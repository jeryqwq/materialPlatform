 ...
 *-----------------------------------------------------------*/ (function () {
  var X = [
    ...
    K = function (B) {
      for (var r = [], P = 0, e = B.length; P < e; P++) r[P] = X[B[P]];
      return r;
    },
    pe = this,
      ...
      return (
        ...
        (P.prototype._detect = function () {
          this._detected ||
            ...
            (this._isWebWorker = typeof B.global.importScripts == 'function'),
  ...
  (function (B) {
    var r = (function () {
      function A(c, v, C) {
        (this.type = c), (this.detail = v), (this.timestamp = C);
      }
      return A;
    })();
    B.LoaderEvent = r;
    var P = (function () {
      function A(c) {
        this._events = [new r(1, '', c)];
      }
      return (
        (A.prototype.record = function (c, v) {
          this._events.push(
            new r(c, v, B.Utilities.getHighPerformanceTimestamp()),
          );
        }),
  ...
  (function (B) {
    var r = (function () {
      function P() {}
      return (
        (P.fileUriToFilePath = function (e, A) {
        ...
        (P.startsWith = function (e, A) {
          return e.length >= A.length && e.substr(0, A.length) === A;
        }),
        (P.endsWith = function (e, A) {
          return e.length >= A.length && e.substr(e.length - A.length) === A;
        }),
        (P.containsQueryString = function (e) {
          return /^[^\#]*\?/gi.test(e);
        }),
        (P.isAbsolutePath = function (e) {
          return /^((http:\/\/)|(https:\/\/)|(file:\/\/)|(\/))/.test(e);
        }),
        (P.forEachProperty = function (e, A) {
          if (e) {
            var c = void 0;
        ...
        (P.isEmpty = function (e) {
          var A = !0;
          return (
            P.forEachProperty(e, function () {
              A = !1;
            }),
            A
          );
        }),
        (P.recursiveClone = function (e) {
          if (
            !e ||
            typeof e != 'object' ||
            e instanceof RegExp ||
          ...
          return (
            P.forEachProperty(e, function (c, v) {
              v && typeof v == 'object'
                ? (A[c] = P.recursiveClone(v))
                : (A[c] = v);
            }),
            A
          );
        ...
        (P.isAnonymousModule = function (e) {
          return P.startsWith(e, '===anonymous');
        }),
          ...
          return (
            this.PERFORMANCE_NOW_PROBED ||
              ...
              (this.HAS_PERFORMANCE_NOW =
                ...
                typeof B.global.performance.now == 'function')),
            this.HAS_PERFORMANCE_NOW ? B.global.performance.now() : Date.now()
          );
        }),
  ...
  (function (B) {
    function r(A) {
      ...
      var c = new Error(A.message || String(A) || 'Unknown Error');
      return A.stack && (c.stack = A.stack), c;
    }
    B.ensureError = r;
    var P = (function () {
      function A() {}
      return (
        (A.validateConfigurationOptions = function (c) {
          function v(f) {
            if (f.phase === 'loading') {
              console.error('Loading "' + f.moduleId + '" failed'),
                console.error(f),
                console.error('Here are the modules that depend on it:'),
                console.error(f.neededBy);
              return;
            }
            if (f.phase === 'factory') {
              console.error(
          ...
          if (
            ...
            typeof c.isBuild != 'boolean' && (c.isBuild = !1),
            typeof c.paths != 'object' && (c.paths = {}),
            typeof c.config != 'object' && (c.config = {}),
            typeof c.catchError == 'undefined' && (c.catchError = !1),
            typeof c.recordStats == 'undefined' && (c.recordStats = !1),
            typeof c.urlArgs != 'string' && (c.urlArgs = ''),
            typeof c.onError != 'function' && (c.onError = v),
            Array.isArray(c.ignoreDuplicateModules) ||
              (c.ignoreDuplicateModules = []),
            c.baseUrl.length > 0 &&
              (B.Utilities.endsWith(c.baseUrl, '/') || (c.baseUrl += '/')),
            typeof c.cspNonce != 'string' && (c.cspNonce = ''),
            typeof c.preferScriptTags == 'undefined' &&
              (c.preferScriptTags = !1),
            Array.isArray(c.nodeModules) || (c.nodeModules = []),
            c.nodeCachedData &&
              typeof c.nodeCachedData == 'object' &&
              (typeof c.nodeCachedData.seed != 'string' &&
                (c.nodeCachedData.seed = 'seed'),
              (typeof c.nodeCachedData.writeDelay != 'number' ||
                c.nodeCachedData.writeDelay < 0) &&
                (c.nodeCachedData.writeDelay = 1e3 * 7),
              !c.nodeCachedData.path ||
                typeof c.nodeCachedData.path != 'string'))
          ) {
            var C = r(
              new Error(
            ...
            (C.phase = 'configuration'),
              c.onError(C),
              (c.nodeCachedData = void 0);
          }
          return c;
        }),
        (A.mergeConfigurationOptions = function (c, v) {
          c === void 0 && (c = null), v === void 0 && (v = null);
          var C = B.Utilities.recursiveClone(v || {});
          return (
            B.Utilities.forEachProperty(c, function (f, d) {
              f === 'ignoreDuplicateModules' &&
              typeof C.ignoreDuplicateModules != 'undefined'
                ? (C.ignoreDuplicateModules =
                    C.ignoreDuplicateModules.concat(d))
                : f === 'paths' && typeof C.paths != 'undefined'
                ? B.Utilities.forEachProperty(d, function (w, t) {
                    return (C.paths[w] = t);
                  })
                : f === 'config' && typeof C.config != 'undefined'
                ? B.Utilities.forEachProperty(d, function (w, t) {
                    return (C.config[w] = t);
                  })
                : (C[f] = B.Utilities.recursiveClone(d));
            }),
    ...
    var e = (function () {
        ...
        if (
          ...
          if (
            ...
            var C = this.options.nodeRequire.main.filename,
              f = Math.max(C.lastIndexOf('/'), C.lastIndexOf('\\'));
            this.options.baseUrl = C.substring(0, f + 1);
          }
      ...
      return (
        (A.prototype._createIgnoreDuplicateModulesMap = function () {
          ...
          for (var c = 0; c < this.options.ignoreDuplicateModules.length; c++)
            this.ignoreDuplicateModulesMap[
              this.options.ignoreDuplicateModules[c]
            ] = !0;
        }),
        (A.prototype._createNodeModulesMap = function () {
          this.nodeModulesMap = Object.create(null);
          for (var c = 0, v = this.options.nodeModules; c < v.length; c++) {
            var C = v[c];
        ...
        (A.prototype._createSortedPathsRules = function () {
          ...
          (this.sortedPathsRules = []),
            B.Utilities.forEachProperty(this.options.paths, function (v, C) {
              Array.isArray(C)
                ? c.sortedPathsRules.push({ from: v, to: C })
                : c.sortedPathsRules.push({ from: v, to: [C] });
            }),
            this.sortedPathsRules.sort(function (v, C) {
              return C.from.length - v.from.length;
            });
        }),
        (A.prototype.cloneAndMerge = function (c) {
          return new A(this._env, P.mergeConfigurationOptions(c, this.options));
        }),
        (A.prototype.getOptionsLiteral = function () {
          return this.options;
        }),
        (A.prototype._applyPaths = function (c) {
          for (var v, C = 0, f = this.sortedPathsRules.length; C < f; C++)
            if (
              ((v = this.sortedPathsRules[C]),
              B.Utilities.startsWith(c, v.from))
            ) {
              for (var d = [], w = 0, t = v.to.length; w < t; w++)
                d.push(v.to[w] + c.substr(v.from.length));
              return d;
            }
          return [c];
        }),
        (A.prototype._addUrlArgsToUrl = function (c) {
          return B.Utilities.containsQueryString(c)
            ? c + '&' + this.options.urlArgs
            : c + '?' + this.options.urlArgs;
        }),
        (A.prototype._addUrlArgsIfNecessaryToUrl = function (c) {
          return this.options.urlArgs ? this._addUrlArgsToUrl(c) : c;
        }),
        (A.prototype._addUrlArgsIfNecessaryToUrls = function (c) {
          if (this.options.urlArgs)
            for (var v = 0, C = c.length; v < C; v++)
              c[v] = this._addUrlArgsToUrl(c[v]);
          return c;
        }),
        (A.prototype.moduleIdToPaths = function (c) {
          if (this._env.isNode) {
            var v =
              this.nodeModulesMap[c] === !0 ||
              (this.options.amdModulesPattern instanceof RegExp &&
                !this.options.amdModulesPattern.test(c));
            if (v) return this.isBuild() ? ['empty:'] : ['node|' + c];
          }
          var C = c,
            f;
          if (
            !B.Utilities.endsWith(C, '.js') &&
            !B.Utilities.isAbsolutePath(C)
          ) {
            f = this._applyPaths(C);
            for (var d = 0, w = f.length; d < w; d++)
              (this.isBuild() && f[d] === 'empty:') ||
                (B.Utilities.isAbsolutePath(f[d]) ||
                  (f[d] = this.options.baseUrl + f[d]),
                !B.Utilities.endsWith(f[d], '.js') &&
                  !B.Utilities.containsQueryString(f[d]) &&
                  (f[d] = f[d] + '.js'));
          } else
            !B.Utilities.endsWith(C, '.js') &&
              !B.Utilities.containsQueryString(C) &&
              (C = C + '.js'),
              (f = [C]);
          return this._addUrlArgsIfNecessaryToUrls(f);
        }),
        (A.prototype.requireToUrl = function (c) {
          var v = c;
          return (
            B.Utilities.isAbsolutePath(v) ||
              ((v = this._applyPaths(v)[0]),
              B.Utilities.isAbsolutePath(v) || (v = this.options.baseUrl + v)),
        ...
        (A.prototype.isDuplicateMessageIgnoredFor = function (c) {
          return this.ignoreDuplicateModulesMap.hasOwnProperty(c);
        }),
        (A.prototype.getConfigForModule = function (c) {
          if (this.options.config) return this.options.config[c];
        }),
  ...
  (function (B) {
    var r = (function () {
        ...
        return (
          (f.prototype.load = function (d, w, t, _) {
            var u = this;
            if (!this._scriptLoader)
              if (this._env.isWebWorker) this._scriptLoader = new A();
              else if (this._env.isElectronRenderer) {
                var S = d.getConfig().getOptionsLiteral().preferScriptTags;
                S
                ...
                this._env.isNode
                  ? (this._scriptLoader = new c(this._env))
                  : (this._scriptLoader = new P());
            var L = { callback: t, errorback: _ };
            if (this._callbackMap.hasOwnProperty(w)) {
              this._callbackMap[w].push(L);
              return;
            }
            (this._callbackMap[w] = [L]),
              this._scriptLoader.load(
                d,
                w,
                function () {
                  return u.triggerCallback(w);
                },
                function (s) {
                  return u.triggerErrorback(w, s);
                },
              );
          }),
          (f.prototype.triggerCallback = function (d) {
            var w = this._callbackMap[d];
            delete this._callbackMap[d];
            for (var t = 0; t < w.length; t++) w[t].callback();
          }),
          (f.prototype.triggerErrorback = function (d, w) {
            var t = this._callbackMap[d];
            delete this._callbackMap[d];
            for (var _ = 0; _ < t.length; _++) t[_].errorback(w);
          }),
          f
        );
      })(),
      P = (function () {
        function f() {}
        return (
          (f.prototype.attachListeners = function (d, w, t) {
            var _ = function () {
            ...
            d.addEventListener('load', u), d.addEventListener('error', S);
          }),
          (f.prototype.load = function (d, w, t, _) {
            if (/^node\|/.test(w)) {
              var u = d.getConfig().getOptionsLiteral(),
                S = v(d.getRecorder(), u.nodeRequire || B.global.nodeRequire),
                L = w.split('|'),
                s = null;
              try {
                s = S(L[1]);
              ...
              d.enqueueDefineAnonymousModule([], function () {
                return s;
              }),
                t();
            } else {
              ...
              b.setAttribute('async', 'async'),
                ...
                this.attachListeners(b, t, _);
              var m = d.getConfig().getOptionsLiteral().trustedTypesPolicy;
              m && (w = m.createScriptURL(w)), b.setAttribute('src', w);
              var o = d.getConfig().getOptionsLiteral().cspNonce;
              o && b.setAttribute('nonce', o),
    ...
    function e(f) {
      var d = f.getConfig().getOptionsLiteral().trustedTypesPolicy;
      try {
        var w = d
          ? self.eval(d.createScript('', 'true'))
          : new Function('true');
        return w.call(self), !0;
      } catch {
        return !1;
      }
    }
    var A = (function () {
        ...
        return (
          (f.prototype._canUseEval = function (d) {
            return (
              this._cachedCanUseEval === null &&
                (this._cachedCanUseEval = e(d)),
          ...
          (f.prototype.load = function (d, w, t, _) {
            if (/^node\|/.test(w)) {
              ...
              var b = d.getConfig().getOptionsLiteral().trustedTypesPolicy,
                m =
                  /^((http:)|(https:)|(file:))/.test(w) &&
                  w.substring(0, self.origin.length) !== self.origin;
              if (!m && this._canUseEval(d)) {
                fetch(w)
                  .then(function (o) {
...
//# sourceURL=` +
              ...
              try {
                b && (w = b.createScriptURL(w)), importScripts(w), t();
              } catch (o) {
                _(o);
              }
            }
      ...
      c = (function () {
        ...
        return (
          (f.prototype._init = function (d) {
            this._didInitialize ||
              ((this._didInitialize = !0),
              (this._fs = d('fs')),
              (this._vm = d('vm')),
              (this._path = d('path')),
              (this._crypto = d('crypto')));
          }),
          (f.prototype._initNodeRequire = function (d, w) {
            var t = w.getConfig().getOptionsLiteral().nodeCachedData;
            ...
            function S(L) {
              ...
              return (
                (b.resolve = function (o, i) {
                  return s._resolveFilename(o, L, !1, i);
                }),
                (b.resolve.paths = function (o) {
                  return s._resolveLookupPaths(o, L);
                }),
                (b.main = process.mainModule),
                (b.extensions = s._extensions),
                (b.cache = s._cache),
                b
              );
            }
            u.prototype._compile = function (L, s) {
              var b = u.wrap(L.replace(/^#!.*/, '')),
                m = w.getRecorder(),
                o = _._getCachedDataPath(t, s),
                i = { filename: s },
                a;
              try {
                var l = _._fs.readFileSync(o);
                (a = l.slice(0, 16)),
              ...
              var g = new _._vm.Script(b, i),
                h = g.runInThisContext(i),
                p = _._path.dirname(s),
                y = S(this),
                N = [this.exports, y, this, s, p, process, ye, Buffer],
                E = h.apply(this.exports, N);
              return (
                _._handleCachedData(g, b, o, !i.cachedData, w),
                _._verifyCachedData(g, b, o, a, w),
                E
              );
            };
          }),
          (f.prototype.load = function (d, w, t, _) {
            var u = this,
              S = d.getConfig().getOptionsLiteral(),
              L = v(d.getRecorder(), S.nodeRequire || B.global.nodeRequire),
              s =
                S.nodeInstrumenter ||
                function (h) {
                  return h;
                };
            this._init(L), this._initNodeRequire(L, d);
            var b = d.getRecorder();
            if (/^node\|/.test(w)) {
              var m = w.split('|'),
                o = null;
              ...
              w = B.Utilities.fileUriToFilePath(this._env.isWindows, w);
              var i = this._path.normalize(w),
                a = this._getElectronRendererScriptPathOrUri(i),
                l = Boolean(S.nodeCachedData),
                g = l ? this._getCachedDataPath(S.nodeCachedData, w) : void 0;
              this._readSourceAndCachedData(i, g, b, function (h, p, y, N) {
                if (h) {
                  _(h);
                  return;
                }
                var E;
                p.charCodeAt(0) === f._BOM
                  ? (E = f._PREFIX + p.substring(1) + f._SUFFIX)
                  : (E = f._PREFIX + p + f._SUFFIX),
                  (E = s(E, i));
                var M = { filename: a, cachedData: y },
                  k = u._createAndEvalScript(d, E, M, t, _);
                u._handleCachedData(k, E, g, l && !y, d),
                  u._verifyCachedData(k, E, g, N, d);
              });
            }
          }),
          (f.prototype._createAndEvalScript = function (d, w, t, _, u) {
            var S = d.getRecorder();
            S.record(31, t.filename);
            var L = new this._vm.Script(w, t),
              s = L.runInThisContext(t),
              b = d.getGlobalAMDDefineFunc(),
              m = !1,
              o = function () {
                return (m = !0), b.apply(null, arguments);
              };
            return (
              (o.amd = b.amd),
              s.call(
                B.global,
                d.getGlobalAMDRequireFunc(),
                o,
                t.filename,
                this._path.dirname(t.filename),
              ),
              S.record(32, t.filename),
              m
                ? _()
                : u(
                    new Error(
          ...
          (f.prototype._getElectronRendererScriptPathOrUri = function (d) {
            if (!this._env.isElectronRenderer) return d;
            var w = d.match(/^([a-z])\:(.*)/i);
            return w
              ? 'file:///' +
                  (w[1].toUpperCase() + ':' + w[2]).replace(/\\/g, '/')
              : 'file://' + d;
          }),
          (f.prototype._getCachedDataPath = function (d, w) {
            var t = this._crypto
                .createHash('md5')
                .update(w, 'utf8')
                .update(d.seed, 'utf8')
                .update(process.arch, '')
                .digest('hex'),
              _ = this._path.basename(w).replace(/\.js$/, '');
            return this._path.join(d.path, _ + '-' + t + '.code');
          }),
          (f.prototype._handleCachedData = function (d, w, t, _, u) {
            var S = this;
            d.cachedDataRejected
              ? this._fs.unlink(t, function (L) {
                  u.getRecorder().record(62, t),
                    S._createAndWriteCachedData(d, w, t, u),
                    L && u.getConfig().onError(L);
                })
              : _ && this._createAndWriteCachedData(d, w, t, u);
          }),
          (f.prototype._createAndWriteCachedData = function (d, w, t, _) {
            var u = this,
              S = Math.ceil(
                _.getConfig().getOptionsLiteral().nodeCachedData.writeDelay *
                  (1 + Math.random()),
              ),
              L = -1,
              s = 0,
                ...
                setTimeout(function () {
                  b ||
                    (b = u._crypto
                      ...
                      .update(w, 'utf8')
                      .digest());
                  var o = d.createCachedData();
                  if (!(o.length === 0 || o.length === L || s >= 5)) {
                    if (o.length < L) {
                      m();
                      return;
                    }
                    (L = o.length),
                      u._fs.writeFile(t, Buffer.concat([b, o]), function (i) {
                        i && _.getConfig().onError(i),
                          _.getRecorder().record(63, t),
                          m();
                      });
                  }
                }, S * Math.pow(4, s++));
          ...
          (f.prototype._readSourceAndCachedData = function (d, w, t, _) {
            if (!w) this._fs.readFile(d, { encoding: 'utf8' }, _);
            else {
              var u = void 0,
                S = void 0,
                L = void 0,
                s = 2,
                b = function (m) {
                  m ? _(m) : --s == 0 && _(void 0, u, S, L);
                };
              this._fs.readFile(d, { encoding: 'utf8' }, function (m, o) {
                (u = o), b(m);
              }),
                this._fs.readFile(w, function (m, o) {
                  !m && o && o.length > 0
                    ? ((L = o.slice(0, 16)), (S = o.slice(16)), t.record(60, w))
                    : t.record(61, w),
                    b();
                });
            }
          }),
          (f.prototype._verifyCachedData = function (d, w, t, _, u) {
            var S = this;
            !_ ||
              d.cachedDataRejected ||
              setTimeout(function () {
                var L = S._crypto.createHash('md5').update(w, 'utf8').digest();
                _.equals(L) ||
                  (u
                    .getConfig()
                    .onError(
                  ...
                  S._fs.unlink(t, function (s) {
                    s && u.getConfig().onError(s);
                  }));
    ...
    B.ensureRecordedNodeRequire = v;
    function C(f) {
      return new r(f);
    }
    B.createScriptLoader = C;
  })(se || (se = {}));
  var se;
  (function (B) {
    var r = (function () {
      function C(f) {
        var d = f.lastIndexOf('/');
        d !== -1
          ? (this.fromModulePath = f.substr(0, d + 1))
          : (this.fromModulePath = '');
      }
      return (
        (C._normalizeModuleId = function (f) {
          var d = f,
            w;
          for (w = /\/\.\//; w.test(d); ) d = d.replace(w, '/');
          for (
            d = d.replace(/^\.\//g, ''),
              w =
                /\/(([^\/])|([^\/][^\/\.])|([^\/\.][^\/])|([^\/][^\/][^\/]+))\/\.\.\//;
        ...
        (C.prototype.resolveModule = function (f) {
          var d = f;
          return (
            B.Utilities.isAbsolutePath(d) ||
              ((B.Utilities.startsWith(d, './') ||
                B.Utilities.startsWith(d, '../')) &&
                (d = C._normalizeModuleId(this.fromModulePath + d))),
            d
          );
        }),
        (C.ROOT = new C('')),
    ...
    B.ModuleIdResolver = r;
    var P = (function () {
      function C(f, d, w, t, _, u) {
        (this.id = f),
          (this.strId = d),
          (this.dependencies = w),
          (this._callback = t),
      ...
      return (
        (C._safeInvokeFunction = function (f, d) {
          try {
            return { returnedValue: f.apply(B.global, d), producedError: null };
          } catch (w) {
            return { returnedValue: null, producedError: w };
          }
        }),
        (C._invokeFactory = function (f, d, w, t) {
          return f.isBuild() && !B.Utilities.isAnonymousModule(d)
            ? { returnedValue: null, producedError: null }
            : f.shouldCatchError()
            ? this._safeInvokeFunction(w, t)
            : { returnedValue: w.apply(B.global, t), producedError: null };
        }),
        (C.prototype.complete = function (f, d, w) {
          this._isComplete = !0;
          var t = null;
          if (this._callback)
            if (typeof this._callback == 'function') {
              f.record(21, this.strId);
              var _ = C._invokeFactory(d, this.strId, this._callback, w);
              (t = _.producedError),
                f.record(22, this.strId),
                !t &&
                  typeof _.returnedValue != 'undefined' &&
                  (!this.exportsPassedIn ||
                    B.Utilities.isEmpty(this.exports)) &&
                  (this.exports = _.returnedValue);
            } else this.exports = this._callback;
          if (t) {
            var u = B.ensureError(t);
            (u.phase = 'factory'),
        ...
        (C.prototype.onDependencyError = function (f) {
          return (
            (this._isComplete = !0),
            (this.error = f),
            this._errorback ? (this._errorback(f), !0) : !1
          );
        }),
    ...
    var e = (function () {
        ...
        return (
          ...
          (C.prototype.getModuleId = function (f) {
            var d = this._strModuleIdToIntModuleId.get(f);
            return (
              typeof d == 'undefined' &&
                ((d = this._nextId++),
                this._strModuleIdToIntModuleId.set(f, d),
                (this._intModuleIdToStrModuleId[d] = f)),
              d
            );
          }),
          (C.prototype.getStrModuleId = function (f) {
            return this._intModuleIdToStrModuleId[f];
          }),
          C
        );
      })(),
    ...
    B.RegularDependency = A;
    var c = (function () {
      function C(f, d, w) {
        (this.id = f), (this.pluginId = d), (this.pluginParam = w);
      }
      return C;
    })();
    B.PluginDependency = c;
    var v = (function () {
      function C(f, d, w, t, _) {
        _ === void 0 && (_ = 0),
          (this._env = f),
          ...
          (this._config = new B.Configuration(this._env)),
      ...
      return (
        ...
        (C._findRelevantLocationInStack = function (f, d) {
          for (
            var w = function (i) {
                return i.replace(/\\/g, '/');
              },
            ...
            if (S) {
              ...
              if (((L = L.substr(m)), (L = w(L)), L === t)) {
                var o = { line: parseInt(s, 10), col: parseInt(b, 10) };
                return (
                  o.line === 1 &&
                    (o.col -=
          ...
          throw new Error(
            'Could not correlate define call site for needle ' + f,
          );
        }),
        (C.prototype.getBuildInfo = function () {
          if (!this._config.isBuild()) return null;
          for (
            var f = [], d = 0, w = 0, t = this._modules2.length;
            w < t;
            w++
          ) {
            var _ = this._modules2[w];
            if (!!_) {
              var u = this._buildInfoPath[_.id] || null,
                S = this._buildInfoDefineStack[_.id] || null,
                L = this._buildInfoDependencies[_.id];
              f[d++] = {
                id: _.strId,
                path: u,
                defineLocation:
                  u && S ? C._findRelevantLocationInStack(u, S) : null,
                dependencies: L,
                shim: null,
                exports: _.exports,
              };
          ...
          return (
            this._recorder ||
              (this._config.shouldRecordStats()
                ? (this._recorder = new B.LoaderEventRecorder(
                    this._loaderAvailableTimestamp,
                  ))
                : (this._recorder = B.NullLoaderEventRecorder.INSTANCE)),
            this._recorder
          );
        }),
        ...
        (C.prototype.enqueueDefineAnonymousModule = function (f, d) {
        ...
        (C.prototype.defineModule = function (f, d, w, t, _, u) {
          var S = this;
          u === void 0 && (u = new r(f));
          var L = this._moduleIdProvider.getModuleId(f);
          if (this._modules2[L]) {
            this._config.isDuplicateMessageIgnoredFor(f) ||
              console.warn("Duplicate definition of module '" + f + "'");
            return;
          }
          var s = new P(L, f, this._normalizeDependencies(d, u), w, t, u);
          (this._modules2[L] = s),
            this._config.isBuild() &&
              ((this._buildInfoDefineStack[L] = _),
              (this._buildInfoDependencies[L] = (s.dependencies || []).map(
                function (b) {
                  return S._moduleIdProvider.getStrModuleId(b.id);
                },
              ))),
            this._resolve(s);
        }),
        (C.prototype._normalizeDependency = function (f, d) {
          if (f === 'exports') return A.EXPORTS;
          if (f === 'module') return A.MODULE;
          if (f === 'require') return A.REQUIRE;
          var w = f.indexOf('!');
          if (w >= 0) {
            var t = d.resolveModule(f.substr(0, w)),
              _ = d.resolveModule(f.substr(w + 1)),
              u = this._moduleIdProvider.getModuleId(t + '!' + _),
              S = this._moduleIdProvider.getModuleId(t);
            return new c(u, S, _);
          }
          return new A(this._moduleIdProvider.getModuleId(d.resolveModule(f)));
        }),
        (C.prototype._normalizeDependencies = function (f, d) {
          for (var w = [], t = 0, _ = 0, u = f.length; _ < u; _++)
            w[t++] = this._normalizeDependency(f[_], d);
          return w;
        }),
        (C.prototype._relativeRequire = function (f, d, w, t) {
          if (typeof d == 'string') return this.synchronousRequire(d, f);
          this.defineModule(
            B.Utilities.generateAnonymousModule(),
            d,
            w,
            t,
            null,
        ...
        (C.prototype.synchronousRequire = function (f, d) {
          d === void 0 && (d = new r(f));
          var w = this._normalizeDependency(f, d),
            t = this._modules2[w.id];
          if (!t)
            throw new Error(
        ...
        (C.prototype.configure = function (f, d) {
          var w = this._config.shouldRecordStats();
          d
            ? (this._config = new B.Configuration(this._env, f))
            : (this._config = this._config.cloneAndMerge(f)),
            this._config.shouldRecordStats() && !w && (this._recorder = null);
        }),
        (C.prototype.getConfig = function () {
          return this._config;
        }),
        (C.prototype._onLoad = function (f) {
          if (this._currentAnonymousDefineCall !== null) {
            var d = this._currentAnonymousDefineCall;
            (this._currentAnonymousDefineCall = null),
              this.defineModule(
        ...
        (C.prototype._createLoadError = function (f, d) {
          var w = this,
            t = this._moduleIdProvider.getStrModuleId(f),
            _ = (this._inverseDependencies2[f] || []).map(function (S) {
              return w._moduleIdProvider.getStrModuleId(S);
            }),
            u = B.ensureError(d);
          return (u.phase = 'loading'), (u.moduleId = t), (u.neededBy = _), u;
        }),
        (C.prototype._onLoadError = function (f, d) {
          var w = this._createLoadError(f, d);
          this._modules2[f] ||
            (this._modules2[f] = new P(
              f,
              this._moduleIdProvider.getStrModuleId(f),
              [],
              function () {},
          ...
          for (
            var t = [], _ = 0, u = this._moduleIdProvider.getMaxModuleId();
            _ < u;
            _++
          )
            t[_] = !1;
          var S = !1,
            L = [];
          for (L.push(f), t[f] = !0; L.length > 0; ) {
            var s = L.shift(),
              b = this._modules2[s];
            b && (S = b.onDependencyError(w) || S);
            var m = this._inverseDependencies2[s];
            if (m)
              for (var _ = 0, u = m.length; _ < u; _++) {
                var o = m[_];
                t[o] || (L.push(o), (t[o] = !0));
              }
          }
          S || this._config.onError(w);
        }),
        (C.prototype._hasDependencyPath = function (f, d) {
          var w = this._modules2[f];
          if (!w) return !1;
          for (
            var t = [], _ = 0, u = this._moduleIdProvider.getMaxModuleId();
            _ < u;
            ...
            t[_] = !1;
          var S = [];
          for (S.push(w), t[f] = !0; S.length > 0; ) {
            var L = S.shift(),
              s = L.dependencies;
            if (s)
              for (var _ = 0, u = s.length; _ < u; _++) {
                var b = s[_];
                if (b.id === d) return !0;
                var m = this._modules2[b.id];
                m && !t[b.id] && ((t[b.id] = !0), S.push(m));
              }
          }
          return !1;
        }),
        (C.prototype._findCyclePath = function (f, d, w) {
          if (f === d || w === 50) return [f];
          var t = this._modules2[f];
          if (!t) return null;
          var _ = t.dependencies;
          if (_)
            for (var u = 0, S = _.length; u < S; u++) {
              var L = this._findCyclePath(_[u].id, d, w + 1);
              if (L !== null) return L.push(f), L;
            }
          return null;
        }),
        (C.prototype._createRequire = function (f) {
          var d = this,
            w = function (t, _, u) {
              return d._relativeRequire(f, t, _, u);
            };
          return (
            (w.toUrl = function (t) {
              return d._config.requireToUrl(f.resolveModule(t));
            }),
            (w.getStats = function () {
            ...
            (w.config = function (t, _) {
              _ === void 0 && (_ = !1), d.configure(t, _);
            }),
            (w.__$__nodeRequire = B.global.nodeRequire),
            w
          );
        }),
        (C.prototype._loadModule = function (f) {
          var d = this;
          if (!(this._modules2[f] || this._knownModules2[f])) {
            this._knownModules2[f] = !0;
            var w = this._moduleIdProvider.getStrModuleId(f),
              t = this._config.moduleIdToPaths(w),
              _ = /^@[^\/]+\/[^\/]+$/;
            this._env.isNode &&
              (w.indexOf('/') === -1 || _.test(w)) &&
              t.push('node|' + w);
            var u = -1,
              S = function (L) {
                if ((u++, u >= t.length)) d._onLoadError(f, L);
                else {
                  var s = t[u],
                    b = d.getRecorder();
                  if (d._config.isBuild() && s === 'empty:') {
                    (d._buildInfoPath[f] = s),
                      d.defineModule(
                        d._moduleIdProvider.getStrModuleId(f),
                        [],
                        null,
                        null,
                        null,
                  ...
                  b.record(10, s),
                    d._scriptLoader.load(
                      d,
                      s,
                      function () {
                        d._config.isBuild() && (d._buildInfoPath[f] = s),
                          b.record(11, s),
                          d._onLoad(f);
                      },
                      function (m) {
        ...
        (C.prototype._loadPluginDependency = function (f, d) {
          var w = this;
          if (!(this._modules2[d.id] || this._knownModules2[d.id])) {
            this._knownModules2[d.id] = !0;
            var t = function (_) {
              w.defineModule(
                w._moduleIdProvider.getStrModuleId(d.id),
                [],
                _,
                null,
                null,
            ...
            (t.error = function (_) {
              w._config.onError(w._createLoadError(d.id, _));
            }),
              f.load(
                d.pluginParam,
        ...
        (C.prototype._resolve = function (f) {
          var d = this,
            w = f.dependencies;
          if (w)
            for (var t = 0, _ = w.length; t < _; t++) {
              var u = w[t];
              if (u === A.EXPORTS) {
                (f.exportsPassedIn = !0), f.unresolvedDependenciesCount--;
                continue;
              }
              if (u === A.MODULE) {
              ...
              var S = this._modules2[u.id];
              if (S && S.isComplete()) {
                if (S.error) {
                  f.onDependencyError(S.error);
                  return;
                }
                f.unresolvedDependenciesCount--;
                continue;
              }
              if (this._hasDependencyPath(u.id, f.id)) {
                ...
                var L = this._findCyclePath(u.id, f.id, 0) || [];
                L.reverse(),
                  L.push(u.id),
                  console.warn(
                    L.map(function (m) {
                      return d._moduleIdProvider.getStrModuleId(m);
                    }).join(` => 
`),
                  ),
                  f.unresolvedDependenciesCount--;
              ...
              if (
                ((this._inverseDependencies2[u.id] =
                  this._inverseDependencies2[u.id] || []),
                this._inverseDependencies2[u.id].push(f.id),
                u instanceof c)
              ) {
                var s = this._modules2[u.pluginId];
                if (s && s.isComplete()) {
                  this._loadPluginDependency(s.exports, u);
                  continue;
                }
                var b = this._inversePluginDependencies2.get(u.pluginId);
                b ||
                  ((b = []),
                  this._inversePluginDependencies2.set(u.pluginId, b)),
                  b.push(u),
          ...
          f.unresolvedDependenciesCount === 0 && this._onModuleComplete(f);
        }),
        (C.prototype._onModuleComplete = function (f) {
          var d = this,
            w = this.getRecorder();
          if (!f.isComplete()) {
            var t = f.dependencies,
              _ = [];
            if (t)
              for (var u = 0, S = t.length; u < S; u++) {
                ...
                if (L === A.MODULE) {
                  _[u] = {
                    id: f.strId,
                    config: function () {
                      return d._config.getConfigForModule(f.strId);
                    },
                  };
                  continue;
                }
                if (L === A.REQUIRE) {
                  _[u] = this._createRequire(f.moduleIdResolver);
                  continue;
                }
            ...
            f.complete(w, this._config, _);
            var b = this._inverseDependencies2[f.id];
            if (((this._inverseDependencies2[f.id] = null), b))
              for (var u = 0, S = b.length; u < S; u++) {
                var m = b[u],
                  o = this._modules2[m];
            ...
            var i = this._inversePluginDependencies2.get(f.id);
            if (i) {
              this._inversePluginDependencies2.delete(f.id);
              for (var u = 0, S = i.length; u < S; u++)
                this._loadPluginDependency(f.exports, i[u]);
            }
          }
        }),
        C
  ...
  var Q, se;
  (function (B) {
    var r = new B.Environment(),
      P = null,
      e = function (C, f, d) {
        typeof C != 'string' && ((d = f), (f = C), (C = null)),
          (typeof f != 'object' || !Array.isArray(f)) && ((d = f), (f = null)),
          f || (f = ['require', 'exports', 'module']),
          C
            ? P.defineModule(C, f, d, null, null)
            : P.enqueueDefineAnonymousModule(f, d);
      };
    e.amd = { jQuery: !0 };
    var A = function (C, f) {
        f === void 0 && (f = !1), P.configure(C, f);
      },
      c = function () {
    ...
    function v() {
      if (
        typeof B.global.require != 'undefined' ||
        typeof require != 'undefined'
      ) {
        var C = B.global.require || require;
        if (typeof C == 'function' && typeof C.resolve == 'function') {
          var f = B.ensureRecordedNodeRequire(P.getRecorder(), C);
          (B.global.nodeRequire = f),
            (c.nodeRequire = f),
            (c.__$__nodeRequire = f);
        }
      }
      r.isNode && !r.isElectronRenderer && !r.isElectronNodeIntegrationWebWorker
        ? ((module.exports = c), (require = c))
        : (r.isElectronRenderer || (B.global.define = e),
          (B.global.require = c));
    }
    (B.init = v),
      (typeof B.global.define != 'function' || !B.global.define.amd) &&
        ((P = new B.ModuleManager(
          r,
          B.createScriptLoader(r),
          e,
          c,
          B.Utilities.getHighPerformanceTimestamp(),
        )),
        typeof B.global.require != 'undefined' &&
          typeof B.global.require != 'function' &&
          c.config(B.global.require),
        (Q = function () {
    ...
    Q(X[18], K([0, 1]), function (B, r) {
      ...
      r.tail2 = e;
      function A(R, I, F = (O, H) => O === H) {
        if (R === I) return !0;
        if (!R || !I || R.length !== I.length) return !1;
        for (let O = 0, H = R.length; O < H; O++) if (!F(R[O], I[O])) return !1;
        return !0;
      }
      r.equals = A;
      function c(R, I, F) {
      ...
      function v(R, I) {
        ...
        if (O === 0) return 0;
        for (; F < O; ) {
          const H = Math.floor((F + O) / 2);
          I(R[H]) ? (O = H) : (F = H + 1);
        }
        return F;
      }
      r.findFirstInSorted = v;
      function C(R, I, F) {
        ...
        for (let T of I) {
          const n = F(T, O);
          n < 0 ? H.push(T) : n > 0 ? W.push(T) : U.push(T);
        }
        return R < H.length
          ? C(R, H, F)
          : R < H.length + U.length
          ? U[0]
          : C(R - (H.length + U.length), W, F);
      }
      r.quickSelect = C;
      function f(R, I) {
        const F = [];
        let O;
        for (const H of R.slice(0).sort(I))
          !O || I(O[0], H) !== 0 ? ((O = [H]), F.push(O)) : O.push(H);
        return F;
      }
      r.groupBy = f;
      function d(R) {
      ...
      function b(R, I) {
        ...
        const O = [];
        if (F <= I) for (let H = F; H < I; H++) O.push(H);
        else for (let H = F; H > I; H--) O.push(H);
        return O;
      }
      r.range = b;
      function m(R, I, F) {
      ...
      function l(R, I, F) {
        const O = h(R, I),
          ...
          W = F.length;
        R.length = H + W;
        for (let U = H - 1; U >= O; U--) R[U + W] = R[U];
        for (let U = 0; U < W; U++) R[U + O] = F[U];
      }
      r.insertInto = l;
      function g(R, I, F, O) {
        const H = h(R, I),
    ...
    Q(X[19], K([0, 1]), function (B, r) {
      ...
      class P {
        ...
        get(A) {
          ...
          return (
            this.lastArgKey !== c &&
              ((this.lastArgKey = c), (this.lastCache = this.computeFn(A))),
            this.lastCache
          );
        }
      }
      r.LRUCachedComputed = P;
    }),
    Q(X[20], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.CSSIcon = r.Codicon = r.getCodiconAriaLabel = void 0);
      function P(c) {
        return c ? c.replace(/\$\((.*?)\)/g, (v, C) => ` ${C} `).trim() : '';
      }
      r.getCodiconAriaLabel = P;
      class e {
        constructor(v, C, f) {
          (this.id = v),
            (this.definition = C),
      ...
      (function (c) {
        ...
        function C(w) {
          if (w instanceof e) return ['codicon', 'codicon-' + w.id];
          const t = v.exec(w.id);
          if (!t) return C(e.error);
          let [, _, u] = t;
          const S = ['codicon', 'codicon-' + _];
          return u && S.push('codicon-modifier-' + u.substr(1)), S;
        }
        c.asClassNameArray = C;
        function f(w) {
          return C(w).join(' ');
        }
        c.asClassName = f;
...
` +
      ...
      (r.ErrorHandler = P), (r.errorHandler = new P());
      function e(u) {
        C(u) || r.errorHandler.onUnexpectedError(u);
      }
      r.onUnexpectedError = e;
      function A(u) {
        C(u) || r.errorHandler.onUnexpectedExternalError(u);
      }
      r.onUnexpectedExternalError = A;
      function c(u) {
        if (u instanceof Error) {
          let { name: S, message: L } = u;
          const s = u.stacktrace || u.stack;
          return { $isError: !0, name: S, message: L, stack: s };
        }
        return u;
      }
      r.transformErrorForSerialization = c;
      const v = 'Canceled';
      function C(u) {
        return u instanceof f
          ? !0
          : u instanceof Error && u.name === v && u.message === v;
      }
      ...
      r.CancellationError = f;
      function d() {
        const u = new Error(v);
        return (u.name = u.message), u;
      }
      r.canceled = d;
      function w(u) {
        return u
          ? new Error(`Illegal argument: ${u}`)
          : new Error('Illegal argument');
      }
      r.illegalArgument = w;
      function t(u) {
        return u
          ? new Error(`Illegal state: ${u}`)
      ...
      r.NotSupportedError = _;
    }),
    Q(X[22], K([0, 1]), function (B, r) {
      'use strict';
      ...
      function P(e) {
        ...
        let c = !1,
          v;
        return function () {
          return c || ((c = !0), (v = e.apply(A, arguments))), v;
        };
      }
      r.once = P;
    }),
    Q(X[23], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.Iterable = void 0);
      var P;
      (function (e) {
        ...
        e.first = w;
        function t(a, l) {
          for (const g of a) if (l(g)) return !0;
          return !1;
        }
        e.some = t;
        function _(a, l) {
          for (const g of a) if (l(g)) return g;
        }
        e.find = _;
        function* u(a, l) {
          for (const g of a) l(g) && (yield g);
        }
        e.filter = u;
        function* S(a, l) {
          let g = 0;
          for (const h of a) yield l(h, g++);
        }
        e.map = S;
        function* L(...a) {
          for (const l of a) for (const g of l) yield g;
        }
        e.concat = L;
        function* s(a) {
          for (const l of a) for (const g of l) yield g;
        ...
        function b(a, l, g) {
          let h = g;
          for (const p of a) h = l(h, p);
          return h;
        }
        e.reduce = b;
        function* m(a, l, g = a.length) {
          for (
            l < 0 && (l += a.length),
              g < 0 ? (g += a.length) : g > a.length && (g = a.length);
            l < g;
            l++
          )
            yield a[l];
        ...
        e.slice = m;
        function o(a, l = Number.POSITIVE_INFINITY) {
          const g = [];
          if (l === 0) return [g, a];
          const h = a[Symbol.iterator]();
          for (let p = 0; p < l; p++) {
            const y = h.next();
            if (y.done) return [g, e.empty()];
            g.push(y.value);
          }
          return [
            g,
        ...
        e.consume = o;
        function i(a, l, g = (h, p) => h === p) {
          const h = a[Symbol.iterator](),
            p = l[Symbol.iterator]();
          for (;;) {
            const y = h.next(),
              N = p.next();
            if (y.done !== N.done) return !1;
            if (y.done) return !0;
            if (!g(y.value, N.value)) return !1;
          }
        }
        e.equals = i;
      })((P = r.Iterable || (r.Iterable = {})));
    }),
    Q(X[24], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.KeyChord =
          r.KeyCodeUtils =
      ...
      class P {
        ...
        define(_, u) {
          (this._keyCodeToStr[_] = u),
            (this._strToKeyCode[u.toLowerCase()] = _);
        }
        keyCodeToStr(_) {
          return this._keyCodeToStr[_];
        }
        strToKeyCode(_) {
          return this._strToKeyCode[_.toLowerCase()] || 0;
        }
      }
      const e = new P(),
        A = new P(),
      ...
      for (let t = 0; t <= 126; t++) r.IMMUTABLE_KEY_CODE_TO_CODE[t] = -1;
      (function () {
        const t = '',
          _ = [
            ...
            [0, 1, 155, 'NumpadClear', 0, t, 0, t, t, t],
        ...
        for (const L of _) {
          ...
          if (
            (S[m] ||
              ...
              (f[o.toLowerCase()] = m),
              b &&
                ((r.IMMUTABLE_CODE_TO_KEY_CODE[m] = i),
                i !== 0 &&
                  i !== 3 &&
                  i !== 5 &&
                  i !== 4 &&
                  i !== 6 &&
                  i !== 57 &&
                  (r.IMMUTABLE_KEY_CODE_TO_CODE[i] = m))),
            !u[i])
          ) {
            if (((u[i] = !0), !a))
              throw new Error(
                `String representation missing for key code ${i} around scan code ${o}`,
              );
            e.define(i, a), A.define(i, h || a), c.define(i, p || h || a);
          }
          l && (r.EVENT_KEY_CODE_MAP[l] = i),
            g && (r.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE[g] = i);
        }
      ...
      (function (t) {
        ...
        t.fromString = u;
        function S(m) {
          return A.keyCodeToStr(m);
        }
        t.toUserSettingsUS = S;
        function L(m) {
          return c.keyCodeToStr(m);
        }
        t.toUserSettingsGeneral = L;
        function s(m) {
          return A.strToKeyCode(m) || c.strToKeyCode(m);
        }
        ...
        t.toElectronAccelerator = b;
      })((d = r.KeyCodeUtils || (r.KeyCodeUtils = {})));
      function w(t, _) {
        const u = ((_ & 65535) << 16) >>> 0;
        return (t | u) >>> 0;
      }
      r.KeyChord = w;
    }),
    Q(X[25], K([0, 1]), function (B, r) {
      'use strict';
    ...
    Q(X[7], K([0, 1, 22, 23]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.ImmortalReference =
          r.MutableDisposable =
      ...
      function C(a) {
        return c == null || c.trackDisposable(a), a;
      }
      function f(a) {
        c == null || c.markAsDisposed(a);
      }
      function d(a, l) {
        c == null || c.setParent(a, l);
      }
      function w(a, l) {
        if (!!c) for (const g of a) c.setParent(g, l);
      }
      function t(a) {
        return c == null || c.markAsSingleton(a), a;
      }
      r.markAsSingleton = t;
      class _ extends Error {
        constructor(l) {
      ...
      (r.DisposableStore = b), (b.DISABLE_DISPOSED_WARNING = !1);
      class m {
        constructor() {
          (this._store = new b()), C(this), d(this._store, this);
        }
        dispose() {
      ...
      (r.Disposable = m), (m.None = Object.freeze({ dispose() {} }));
      class o {
        constructor() {
        ...
        clearAndLeak() {
          const l = this._value;
          return (this._value = void 0), l && d(l, null), l;
        }
      }
      r.MutableDisposable = o;
      class i {
        constructor(l) {
          this.object = l;
        }
      ...
      r.ImmortalReference = i;
    }),
    Q(X[26], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.LinkedList = void 0);
      class P {
      ...
      class e {
        ...
        clear() {
          ...
          for (; c !== P.Undefined; ) {
            const v = c.next;
            (c.prev = P.Undefined), (c.next = P.Undefined), (c = v);
          }
          (this._first = P.Undefined),
            (this._last = P.Undefined),
            (this._size = 0);
        ...
        _insert(c, v) {
          const C = new P(c);
          if (this._first === P.Undefined) (this._first = C), (this._last = C);
          else if (v) {
            const d = this._last;
            (this._last = C), (C.prev = d), (d.next = C);
          } else {
            const d = this._first;
            (this._first = C), (C.next = d), (d.prev = C);
          }
          this._size += 1;
          let f = !1;
          return () => {
            f || ((f = !0), this._remove(C));
          };
        }
        shift() {
        ...
        _remove(c) {
          if (c.prev !== P.Undefined && c.next !== P.Undefined) {
            const v = c.prev;
            (v.next = c.next), (c.next.prev = v);
          } else c.prev === P.Undefined && c.next === P.Undefined ? ((this._first = P.Undefined), (this._last = P.Undefined)) : c.next === P.Undefined ? ((this._last = this._last.prev), (this._last.next = P.Undefined)) : c.prev === P.Undefined && ((this._first = this._first.next), (this._first.prev = P.Undefined));
          this._size -= 1;
        }
        *[Symbol.iterator]() {
          let c = this._first;
          for (; c !== P.Undefined; ) yield c.element, (c = c.next);
        }
      }
      r.LinkedList = e;
    }),
    Q(X[3], K([0, 1]), function (B, r) {
      'use strict';
      var P;
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.isAndroid =
      ...
      typeof r.globals.vscode.process != 'undefined'
        ? (s = r.globals.vscode.process)
        : typeof process != 'undefined' && (s = process);
      const b =
          typeof ((P = s == null ? void 0 : s.versions) === null || P === void 0
            ? void 0
            : P.electron) == 'string',
        m = b && (s == null ? void 0 : s.type) === 'renderer';
      if (typeof navigator == 'object' && !m)
        (L = navigator.userAgent),
          (A = L.indexOf('Windows') >= 0),
          (c = L.indexOf('Macintosh') >= 0),
          (t =
        ...
        (A = s.platform === 'win32'),
          (c = s.platform === 'darwin'),
          (v = s.platform === 'linux'),
          (C = v && !!s.env.SNAP && !!s.env.SNAP_REVISION),
          (w = b),
          (_ = e),
          (u = e);
        const g = s.env.VSCODE_NLS_CONFIG;
        if (g)
          try {
            const h = JSON.parse(g),
              p = h.availableLanguages['*'];
            (_ = h.locale), (u = p || e), (S = h._translationsConfigFile);
          } catch {}
        f = !0;
      ...
      c ? (o = 1) : A ? (o = 3) : v && (o = 2),
        ...
        (r.setTimeout0 = (() => {
          if (
            ...
            let g = [];
            r.globals.addEventListener('message', (p) => {
              if (p.data && p.data.vscodeScheduleAsyncWork)
                for (let y = 0, N = g.length; y < N; y++) {
                  const E = g[y];
                  if (E.id === p.data.vscodeScheduleAsyncWork) {
                    g.splice(y, 1), E.callback();
                    return;
                  }
                }
            });
            ...
            return (p) => {
              const y = ++h;
              g.push({ id: y, callback: p }),
                r.globals.postMessage({ vscodeScheduleAsyncWork: y }, '*');
            };
          }
          return (g) => setTimeout(g);
        })()),
        (r.OS = c || t ? 2 : A ? 1 : 3);
      let i = !0,
        a = !1;
      function l() {
        if (!a) {
          ...
          (g[0] = 1),
            (g[1] = 2),
            (i = new Uint16Array(g.buffer)[0] === (2 << 8) + 1);
        }
        return i;
      }
      (r.isLittleEndian = l),
    ...
    Q(X[27], K([0, 1, 3]), function (B, r, P) {
      ...
      if (
        ...
        typeof P.globals.vscode.process != 'undefined'
      ) {
        const A = P.globals.vscode.process;
        e = {
          get platform() {
            return A.platform;
          },
    ...
    Q(X[8], K([0, 1, 27]), function (B, r, P) {
      ...
      class _ extends Error {
        constructor(i, a, l) {
          ...
          typeof a == 'string' && a.indexOf('not ') === 0
            ? ((g = 'must not be'), (a = a.replace(/^not /, '')))
            : (g = 'must be');
          const h = i.indexOf('.') !== -1 ? 'property' : 'argument';
          let p = `The "${i}" ${h} ${g} of type ${a}`;
          p += `. Received type ${typeof l}`;
          super(p);
          this.code = 'ERR_INVALID_ARG_TYPE';
        }
      }
      function u(o, i) {
        if (typeof o != 'string') throw new _(i, 'string', o);
      }
      function S(o) {
        return o === f || o === d;
      }
      ...
      function b(o, i, a, l) {
        ...
        for (let E = 0; E <= o.length; ++E) {
          if (E < o.length) N = o.charCodeAt(E);
          else {
            if (l(N)) break;
            N = f;
          }
            ...
            if (!(p === E - 1 || y === 1))
              if (y === 2) {
                if (
                  g.length < 2 ||
                  h !== 2 ||
                  g.charCodeAt(g.length - 1) !== C ||
                  g.charCodeAt(g.length - 2) !== C
                ) {
                  if (g.length > 2) {
                    const M = g.lastIndexOf(a);
                    M === -1
                      ? ((g = ''), (h = 0))
                      : ((g = g.slice(0, M)),
                        (h = g.length - 1 - g.lastIndexOf(a))),
                      (p = E),
                      (y = 0);
                    continue;
                  } else if (g.length !== 0) {
      ...
      function m(o, i) {
        if (i === null || typeof i != 'object')
          throw new _('pathObject', 'Object', i);
        const a = i.dir || i.root,
          l = i.base || `${i.name || ''}${i.ext || ''}`;
        return a ? (a === i.root ? `${a}${l}` : `${a}${o}${l}`) : l;
      }
      (r.win32 = {
        resolve(...o) {
          let i = '',
            a = '',
            l = !1;
          for (let g = o.length - 1; g >= -1; g--) {
            let h;
            if (g >= 0) {
              if (((h = o[g]), u(h, 'path'), h.length === 0)) continue;
            } else
              i.length === 0
                ? (h = P.cwd())
                : ((h = P.env[`=${i}`] || P.cwd()),
                  (h === void 0 ||
                    (h.slice(0, 2).toLowerCase() !== i.toLowerCase() &&
                      h.charCodeAt(2) === d)) &&
                    (h = `${i}\\`));
            const p = h.length;
            let y = 0,
            ...
            if (p === 1) S(M) && ((y = 1), (E = !0));
              ...
              if (((E = !0), S(h.charCodeAt(1)))) {
                let k = 2,
                  R = k;
                for (; k < p && !S(h.charCodeAt(k)); ) k++;
                if (k < p && k !== R) {
                  const I = h.slice(R, k);
                  for (R = k; k < p && S(h.charCodeAt(k)); ) k++;
                  if (k < p && k !== R) {
                    for (R = k; k < p && !S(h.charCodeAt(k)); ) k++;
                    (k === p || k !== R) &&
                      ((N = `\\\\${I}\\${h.slice(R, k)}`), (y = k));
              ...
              s(M) &&
                ...
                ((N = h.slice(0, 2)),
                (y = 2),
                p > 2 && S(h.charCodeAt(2)) && ((E = !0), (y = 3)));
            if (N.length > 0)
              if (i.length > 0) {
                if (N.toLowerCase() !== i.toLowerCase()) continue;
              } else i = N;
            if (l) {
              if (i.length > 0) break;
            } else if (
              ((a = `${h.slice(y)}\\${a}`), (l = E), E && i.length > 0)
            )
              break;
          }
          return (a = b(a, !l, '\\', S)), l ? `${i}\\${a}` : `${i}${a}` || '.';
        },
        normalize(o) {
          u(o, 'path');
          const i = o.length;
          ...
          if (i === 1) return L(h) ? '\\' : o;
          if (S(h))
            if (((g = !0), S(o.charCodeAt(1)))) {
              let y = 2,
                N = y;
              for (; y < i && !S(o.charCodeAt(y)); ) y++;
              if (y < i && y !== N) {
                const E = o.slice(N, y);
                for (N = y; y < i && S(o.charCodeAt(y)); ) y++;
                if (y < i && y !== N) {
                  for (N = y; y < i && !S(o.charCodeAt(y)); ) y++;
                  if (y === i) return `\\\\${E}\\${o.slice(N)}\\`;
                  y !== N && ((l = `\\\\${E}\\${o.slice(N, y)}`), (a = y));
                }
              }
            } else a = 1;
          else
            s(h) &&
              ...
              ((l = o.slice(0, 2)),
              (a = 2),
              i > 2 && S(o.charCodeAt(2)) && ((g = !0), (a = 3)));
          let p = a < i ? b(o.slice(a), !g, '\\', S) : '';
          return (
            p.length === 0 && !g && (p = '.'),
            p.length > 0 && S(o.charCodeAt(i - 1)) && (p += '\\'),
            l === void 0 ? (g ? `\\${p}` : p) : g ? `${l}\\${p}` : `${l}${p}`
          );
        },
        isAbsolute(o) {
          u(o, 'path');
          ...
          return (
            S(a) ||
            (i > 2 && s(a) && o.charCodeAt(1) === w && S(o.charCodeAt(2)))
          );
        },
        join(...o) {
          ...
          for (let h = 0; h < o.length; ++h) {
            const p = o[h];
            u(p, 'path'),
              p.length > 0 && (i === void 0 ? (i = a = p) : (i += `\\${p}`));
          }
          if (i === void 0) return '.';
          let l = !0,
            g = 0;
          if (typeof a == 'string' && S(a.charCodeAt(0))) {
            ++g;
            const h = a.length;
            h > 1 &&
              S(a.charCodeAt(1)) &&
              (++g, h > 2 && (S(a.charCodeAt(2)) ? ++g : (l = !1)));
          }
          if (l) {
            for (; g < i.length && S(i.charCodeAt(g)); ) g++;
            g >= 2 && (i = `\\${i.slice(g)}`);
          }
          return r.win32.normalize(i);
        },
        relative(o, i) {
          if ((u(o, 'from'), u(i, 'to'), o === i)) return '';
          const a = r.win32.resolve(o),
            l = r.win32.resolve(i);
          if (
            a === l ||
            ((o = a.toLowerCase()), (i = l.toLowerCase()), o === i)
          )
            return '';
          let g = 0;
          for (; g < o.length && o.charCodeAt(g) === d; ) g++;
          let h = o.length;
          for (; h - 1 > g && o.charCodeAt(h - 1) === d; ) h--;
          const p = h - g;
          let y = 0;
          for (; y < i.length && i.charCodeAt(y) === d; ) y++;
          let N = i.length;
          for (; N - 1 > y && i.charCodeAt(N - 1) === d; ) N--;
          const E = N - y,
            M = p < E ? p : E;
          let k = -1,
            R = 0;
          for (; R < M; R++) {
            const F = o.charCodeAt(g + R);
            if (F !== i.charCodeAt(y + R)) break;
            F === d && (k = R);
          }
          if (R !== M) {
            if (k === -1) return l;
            ...
            if (E > M) {
              if (i.charCodeAt(y + R) === d) return l.slice(y + R + 1);
              if (R === 2) return l.slice(y + R);
            }
            p > M && (o.charCodeAt(g + R) === d ? (k = R) : R === 2 && (k = 3)),
              k === -1 && (k = 0);
          }
          let I = '';
          for (R = g + k + 1; R <= h; ++R)
            (R === h || o.charCodeAt(R) === d) &&
              (I += I.length === 0 ? '..' : '\\..');
          return (
            (y += k),
            I.length > 0
              ? `${I}${l.slice(y, N)}`
              : (l.charCodeAt(y) === d && ++y, l.slice(y, N))
          );
        },
        toNamespacedPath(o) {
          if (typeof o != 'string') return o;
          if (o.length === 0) return '';
          const i = r.win32.resolve(o);
          if (i.length <= 2) return o;
          if (i.charCodeAt(0) === d) {
            if (i.charCodeAt(1) === d) {
              const a = i.charCodeAt(2);
              if (a !== t && a !== C) return `\\\\?\\UNC\\${i.slice(2)}`;
            }
          } else if (
            s(i.charCodeAt(0)) &&
            i.charCodeAt(1) === w &&
        ...
        dirname(o) {
          ...
          if (S(g)) {
            ...
            s(g) &&
              o.charCodeAt(1) === w &&
              ((a = i > 2 && S(o.charCodeAt(2)) ? 3 : 2), (l = a));
          let h = -1,
            p = !0;
          for (let y = i - 1; y >= l; --y)
            if (S(o.charCodeAt(y))) {
        ...
        basename(o, i) {
          ...
          if (
            ...
            let p = i.length - 1,
              y = -1;
            for (h = o.length - 1; h >= a; --h) {
              const N = o.charCodeAt(h);
              if (S(N)) {
                if (!g) {
                  a = h + 1;
                  break;
            ...
            return (
              a === l ? (l = y) : l === -1 && (l = o.length), o.slice(a, l)
            );
          }
          for (h = o.length - 1; h >= a; --h)
            if (S(o.charCodeAt(h))) {
        ...
        extname(o) {
          ...
          o.length >= 2 &&
            ...
            s(o.charCodeAt(0)) &&
            (i = l = 2);
          for (let y = o.length - 1; y >= i; --y) {
            const N = o.charCodeAt(y);
            if (S(N)) {
              if (!h) {
                l = y + 1;
                break;
        ...
        parse(o) {
          ...
          if (a === 1)
            return S(g)
              ...
              : ((i.base = i.name = o), i);
          if (S(g)) {
            if (((l = 1), S(o.charCodeAt(1)))) {
              let k = 2,
                R = k;
              for (; k < a && !S(o.charCodeAt(k)); ) k++;
              if (k < a && k !== R) {
                for (R = k; k < a && S(o.charCodeAt(k)); ) k++;
                if (k < a && k !== R) {
                  for (R = k; k < a && !S(o.charCodeAt(k)); ) k++;
                  k === a ? (l = k) : k !== R && (l = k + 1);
                }
          ...
          } else if (s(g) && o.charCodeAt(1) === w) {
            if (a <= 2) return (i.root = i.dir = o), i;
            if (((l = 2), S(o.charCodeAt(2)))) {
              if (a === 3) return (i.root = i.dir = o), i;
              l = 3;
            }
          }
          l > 0 && (i.root = o.slice(0, l));
          let h = -1,
            p = l,
            y = -1,
            N = !0,
          ...
          return (
            y !== -1 &&
              (h === -1 || M === 0 || (M === 1 && h === y - 1 && h === p + 1)
                ? (i.base = i.name = o.slice(p, y))
                : ((i.name = o.slice(p, h)),
                  (i.base = o.slice(p, y)),
                  (i.ext = o.slice(h, y)))),
            p > 0 && p !== l ? (i.dir = o.slice(0, p - 1)) : (i.dir = i.root),
            i
          );
        },
        sep: '\\',
        ...
        (r.posix = {
          resolve(...o) {
            let i = '',
              a = !1;
            for (let l = o.length - 1; l >= -1 && !a; l--) {
              const g = l >= 0 ? o[l] : P.cwd();
              u(g, 'path'),
                g.length !== 0 &&
                  ((i = `${g}/${i}`), (a = g.charCodeAt(0) === f));
            }
            return (i = b(i, !a, '/', L)), a ? `/${i}` : i.length > 0 ? i : '.';
          },
          normalize(o) {
            if ((u(o, 'path'), o.length === 0)) return '.';
            const i = o.charCodeAt(0) === f,
              a = o.charCodeAt(o.length - 1) === f;
            return (
              (o = b(o, !i, '/', L)),
              o.length === 0
                ? i
          ...
          isAbsolute(o) {
            return u(o, 'path'), o.length > 0 && o.charCodeAt(0) === f;
          },
          join(...o) {
            if (o.length === 0) return '.';
            let i;
          ...
          relative(o, i) {
            if (
              ...
              u(i, 'to'),
              o === i ||
                ((o = r.posix.resolve(o)), (i = r.posix.resolve(i)), o === i))
            )
              return '';
            const a = 1,
              l = o.length,
            ...
            let N = -1,
              E = 0;
            for (; E < y; E++) {
              const k = o.charCodeAt(a + E);
              if (k !== i.charCodeAt(h + E)) break;
              k === f && (N = E);
            }
            if (E === y)
              if (p > y) {
                if (i.charCodeAt(h + E) === f) return i.slice(h + E + 1);
                if (E === 0) return i.slice(h + E);
              } else
                g > y &&
                  (o.charCodeAt(a + E) === f ? (N = E) : E === 0 && (N = 0));
            let M = '';
            for (E = a + N + 1; E <= l; ++E)
              (E === l || o.charCodeAt(E) === f) &&
                (M += M.length === 0 ? '..' : '/..');
            return `${M}${i.slice(h + N)}`;
          },
          toNamespacedPath(o) {
            return o;
          },
          ...
          parse(o) {
            ...
            if (p !== -1) {
              const M = h === 0 && a ? 1 : h;
              g === -1 || E === 0 || (E === 1 && g === p - 1 && g === h + 1)
                ? (i.base = i.name = o.slice(M, p))
                : ((i.name = o.slice(M, g)),
                  (i.base = o.slice(M, p)),
                  (i.ext = o.slice(g, p)));
            }
            return h > 0 ? (i.dir = o.slice(0, h - 1)) : a && (i.dir = '/'), i;
          },
          sep: '/',
          delimiter: ':',
          win32: null,
        ...
        (r.normalize =
          P.platform === 'win32' ? r.win32.normalize : r.posix.normalize),
        (r.resolve =
          P.platform === 'win32' ? r.win32.resolve : r.posix.resolve),
        (r.relative =
          P.platform === 'win32' ? r.win32.relative : r.posix.relative),
        (r.dirname =
          P.platform === 'win32' ? r.win32.dirname : r.posix.dirname),
        (r.basename =
          P.platform === 'win32' ? r.win32.basename : r.posix.basename),
        (r.extname =
          P.platform === 'win32' ? r.win32.extname : r.posix.extname),
        (r.sep = P.platform === 'win32' ? r.win32.sep : r.posix.sep);
    }),
    Q(X[12], K([0, 1, 3]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.StopWatch = void 0);
      const e =
      ...
      class A {
        ...
        _now() {
          return this._highResolution
            ? P.globals.performance.now()
            : Date.now();
        }
      }
      r.StopWatch = A;
    }),
    Q(X[4], K([0, 1, 10, 7, 26, 12]), function (B, r, P, e, A, c) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.Relay =
          r.EventBufferer =
      ...
      (function (L) {
        ...
        function s(W) {
          return (U, T = null, n) => {
            ...
            return (
              (j = W(
                (Y) => {
                  if (!$) return j ? j.dispose() : ($ = !0), U.call(T, Y);
                },
                null,
                n,
              )),
        ...
        L.once = s;
        function b(W, U) {
          return g((T, n = null, $) => W((j) => T.call(n, U(j)), null, $));
        }
        L.map = b;
        function m(W, U) {
          return g((T, n = null, $) =>
        ...
        L.forEach = m;
        function o(W, U) {
          return g((T, n = null, $) => W((j) => U(j) && T.call(n, j), null, $));
        }
        L.filter = o;
        function i(W) {
          return W;
        ...
        function h(W, U, T, n = 100, $ = !1) {
          ...
          return W((Z) => {
            z++,
              ...
              (Y = setTimeout(() => {
                const x = j;
                (j = void 0), (Y = void 0), (!$ || z > 1) && U(x), (z = 0);
              }, n));
          });
        }
        L.debouncedListener = h;
        function p(W, U, T = 100, n = !1, $) {
          let j,
            Y,
            z,
            Z = 0;
        ...
        L.latch = y;
        function N(W, U) {
          return [L.filter(W, U), L.filter(W, (T) => !U(T))];
        }
        L.split = N;
        function E(W, U = !1, T = []) {
          let n = T.slice(),
        ...
        class M {
          ...
          map(U) {
            return new M(b(this.event, U));
          }
          forEach(U) {
            return new M(m(this.event, U));
          }
          filter(U) {
            return new M(o(this.event, U));
          }
          reduce(U, T) {
            return new M(l(this.event, U, T));
          }
          latch() {
            return new M(y(this.event));
          }
          debounce(U, T = 100, n = !1, $) {
            return new M(p(this.event, U, T, n, $));
          }
          on(U, T, n) {
            return this.event(U, T, n);
          }
          once(U, T, n) {
            return s(this.event)(U, T, n);
          }
        }
        function k(W) {
          return new M(W);
        ...
        L.chain = k;
        function R(W, U, T = (n) => n) {
          const n = (...z) => Y.fire(T(...z)),
            $ = () => W.on(U, n),
            j = () => W.removeListener(U, n),
            Y = new w({ onFirstListenerAdd: $, onLastListenerRemove: j });
          return Y.event;
        }
        L.fromNodeEventEmitter = R;
        function I(W, U, T = (n) => n) {
          const n = (...z) => Y.fire(T(...z)),
            $ = () => W.addEventListener(U, n),
            j = () => W.removeEventListener(U, n),
            Y = new w({ onFirstListenerAdd: $, onLastListenerRemove: j });
          return Y.event;
        }
        L.fromDOMEventEmitter = I;
        function F(W) {
          return new Promise((U) => s(W)(U));
        }
        L.toPromise = F;
        function O(W, U) {
          return U(void 0), W((T) => U(T));
        }
        L.runAndSubscribe = O;
        function H(W, U) {
          let T = null;
          function n(j) {
            T == null || T.dispose(), (T = new e.DisposableStore()), U(j, T);
          }
          n(void 0);
          const $ = W((j) => n(j));
          return (0, e.toDisposable)(() => {
            $.dispose(), T == null || T.dispose();
          });
        }
        L.runAndSubscribeWithStore = H;
      })((v = r.Event || (r.Event = {})));
      class C {
        constructor(s) {
          (this._listenerCount = 0),
            ...
            (this._name = `${s}_${C._idPool++}`);
        }
        start(s) {
          (this._stopWatch = new c.StopWatch(!0)), (this._listenerCount = s);
        }
        stop() {
          if (this._stopWatch) {
            const s = this._stopWatch.elapsed();
            (this._elapsedOverall += s),
              (this._invocationCount += 1),
              console.info(
                `did FIRE ${this._name}: elapsed_ms: ${s.toFixed(
                  5,
                )}, listener: ${
                  this._listenerCount
      ...
      let f = -1;
      class d {
        constructor(s, b = Math.random().toString(18).slice(2, 5)) {
          (this.customThreshold = s),
            (this.name = b),
...
`,
              ...
              .slice(3).join(`
`),
            o = this._stacks.get(m) || 0;
          if (
            (this._stacks.set(m, o + 1),
            (this._warnCountdown -= 1),
            this._warnCountdown <= 0)
          ) {
            this._warnCountdown = b * 0.5;
            let i,
              a = 0;
            for (const [l, g] of this._stacks)
              (!i || a < g) && ((i = l), (a = g));
            console.warn(
              `[${this.name}] potential listener LEAK detected, having ${s} listeners already. MOST frequent listener (${a}):`,
            ),
              console.warn(i);
          }
          return () => {
            const i = this._stacks.get(m) || 0;
            this._stacks.set(m, i - 1);
          };
        }
      }
      class w {
          ...
          return (
            this._event ||
              (this._event = (s, b, m) => {
                ...
                const a = this._listeners.push(b ? [s, b] : s);
                i &&
                  this._options &&
                  ...
                  this._options &&
                    ...
                    this._options.onListenerDidAdd(this, s, b);
                const l =
                    (o = this._leakageMon) === null || o === void 0
                      ? void 0
                ...
                return (
                  m instanceof e.DisposableStore
                    ? m.add(g)
                    : Array.isArray(m) && m.push(g),
                  g
                );
              }),
            this._event
        ...
        fire(s) {
          var b, m;
          if (this._listeners) {
            this._deliveryQueue || (this._deliveryQueue = new A.LinkedList());
            for (let o of this._listeners) this._deliveryQueue.push([o, s]);
            for (
              (b = this._perfMon) === null ||
              b === void 0 ||
              b.start(this._deliveryQueue.size);
              this._deliveryQueue.size > 0;

            ) {
              const [o, i] = this._deliveryQueue.shift();
              try {
                typeof o == 'function' ? o.call(void 0, i) : o[0].call(o[1], i);
              } catch (a) {
                (0, P.onUnexpectedError)(a);
              }
            }
        ...
        dispose() {
          ...
          this._disposed ||
            ((this._disposed = !0),
            (s = this._listeners) === null || s === void 0 || s.clear(),
            (b = this._deliveryQueue) === null || b === void 0 || b.clear(),
            (o =
              (m = this._options) === null || m === void 0
                ? void 0
                : m.onLastListenerRemove) === null ||
              o === void 0 ||
              o.call(m),
      ...
      class t extends w {
        constructor(s) {
          ...
          (this._isPaused = 0),
            ...
            (this._mergeFn = s == null ? void 0 : s.merge);
        }
        pause() {
          this._isPaused++;
        }
        resume() {
          if (this._isPaused !== 0 && --this._isPaused == 0)
            if (this._mergeFn) {
              const s = Array.from(this._eventQueue);
              this._eventQueue.clear(), super.fire(this._mergeFn(s));
            } else
        ...
        fire(s) {
          this._listeners &&
            (this._isPaused !== 0 ? this._eventQueue.push(s) : super.fire(s));
        }
      }
      r.PauseableEmitter = t;
      class _ extends t {
        constructor(s) {
          var b;
          super(s);
          this._delay = (b = s.delay) !== null && b !== void 0 ? b : 100;
        }
        fire(s) {
          this._handle ||
            (this.pause(),
      ...
      class u {
          ...
          return (b, m, o) =>
            s(
              (i) => {
                ...
                a ? a.push(() => b.call(m, i)) : b.call(m, i);
              },
              void 0,
              o,
            );
        ...
        bufferEvents(s) {
          ...
          this.buffers.push(b);
          const m = s();
          return this.buffers.pop(), b.forEach((o) => o()), m;
        }
      }
      r.EventBufferer = u;
      class S {
        ...
        set input(s) {
          (this.inputEvent = s),
            this.listening &&
              ...
              (this.inputEventListener = s(this.emitter.fire, this.emitter)));
        }
        dispose() {
    ...
    Q(X[13], K([0, 1, 4]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.CancellationTokenSource = r.CancellationToken = void 0);
      const e = Object.freeze(function (C, f) {
        const d = setTimeout(C.bind(f), 0);
        return {
          dispose() {
            clearTimeout(d);
          },
      ...
      (function (C) {
        function f(d) {
          return d === C.None || d === C.Cancelled || d instanceof c
            ? !0
            : !d || typeof d != 'object'
            ? !1
        ...
        constructor(f) {
          (this._token = void 0),
            ...
            (this._parentListener =
              f && f.onCancellationRequested(this.cancel, this));
        }
        get token() {
  ...
  var ne =
      ...
      function (B, r, P, e) {
        ...
        return new (P || (P = Promise))(function (c, v) {
          function C(w) {
            try {
              d(e.next(w));
            } catch (t) {
          ...
          function d(w) {
            w.done ? c(w.value) : A(w.value).then(C, f);
          }
          d((e = e.apply(B, r || [])).next());
        });
      },
    be =
  ...
  Q(X[28], K([0, 1, 13, 10, 4, 7, 3]), function (B, r, P, e, A, c, v) {
    'use strict';
    Object.defineProperty(r, '__esModule', { value: !0 }),
      (r.createCancelableAsyncIterable =
        r.CancelableAsyncIterableObject =
        r.AsyncIterableObject =
        r.Promises =
        r.DeferredPromise =
        r.IdleValue =
        r.runWhenIdle =
    ...
    r.isThenable = C;
    function f(N) {
      const E = new P.CancellationTokenSource(),
        M = N(E.token),
        k = new Promise((R, I) => {
          const F = E.token.onCancellationRequested(() => {
            F.dispose(), E.dispose(), I(new e.CancellationError());
          });
          Promise.resolve(M).then(
            (O) => {
              F.dispose(), E.dispose(), R(O);
            },
            (O) => {
              F.dispose(), E.dispose(), I(O);
            },
          );
        });
      return new (class {
    ...
    r.createCancelablePromise = f;
    function d(N, E, M) {
      return new Promise((k, R) => {
        const I = E.onCancellationRequested(() => {
          I.dispose(), k(M);
        });
        N.then(k, R).finally(() => I.dispose());
      });
    }
    r.raceCancellation = d;
    class w {
      constructor() {
      ...
      queue(E) {
        if (this.activePromise) {
          if (((this.queuedPromiseFactory = E), !this.queuedPromise)) {
            const M = () => {
              this.queuedPromise = null;
              const k = this.queue(this.queuedPromiseFactory);
              return (this.queuedPromiseFactory = null), k;
            };
            this.queuedPromise = new Promise((k) => {
              this.activePromise.then(M, M).then(k);
            });
          }
          return new Promise((M, k) => {
            this.queuedPromise.then(M, k);
          });
        }
        return (
          ...
          new Promise((M, k) => {
            this.activePromise.then(
              (R) => {
                (this.activePromise = null), M(R);
              },
              (R) => {
                (this.activePromise = null), k(R);
              },
            );
          })
        );
    ...
    r.MicrotaskDelay = Symbol('MicrotaskDelay');
    class u {
      constructor(E) {
        (this.defaultDelay = E),
          (this.deferred = null),
      ...
      trigger(E, M = this.defaultDelay) {
        ...
        const k = () => {
          var R;
          (this.deferred = null),
            (R = this.doResolve) === null || R === void 0 || R.call(this, null);
        };
        return (
          (this.deferred = M === r.MicrotaskDelay ? _(k) : t(M, k)),
          this.completionPromise
        );
      }
      isTriggered() {
        var E;
        return !!((E = this.deferred) === null || E === void 0
          ? void 0
          : E.isTriggered());
      }
      cancel() {
        this.cancelTimeout(),
          this.completionPromise &&
            (this.doReject && this.doReject(new e.CancellationError()),
            (this.completionPromise = null));
      }
      cancelTimeout() {
        var E;
        (E = this.deferred) === null || E === void 0 || E.dispose(),
          (this.deferred = null);
      }
      dispose() {
        this.cancel();
    ...
    class S {
      constructor(E) {
        (this.delayer = new u(E)), (this.throttler = new w());
      }
      trigger(E, M) {
        return this.delayer.trigger(() => this.throttler.queue(E), M);
      }
      dispose() {
        this.delayer.dispose();
      }
    }
    r.ThrottledDelayer = S;
    function L(N, E) {
      return E
        ? new Promise((M, k) => {
            const R = setTimeout(() => {
              ...
              I = E.onCancellationRequested(() => {
                clearTimeout(R), I.dispose(), k(new e.CancellationError());
              });
          })
        : f((M) => L(N, M));
    }
    r.timeout = L;
    function s(N, E = 0) {
      const M = setTimeout(N, E);
      return (0, c.toDisposable)(() => clearTimeout(M));
    }
    r.disposableTimeout = s;
    function b(N, E = (k) => !!k, M = null) {
      let k = 0;
      const R = N.length,
        I = () => {
          if (k >= R) return Promise.resolve(M);
          const F = N[k++];
          return Promise.resolve(F()).then((H) =>
            E(H) ? Promise.resolve(H) : I(),
          );
        };
      return I();
    }
    ...
    class a {
      constructor(E) {
        (this._didRun = !1),
          ...
          (this._handle = (0, r.runWhenIdle)(() => this._executor()));
      }
      dispose() {
    ...
    class l {
      constructor() {
        (this.rejected = !1),
          (this.resolved = !1),
          (this.p = new Promise((E, M) => {
            (this.completeCallback = E), (this.errorCallback = M);
          }));
      }
      get isRejected() {
      ...
      complete(E) {
        return new Promise((M) => {
          this.completeCallback(E), (this.resolved = !0), M();
        });
      }
      cancel() {
        new Promise((E) => {
          this.errorCallback(new e.CancellationError()),
            (this.rejected = !0),
            E();
        });
      }
    ...
    class h {
      constructor(E) {
        (this._state = 0),
          ...
          queueMicrotask(() =>
            ne(this, void 0, void 0, function* () {
              const M = {
                emitOne: (k) => this.emitOne(k),
                emitMany: (k) => this.emitMany(k),
                reject: (k) => this.reject(k),
              };
              try {
                yield Promise.resolve(E(M)), this.resolve();
              } catch (k) {
                this.reject(k);
              } finally {
                (M.emitOne = void 0),
            ...
            yield Promise.all(
              E.map((k) => {
                ...
                return ne(this, void 0, void 0, function* () {
                  var F, O;
                  try {
                    for (R = be(k); (I = yield R.next()), !I.done; ) {
                      const H = I.value;
                      M.emitOne(H);
                    }
                  } catch (H) {
                    ...
                    try {
                      I && !I.done && (O = R.return) && (yield O.call(R));
                    } finally {
                      if (F) throw F.error;
                    }
                  }
          ...
          next: () =>
            ne(this, void 0, void 0, function* () {
              do {
                ...
                yield A.Event.toPromise(this._onStateChanged.event);
              } while (!0);
            }),
        };
      }
      static map(E, M) {
        return new h((k) =>
          ne(this, void 0, void 0, function* () {
            var R, I;
            try {
              for (var F = be(E), O; (O = yield F.next()), !O.done; ) {
                const H = O.value;
                k.emitOne(M(H));
              }
            } catch (H) {
              ...
              try {
                O && !O.done && (I = F.return) && (yield I.call(F));
              } finally {
                if (R) throw R.error;
              }
            }
      ...
      filter(E) {
        return h.filter(this, E);
      }
      static coalesce(E) {
        return h.filter(E, (M) => !!M);
      }
      coalesce() {
      ...
      static toPromise(E) {
        ...
        return ne(this, void 0, void 0, function* () {
          const F = [];
          try {
            for (M = be(E); (k = yield M.next()), !k.done; ) {
              const O = k.value;
              F.push(O);
            }
          } catch (O) {
            ...
            try {
              k && !k.done && (I = M.return) && (yield I.call(M));
            } finally {
              if (R) throw R.error;
            }
          }
    ...
    (r.AsyncIterableObject = h), (h.EMPTY = h.fromArray([]));
    class p extends h {
      constructor(E, M) {
        super(M);
        this._source = E;
    ...
    r.CancelableAsyncIterableObject = p;
    function y(N) {
      const E = new P.CancellationTokenSource(),
        M = N(E.token);
      return new p(E, (k) =>
        ne(this, void 0, void 0, function* () {
          var R, I;
          const F = E.token.onCancellationRequested(() => {
            F.dispose(), E.dispose(), k.reject(new e.CancellationError());
          });
          try {
            try {
              for (var O = be(M), H; (H = yield O.next()), !H.done; ) {
                const W = H.value;
              ...
              try {
                H && !H.done && (I = O.return) && (yield I.call(O));
              } finally {
                if (R) throw R.error;
              }
            }
            ...
            F.dispose(), E.dispose(), k.reject(W);
          }
        }),
      );
    }
    r.createCancelableAsyncIterable = y;
  }),
    Q(X[2], K([0, 1, 19, 25]), function (B, r, P, e) {
      'use strict';
      var A;
      Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      r.isFalsyOrWhitespace = c;
      const v = /{(\d+)}/g;
      function C(D, ...q) {
        return q.length === 0
          ? D
          : D.replace(v, function (V, G) {
              const J = parseInt(G, 10);
              return isNaN(J) || J < 0 || J >= q.length ? V : q[J];
            });
      }
      r.format = C;
      function f(D) {
      ...
      function t(D, q) {
        if (!D || !q) return D;
        const V = q.length;
        if (V === 0 || D.length === 0) return D;
        let G = 0;
        for (; D.indexOf(q, G) === G; ) G = G + V;
      ...
      function _(D, q) {
        ...
        let J = G,
          re = -1;
        for (; (re = D.lastIndexOf(q, J - 1)), !(re === -1 || re + V !== J); ) {
          if (re === 0) return '';
          J = re;
        }
      ...
      r.stripWildcards = S;
      function L(D, q, V = {}) {
        if (!D) throw new Error('Cannot create regex from empty string');
        q || (D = d(D)),
          V.wholeWord &&
            (/\B/.test(D.charAt(0)) || (D = '\\b' + D),
            /\B/.test(D.charAt(D.length - 1)) || (D = D + '\\b'));
        let G = '';
        return (
          V.global && (G += 'g'),
          V.matchCase || (G += 'i'),
      ...
      function s(D) {
        return D.source === '^' ||
          ...
          D.source === '^\\s*$'
          ? !1
          : !!(D.exec('') && D.lastIndex === 0);
      }
      r.regExpLeadsToEndlessLoop = s;
      function b(D) {
        return (
          (D.global ? 'g' : '') +
          (D.ignoreCase ? 'i' : '') +
      ...
      r.firstNonWhitespaceIndex = o;
      function i(D, q = 0, V = D.length) {
        for (let G = q; G < V; G++) {
          const J = D.charCodeAt(G);
          if (J !== 32 && J !== 9) return D.substring(q, G);
        }
        return D.substring(q, V);
      }
      r.getLeadingWhitespace = i;
      function a(D, q = D.length - 1) {
        for (let V = q; V >= 0; V--) {
          const G = D.charCodeAt(V);
          if (G !== 32 && G !== 9) return V;
        }
        return -1;
      }
      ...
      r.compare = l;
      function g(D, q, V = 0, G = D.length, J = 0, re = q.length) {
        for (; V < G && J < re; V++, J++) {
          let ce = D.charCodeAt(V),
            ie = q.charCodeAt(J);
          if (ce < ie) return -1;
          if (ce > ie) return 1;
        }
      ...
      function h(D, q) {
        return p(D, q, 0, D.length, 0, q.length);
      }
      r.compareIgnoreCase = h;
      function p(D, q, V = 0, G = D.length, J = 0, re = q.length) {
        for (; V < G && J < re; V++, J++) {
          let ce = D.charCodeAt(V),
            ie = q.charCodeAt(J);
          if (ce === ie) continue;
          if (ce >= 128 || ie >= 128)
            return g(D.toLowerCase(), q.toLowerCase(), V, G, J, re);
          y(ce) && (ce -= 32), y(ie) && (ie -= 32);
          const oe = ce - ie;
          if (oe !== 0) return oe;
        }
        const ae = G - V,
      ...
      r.compareSubstringIgnoreCase = p;
      function y(D) {
        return D >= 97 && D <= 122;
      }
      r.isLowerAsciiLetter = y;
      function N(D) {
        return D >= 65 && D <= 90;
      }
      r.isUpperAsciiLetter = N;
      function E(D, q) {
        return D.length === q.length && p(D, q) === 0;
      }
      r.equalsIgnoreCase = E;
      function M(D, q) {
        const V = q.length;
        return q.length > D.length ? !1 : p(D, q, 0, V) === 0;
      }
      r.startsWithIgnoreCase = M;
      function k(D, q) {
        let V,
          G = Math.min(D.length, q.length);
        for (V = 0; V < G; V++)
          if (D.charCodeAt(V) !== q.charCodeAt(V)) return V;
        return G;
      }
      ...
      function R(D, q) {
        ...
        const J = D.length - 1,
          re = q.length - 1;
        for (V = 0; V < G; V++)
          if (D.charCodeAt(J - V) !== q.charCodeAt(re - V)) return V;
        return G;
      }
      ...
      r.isLowSurrogate = F;
      function O(D, q) {
        return ((D - 55296) << 10) + (q - 56320) + 65536;
      }
      r.computeCodePoint = O;
      function H(D, q, V) {
        const G = D.charCodeAt(V);
        if (I(G) && V + 1 < q) {
          const J = D.charCodeAt(V + 1);
          if (F(J)) return O(G, J);
        }
        return G;
      }
      r.getNextCodePoint = H;
      function W(D, q) {
        const V = D.charCodeAt(q - 1);
        if (F(V) && q > 1) {
          const G = D.charCodeAt(q - 2);
          if (I(G)) return O(G, V);
        }
        return V;
      }
      class U {
        constructor(q, V = 0) {
          (this._str = q), (this._len = q.length), (this._offset = V);
        }
        get offset() {
          return this._offset;
        }
        ...
        prevCodePoint() {
          const q = W(this._str, this._offset);
          return (this._offset -= q >= 65536 ? 2 : 1), q;
        }
        nextCodePoint() {
          const q = H(this._str, this._len, this._offset);
          return (this._offset += q >= 65536 ? 2 : 1), q;
        }
        eol() {
      ...
      r.CodePointIterator = U;
      class T {
        constructor(q, V = 0) {
          this._iterator = new U(q, V);
        }
        get offset() {
        ...
        nextGraphemeLength() {
          const q = de.getInstance(),
            V = this._iterator,
            G = V.offset;
          let J = q.getGraphemeBreakType(V.nextCodePoint());
          for (; !V.eol(); ) {
            const re = V.offset,
              ae = q.getGraphemeBreakType(V.nextCodePoint());
            if (we(J, ae)) {
              V.setOffset(re);
              break;
            }
        ...
        prevGraphemeLength() {
          const q = de.getInstance(),
            V = this._iterator,
            G = V.offset;
          let J = q.getGraphemeBreakType(V.prevCodePoint());
          for (; V.offset > 0; ) {
            const re = V.offset,
              ae = q.getGraphemeBreakType(V.prevCodePoint());
            if (we(ae, J)) {
              V.setOffset(re);
              break;
            }
      ...
      r.GraphemeIterator = T;
      function n(D, q) {
        return new T(D, q).nextGraphemeLength();
      }
      r.nextCharLength = n;
      function $(D, q) {
        return new T(D, q).prevGraphemeLength();
      }
      r.prevCharLength = $;
      function j(D, q) {
        q > 0 && F(D.charCodeAt(q)) && q--;
        const V = q + n(D, q);
        return [V - $(D, V), V];
      }
      r.getCharContainingOffset = j;
      const Y =
      ...
      function ee(D) {
        return r.UNUSUAL_LINE_TERMINATORS.test(D);
      }
      ...
      (r.isEmojiImprecise = le),
        (r.UTF8_BOM_CHARACTER = String.fromCharCode(65279));
      function he(D) {
        return !!(D && D.length > 0 && D.charCodeAt(0) === 65279);
      }
      r.startsWithUTF8BOM = he;
      function me(D, q = !1) {
        return D
          ? (q && (D = D.replace(/\\./g, '')), D.toLowerCase() !== D)
          : !1;
      }
      r.containsUppercaseCharacter = me;
      function Se(D) {
        const q = 90 - 65 + 1;
        return (
          (D = D % (2 * q)),
          D < q ? String.fromCharCode(97 + D) : String.fromCharCode(65 + D - q)
        );
      }
      ...
      function we(D, q) {
        return D === 0
          ...
          : D === 2 && q === 3
          ? !1
          : D === 4 || D === 2 || D === 3 || q === 4 || q === 2 || q === 3
          ? !0
          : !(
              (D === 8 && (q === 8 || q === 9 || q === 11 || q === 12)) ||
              ((D === 11 || D === 9) && (q === 9 || q === 10)) ||
              ((D === 12 || D === 10) && q === 10) ||
              q === 5 ||
              q === 13 ||
      ...
      r.getLeftDeleteOffset = Ae;
      function Ne(D, q) {
        const V = new U(q, D);
        let G = V.prevCodePoint();
        for (; Ee(G) || G === 65039 || G === 8419; ) {
          if (V.offset === 0) return;
          G = V.prevCodePoint();
        }
        if (!le(G)) return;
        let J = V.offset;
        return J > 0 && V.prevCodePoint() === 8205 && (J = V.offset), J;
      }
      function Ee(D) {
      ...
      class ue {
        ...
        static getInstance(q) {
          return ue.cache.get(Array.from(q));
        }
        static getLocales() {
      ...
      (r.AmbiguousCharacters = ue),
        ...
        (ue.cache = new P.LRUCachedComputed((D) => {
          function q(ie) {
            const oe = new Map();
            for (let fe = 0; fe < ie.length; fe += 2)
              oe.set(ie[fe], ie[fe + 1]);
            return oe;
          }
          function V(ie, oe) {
            const fe = new Map(ie);
            for (const [Ce, ve] of oe) fe.set(Ce, ve);
            return fe;
          }
          function G(ie, oe) {
            if (!ie) return oe;
            const fe = new Map();
            for (const [Ce, ve] of ie) oe.has(Ce) && fe.set(Ce, ve);
            return fe;
          }
          const J = A.ambiguousCharacterData.getValue();
          let re = D.filter((ie) => !ie.startsWith('_') && ie in J);
      ...
      class _e {
        ...
        static isInvisibleCharacter(q) {
          return _e.getData().has(q);
        }
        static get codePoints() {
          return _e.getData();
        }
      }
      (r.InvisibleCharacters = _e), (_e._data = void 0);
    }),
    Q(X[29], K([0, 1, 8, 3, 2]), function (B, r, P, e, A) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.hasDriveLetter =
          r.isRootOrDriveLetter =
      ...
      r.isPathSeparator = c;
      function v(u) {
        return u.replace(/[\\/]/g, P.posix.sep);
      }
      r.toSlashes = v;
      function C(u) {
        return (
      ...
      r.toPosixPath = C;
      function f(u, S = P.posix.sep) {
        if (!u) return '';
        const L = u.length,
          s = u.charCodeAt(0);
        if (c(s)) {
          if (c(u.charCodeAt(1)) && !c(u.charCodeAt(2))) {
            let m = 3;
            const o = m;
            for (; m < L && !c(u.charCodeAt(m)); m++);
            if (o !== m && !c(u.charCodeAt(m + 1))) {
              for (m += 1; m < L; m++)
                if (c(u.charCodeAt(m)))
                  return u.slice(0, m + 1).replace(/[\\/]/g, S);
            }
          }
          return S;
        } else if (w(s) && u.charCodeAt(1) === 58) return c(u.charCodeAt(2)) ? u.slice(0, 2) + S : u.slice(0, 2);
        let b = u.indexOf('://');
        if (b !== -1) {
          for (b += 3; b < L; b++)
            if (c(u.charCodeAt(b))) return u.slice(0, b + 1);
        }
        return '';
      }
      r.getRoot = f;
      function d(u, S, L, s = P.sep) {
        if (u === S) return !0;
        if (!u || !S || S.length > u.length) return !1;
        if (L) {
          if (!(0, A.startsWithIgnoreCase)(u, S)) return !1;
          if (S.length === u.length) return !0;
          let m = S.length;
          return S.charAt(S.length - 1) === s && m--, u.charAt(m) === s;
        }
        return S.charAt(S.length - 1) !== s && (S += s), u.indexOf(S) === 0;
      }
      r.isEqualOrParent = d;
      function w(u) {
        return (u >= 65 && u <= 90) || (u >= 97 && u <= 122);
      }
      r.isWindowsDriveLetter = w;
      function t(u) {
        const S = (0, P.normalize)(u);
        return e.isWindows
          ? u.length > 3
            ? !1
            : _(S) && (u.length === 2 || S.charCodeAt(2) === 92)
          : S === P.posix.sep;
      }
      r.isRootOrDriveLetter = t;
      function _(u, S) {
        return (S !== void 0 ? S : e.isWindows)
          ? w(u.charCodeAt(0)) && u.charCodeAt(1) === 58
          : !1;
      }
      r.hasDriveLetter = _;
    }),
    Q(X[30], K([0, 1, 2]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.StringSHA1 =
          r.toHexString =
      ...
      r.numberHash = c;
      function v(L, s) {
        return c(L ? 433 : 863, s);
      }
      function C(L, s) {
        s = c(149417, s);
        for (let b = 0, m = L.length; b < m; b++) s = c(L.charCodeAt(b), s);
        return s;
      }
      r.stringHash = C;
      function f(L, s) {
        return (s = c(104579, s)), L.reduce((b, m) => A(m, b), s);
      }
      function d(L, s) {
        return (
          (s = c(181387, s)),
      ...
      function t(L, s = 0, b = L.byteLength, m = 0) {
        for (let o = 0; o < b; o++) L[s + o] = m;
      }
      function _(L, s, b = '0') {
        for (; L.length < s; ) L = b + L;
        return L;
      }
      function u(L, s = 32) {
      ...
      class S {
        ...
        update(s) {
          ...
          for (
            i !== 0
              ? ((a = i), (l = -1), (i = 0))
              : ((a = s.charCodeAt(0)), (l = 0));
            ;

          ) {
            let g = a;
            if (P.isHighSurrogate(a))
              if (l + 1 < b) {
                const h = s.charCodeAt(l + 1);
                P.isLowSurrogate(h)
                  ? (l++, (g = P.computeCodePoint(a, h)))
                  : (g = 65533);
              } else {
                i = a;
                break;
              }
            else P.isLowSurrogate(a) && (g = 65533);
            if (((o = this._push(m, o, g)), l++, l < b)) a = s.charCodeAt(l);
            else break;
          }
        ...
        _step() {
          const s = S._bigBlock32,
            b = this._buffDV;
          for (let y = 0; y < 64; y += 4)
            s.setUint32(y, b.getUint32(y, !1), !1);
          ...
          for (let y = 0; y < 80; y++)
            y < 20
              ? ((g = (o & i) | (~o & a)), (h = 1518500249))
              : y < 40
              ? ((g = o ^ i ^ a), (h = 1859775393))
              : y < 60
              ? ((g = (o & i) | (o & a) | (i & a)), (h = 2400959708))
              : ((g = o ^ i ^ a), (h = 3395469782)),
              (p = (w(m, 5) + g + l + h + s.getUint32(y * 4, !1)) & 4294967295),
              (l = a),
              (a = i),
              (i = w(o, 30)),
              (o = m),
              (m = p);
          (this._h0 = (this._h0 + m) & 4294967295),
      ...
      (r.StringSHA1 = S), (S._bigBlock32 = new DataView(new ArrayBuffer(320)));
    }),
    Q(X[14], K([0, 1, 21, 30]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.LcsDiff =
          r.MyArray =
      ...
      class A {
        ...
        getElements() {
          ...
          for (let u = 0, S = t.length; u < S; u++) _[u] = t.charCodeAt(u);
          return _;
        }
      }
      r.StringDiffSequence = A;
      function c(w, t, _) {
        return new d(new A(w), new A(t)).ComputeDiff(_).changes;
      }
      r.stringDiff = c;
      class v {
        static Assert(t, _) {
      ...
      r.Debug = v;
      class C {
        static Copy(t, _, u, S, L) {
          for (let s = 0; s < L; s++) u[S + s] = t[_ + s];
        }
        static Copy2(t, _, u, S, L) {
          for (let s = 0; s < L; s++) u[S + s] = t[_ + s];
        }
      }
      r.MyArray = C;
      ...
      class d {
        ...
        static _getElements(t) {
          const _ = t.getElements();
          if (d._isStringArray(_)) {
            const u = new Int32Array(_.length);
            for (let S = 0, L = _.length; S < L; S++)
              u[S] = (0, e.stringHash)(_[S], 0);
            return [_, u, !0];
          }
        ...
        ElementsAreStrictEqual(t, _) {
          if (!this.ElementsAreEqual(t, _)) return !1;
          const u = d._getStrictElement(this._originalSequence, t),
            S = d._getStrictElement(this._modifiedSequence, _);
          return u === S;
        }
        static _getStrictElement(t, _) {
          return typeof t.getStrictElement == 'function'
            ? t.getStrictElement(_)
            : null;
        }
        OriginalElementsAreEqual(t, _) {
          return this._originalElementsOrHash[t] !==
        ...
        _ComputeDiff(t, _, u, S, L) {
          const s = [!1];
          let b = this.ComputeDiffRecursive(t, _, u, S, s);
          return (
            L && (b = this.PrettifyChanges(b)), { quitEarly: s[0], changes: b }
          );
        }
        ComputeDiffRecursive(t, _, u, S, L) {
          for (L[0] = !1; t <= _ && u <= S && this.ElementsAreEqual(t, u); )
            t++, u++;
          for (; _ >= t && S >= u && this.ElementsAreEqual(_, S); ) _--, S--;
          if (t > _ || u > S) {
            let a;
            return (
              u <= S
                ? (v.Assert(
                  ...
                  (a = [new P.DiffChange(t, 0, u, S - u + 1)]))
                : t <= _
                ? (v.Assert(
                    u === S + 1,
                    'modifiedStart should only be one more than modifiedEnd',
                  ),
                  (a = [new P.DiffChange(t, _ - t + 1, u, 0)]))
                : (v.Assert(
                    t === _ + 1,
                    'originalStart should only be one more than originalEnd',
                  ),
          ...
          const s = [0],
            b = [0],
            m = this.ComputeRecursionPoint(t, _, u, S, s, b, L),
            o = s[0],
            i = b[0];
          if (m !== null) return m;
          if (!L[0]) {
            const a = this.ComputeDiffRecursive(t, o, u, i, L);
            let l = [];
            return (
              L[0]
                ? (l = [
                ...
                : (l = this.ComputeDiffRecursive(o + 1, _, i + 1, S, L)),
              this.ConcatenateChanges(a, l)
            );
          }
          return [new P.DiffChange(t, _ - t + 1, u, S - u + 1)];
        }
        WALKTRACE(t, _, u, S, L, s, b, m, o, i, a, l, g, h, p, y, N, E) {
          let M = null,
            k = null,
            R = new f(),
            I = _,
          ...
          do {
            ...
            U === I || (U < F && o[U - 1] < o[U + 1])
              ? ((a = o[U + 1]),
                (h = a - O - S),
                a < H && R.MarkNextChange(),
                (H = a),
                R.AddModifiedElement(a + 1, h),
                (O = U + 1 - t))
              : ((a = o[U - 1] + 1),
                (h = a - O - S),
                a < H && R.MarkNextChange(),
                (H = a - 1),
                R.AddOriginalElement(a, h + 1),
                (O = U - 1 - t)),
              W >= 0 &&
                ((o = this.m_forwardHistory[W]),
                (t = o[0]),
                (I = 1),
                (F = o.length - 1));
          } while (--W >= -1);
          if (((M = R.getReverseChanges()), E[0])) {
            let U = g[0] + 1,
              T = y[0] + 1;
            if (M !== null && M.length > 0) {
              const n = M[M.length - 1];
              (U = Math.max(U, n.getOriginalEnd())),
                (T = Math.max(T, n.getModifiedEnd()));
            }
            k = [new P.DiffChange(U, l - U + 1, T, p - T + 1)];
          } else {
            (R = new f()),
              (I = s),
              (F = b),
            ...
            do {
              ...
              U === I || (U < F && i[U - 1] >= i[U + 1])
                ? ((a = i[U + 1] - 1),
                  ...
                  a > H && R.MarkNextChange(),
                  (H = a + 1),
                  R.AddOriginalElement(a + 1, h + 1),
                  (O = U + 1 - L))
                : ((a = i[U - 1]),
                  (h = a - O - m),
                  a > H && R.MarkNextChange(),
                  (H = a),
                  R.AddModifiedElement(a + 1, h + 1),
                  (O = U - 1 - L)),
                W >= 0 &&
                  ((i = this.m_reverseHistory[W]),
                  (L = i[0]),
                  (I = 1),
                  (F = i.length - 1));
            } while (--W >= -1);
          ...
          return this.ConcatenateChanges(M, k);
        }
        ComputeRecursionPoint(t, _, u, S, L, s, b) {
          let m = 0,
            o = 0,
            i = 0,
            a = 0,
          ...
          const h = _ - t + (S - u),
            ...
            F = (M - E) % 2 == 0;
          (y[E] = t), (N[M] = _), (b[0] = !1);
          for (let O = 1; O <= h / 2 + 1; O++) {
            let H = 0,
              W = 0;
            (i = this.ClipDiagonalBound(E - O, O, E, p)),
              (a = this.ClipDiagonalBound(E + O, O, E, p));
            for (let T = i; T <= a; T += 2) {
              T === i || (T < a && y[T - 1] < y[T + 1])
                ? (m = y[T + 1])
                : (m = y[T - 1] + 1),
                (o = m - (T - E) - k);
              const n = m;
              for (; m < _ && o < S && this.ElementsAreEqual(m + 1, o + 1); )
                m++, o++;
              if (
                ((y[T] = m),
                m + o > H + W && ((H = m), (W = o)),
                !F && Math.abs(T - M) <= O - 1 && m >= N[T])
              )
                return (
                  (L[0] = m),
                  (s[0] = o),
                  n <= N[T] && 1447 > 0 && O <= 1447 + 1
                    ? this.WALKTRACE(
                        E,
                        i,
                        a,
            ...
            if (
              ...
              return (
                ...
                U > 0 && 1447 > 0 && O <= 1447 + 1
                  ...
                  : (t++, u++, [new P.DiffChange(t, _ - t + 1, u, S - u + 1)])
              );
            (l = this.ClipDiagonalBound(M - O, O, M, p)),
              (g = this.ClipDiagonalBound(M + O, O, M, p));
            for (let T = l; T <= g; T += 2) {
              T === l || (T < g && N[T - 1] >= N[T + 1])
                ? (m = N[T + 1] - 1)
                : (m = N[T - 1]),
                (o = m - (T - M) - R);
              const n = m;
              for (; m > t && o > u && this.ElementsAreEqual(m, o); ) m--, o--;
              if (((N[T] = m), F && Math.abs(T - E) <= O && m <= y[T]))
                return (
                  (L[0] = m),
                  (s[0] = o),
                  n >= y[T] && 1447 > 0 && O <= 1447 + 1
                    ? this.WALKTRACE(
                        E,
                        i,
                        a,
            ...
            if (O <= 1447) {
              let T = new Int32Array(a - i + 2);
              (T[0] = E - i + 1),
                C.Copy2(y, i, T, 1, a - i + 1),
                this.m_forwardHistory.push(T),
                (T = new Int32Array(g - l + 2)),
                (T[0] = M - l + 1),
                C.Copy2(N, l, T, 1, g - l + 1),
        ...
        PrettifyChanges(t) {
          for (let _ = 0; _ < t.length; _++) {
            const u = t[_],
              ...
              s = u.originalLength > 0,
              b = u.modifiedLength > 0;
            for (
              ;
              u.originalStart + u.originalLength < S &&
              u.modifiedStart + u.modifiedLength < L &&
              (!s ||
              ...
              const o = this.ElementsAreStrictEqual(
                u.originalStart,
                u.modifiedStart,
              );
              if (
            ...
            let m = [null];
            if (_ < t.length - 1 && this.ChangesOverlap(t[_], t[_ + 1], m)) {
              (t[_] = m[0]), t.splice(_ + 1, 1), _--;
              continue;
            }
          }
          for (let _ = t.length - 1; _ >= 0; _--) {
            ...
            for (let a = 1; ; a++) {
              const l = u.originalStart - a,
                g = u.modifiedStart - a;
              if (
                l < S ||
                g < L ||
                (s &&
                  !this.OriginalElementsAreEqual(l, l + u.originalLength)) ||
                (b && !this.ModifiedElementsAreEqual(g, g + u.modifiedLength))
              )
                break;
              const p =
                (l === S && g === L ? 5 : 0) +
                this._boundaryScore(l, u.originalLength, g, u.modifiedLength);
              p > o && ((o = p), (m = a));
            }
            (u.originalStart -= m), (u.modifiedStart -= m);
            const i = [null];
            if (_ > 0 && this.ChangesOverlap(t[_ - 1], t[_], i)) {
              (t[_ - 1] = i[0]), t.splice(_, 1), _++;
              continue;
            }
          }
          if (this._hasStrings)
            for (let _ = 1, u = t.length; _ < u; _++) {
              const S = t[_ - 1],
                L = t[_],
                s = L.originalStart - S.originalStart - S.originalLength,
                b = S.originalStart,
                ...
                l = a - i;
              if (s < 5 && o < 20 && l < 20) {
                const g = this._findBetterContiguousSequence(b, o, i, l, s);
                if (g) {
                  const [h, p] = g;
                  (h !== S.originalStart + S.originalLength ||
                    p !== S.modifiedStart + S.modifiedLength) &&
                    ((S.originalLength = h - S.originalStart),
                    (S.modifiedLength = p - S.modifiedStart),
                    (L.originalStart = h + s),
                    (L.modifiedStart = p + s),
        ...
        _findBetterContiguousSequence(t, _, u, S, L) {
          if (_ < L || S < L) return null;
          const s = t + _ - L + 1,
            b = u + S - L + 1;
          let m = 0,
            o = 0,
          ...
          for (let a = t; a < s; a++)
            for (let l = u; l < b; l++) {
              const g = this._contiguousSequenceScore(a, l, L);
              g > 0 && g > m && ((m = g), (o = a), (i = l));
            }
          return m > 0 ? [o, i] : null;
        }
        _contiguousSequenceScore(t, _, u) {
          let S = 0;
          for (let L = 0; L < u; L++) {
            if (!this.ElementsAreEqual(t + L, _ + L)) return 0;
            S += this._originalStringElements[t + L].length;
          }
          return S;
        }
        ...
        _boundaryScore(t, _, u, S) {
          const L = this._OriginalRegionIsBoundary(t, _) ? 1 : 0,
            s = this._ModifiedRegionIsBoundary(u, S) ? 1 : 0;
          return L + s;
        }
        ConcatenateChanges(t, _) {
          let u = [];
          if (t.length === 0 || _.length === 0) return _.length > 0 ? _ : t;
          if (this.ChangesOverlap(t[t.length - 1], _[0], u)) {
            const S = new Array(t.length + _.length - 1);
            return (
              C.Copy(t, 0, S, 0, t.length - 1),
              (S[t.length - 1] = u[0]),
              C.Copy(_, 1, S, t.length, _.length - 1),
              S
            );
          } else {
            const S = new Array(t.length + _.length);
            return (
              C.Copy(t, 0, S, 0, t.length),
              C.Copy(_, 0, S, t.length, _.length),
              S
            );
          }
        }
        ChangesOverlap(t, _, u) {
          if (
            (v.Assert(
              t.originalStart <= _.originalStart,
              'Left change is not less than or equal to right change',
            ),
            v.Assert(
              t.modifiedStart <= _.modifiedStart,
              'Left change is not less than or equal to right change',
            ),
            t.originalStart + t.originalLength >= _.originalStart ||
              t.modifiedStart + t.modifiedLength >= _.modifiedStart)
          ) {
            const S = t.originalStart;
            let L = t.originalLength;
            const s = t.modifiedStart;
            let b = t.modifiedLength;
            return (
              t.originalStart + t.originalLength >= _.originalStart &&
                (L = _.originalStart + _.originalLength - t.originalStart),
              t.modifiedStart + t.modifiedLength >= _.modifiedStart &&
                (b = _.modifiedStart + _.modifiedLength - t.modifiedStart),
              (u[0] = new P.DiffChange(S, L, s, b)),
              !0
            );
          } else return (u[0] = null), !1;
        }
        ClipDiagonalBound(t, _, u, S) {
          if (t >= 0 && t < S) return t;
          const L = u,
            s = S - u - 1,
            b = _ % 2 == 0;
    ...
    Q(X[31], K([0, 1, 2]), function (B, r, P) {
      ...
      class c {
        ...
        reset(s) {
          return (this._value = s), (this._pos = 0), this;
        }
        next() {
        ...
        cmp(s) {
          const b = s.charCodeAt(0),
            m = this._value.charCodeAt(this._pos);
          return b - m;
        }
        value() {
      ...
      class v {
        ...
        reset(s) {
          return (
            (this._value = s), (this._from = 0), (this._to = 0), this.next()
          );
        }
        hasNext() {
        ...
        cmp(s) {
          return this._caseSensitive
            ...
            : (0, P.compareSubstringIgnoreCase)(
                s,
                this._value,
                0,
                s.length,
      ...
      r.ConfigKeysIterator = v;
      class C {
        constructor(s = !0, b = !0) {
          (this._splitOnBackslash = s), (this._caseSensitive = b);
        }
        reset(s) {
          (this._from = 0),
            (this._to = 0),
            (this._value = s),
            (this._valueLen = s.length);
          for (let b = s.length - 1; b >= 0; b--, this._valueLen--) {
            const m = this._value.charCodeAt(b);
            if (!(m === 47 || (this._splitOnBackslash && m === 92))) break;
          }
          return this.next();
        }
        hasNext() {
        ...
        next() {
          ...
          for (; this._to < this._valueLen; this._to++) {
            const b = this._value.charCodeAt(this._to);
            if (b === 47 || (this._splitOnBackslash && b === 92))
              if (s) this._from++;
              else break;
            else s = !1;
          }
      ...
      class f {
        ...
        reset(s) {
          return (
            ...
            this._value.path &&
              ((this._pathIterator = new C(!1, !this._ignorePathCasing(s))),
              this._pathIterator.reset(s.path),
        ...
        cmp(s) {
          if (this._states[this._stateIdx] === 1)
            return (0, P.compareIgnoreCase)(s, this._value.scheme);
          if (this._states[this._stateIdx] === 2)
            return (0, P.compareIgnoreCase)(s, this._value.authority);
          if (this._states[this._stateIdx] === 3)
            return this._pathIterator.cmp(s);
          if (this._states[this._stateIdx] === 4)
            return (0, P.compare)(s, this._value.query);
          if (this._states[this._stateIdx] === 5)
            return (0, P.compare)(s, this._value.fragment);
          throw new Error();
        }
        value() {
      ...
      class d {
        ...
        get heightLeft() {
          var s, b;
          return (b =
            (s = this.left) === null || s === void 0 ? void 0 : s.height) !==
            null && b !== void 0
            ? b
            : 0;
        }
        get heightRight() {
          var s, b;
          return (b =
            (s = this.right) === null || s === void 0 ? void 0 : s.height) !==
            null && b !== void 0
            ? b
            : 0;
        }
      ...
      class w {
        ...
        set(s, b) {
          const m = this._iter.reset(s);
          let o;
          this._root ||
            ((this._root = new d()), (this._root.segment = m.value()));
          const i = [];
          for (o = this._root; ; ) {
            const l = m.cmp(o.segment);
            if (l > 0)
              o.left || ((o.left = new d()), (o.left.segment = m.value())),
                i.push([-1, o]),
                (o = o.left);
            else if (l < 0)
              o.right || ((o.right = new d()), (o.right.segment = m.value())),
                i.push([1, o]),
                (o = o.right);
            else if (m.hasNext())
              m.next(),
                o.mid || ((o.mid = new d()), (o.mid.segment = m.value())),
                i.push([0, o]),
                (o = o.mid);
            else break;
          }
          ...
          for (let l = i.length - 1; l >= 0; l--) {
            const g = i[l][1];
            g.updateHeight();
            const h = g.balanceFactor();
            if (h < -1 || h > 1) {
              const p = i[l][0],
                y = i[l + 1][0];
              if (p === 1 && y === 1) i[l][1] = g.rotateLeft();
              else if (p === -1 && y === -1) i[l][1] = g.rotateRight();
              else if (p === 1 && y === -1)
                (g.right = i[l + 1][1] = i[l + 1][1].rotateRight()),
                  (i[l][1] = g.rotateLeft());
              else if (p === -1 && y === 1)
                (g.left = i[l + 1][1] = i[l + 1][1].rotateLeft()),
                  (i[l][1] = g.rotateRight());
        ...
        get(s) {
          var b;
          return (b = this._getNode(s)) === null || b === void 0
            ? void 0
            : b.value;
        }
        _getNode(s) {
          const b = this._iter.reset(s);
          let m = this._root;
          for (; m; ) {
            const o = b.cmp(m.segment);
            if (o > 0) m = m.left;
            else if (o < 0) m = m.right;
            else if (b.hasNext()) b.next(), (m = m.mid);
            else break;
          }
          return m;
        }
        has(s) {
          const b = this._getNode(s);
          return !(
            (b == null ? void 0 : b.value) === void 0 &&
            (b == null ? void 0 : b.mid) === void 0
          );
        }
        delete(s) {
          return this._delete(s, !1);
        }
        deleteSuperstr(s) {
          return this._delete(s, !0);
        }
        _delete(s, b) {
          var m;
          const o = this._iter.reset(s),
            i = [];
          let a = this._root;
          for (; a; ) {
            const l = o.cmp(a.segment);
            if (l > 0) i.push([-1, a]), (a = a.left);
            else if (l < 0) i.push([1, a]), (a = a.right);
            else if (o.hasNext()) o.next(), i.push([0, a]), (a = a.mid);
            else break;
          }
          if (!!a) {
            if (
              ...
              if (a.left && a.right) {
                const l = this._min(a.right),
                  { key: g, value: h, segment: p } = l;
                this._delete(l.key, !1),
                  (a.key = g),
                  (a.value = h),
                  (a.segment = p);
              } else {
                const l = (m = a.left) !== null && m !== void 0 ? m : a.right;
                if (i.length > 0) {
                  const [g, h] = i[i.length - 1];
                  switch (g) {
                    case -1:
                      h.left = l;
                      break;
            ...
            for (let l = i.length - 1; l >= 0; l--) {
              ...
              if (
                (h > 1
                  ? (g.right.balanceFactor() >= 0 ||
                      (g.right = g.right.rotateRight()),
                    (i[l][1] = g.rotateLeft()))
                  : h < -1 &&
                    (g.left.balanceFactor() <= 0 ||
        ...
        findSubstr(s) {
          ...
          let m = this._root,
            o;
          for (; m; ) {
            const i = b.cmp(m.segment);
            if (i > 0) m = m.left;
            else if (i < 0) m = m.right;
            else if (b.hasNext()) b.next(), (o = m.value || o), (m = m.mid);
            else break;
          }
          return (m && m.value) || o;
        }
        findSuperstr(s) {
          ...
          for (; m; ) {
            ...
            else return m.mid ? this._entries(m.mid) : void 0;
          }
        }
        forEach(s) {
          for (const [b, m] of this) s(m, b);
        }
        *[Symbol.iterator]() {
        ...
        *_entries(s) {
          !s ||
            (s.left && (yield* this._entries(s.left)),
            s.value && (yield [s.key, s.value]),
            s.mid && (yield* this._entries(s.mid)),
            s.right && (yield* this._entries(s.right)));
        }
      }
      r.TernarySearchTree = w;
      class t {
        constructor(s, b) {
          (this.uri = s), (this.value = b);
        }
      }
      class _ {
        constructor(s, b) {
          (this[e] = 'ResourceMap'),
            s instanceof _
              ? ((this.map = new Map(s.map)),
                (this.toKey = b ?? _.defaultToKey))
              : ((this.map = new Map()), (this.toKey = s ?? _.defaultToKey));
        }
        set(s, b) {
          return this.map.set(this.toKey(s), new t(s, b)), this;
        }
        get(s) {
          var b;
          return (b = this.map.get(this.toKey(s))) === null || b === void 0
            ? void 0
            : b.value;
        }
        has(s) {
        ...
        forEach(s, b) {
          typeof b != 'undefined' && (s = s.bind(b));
          for (let [m, o] of this.map) s(o.value, o.uri, this);
        }
        *values() {
          for (let s of this.map.values()) yield s.value;
        }
        *keys() {
          for (let s of this.map.values()) yield s.uri;
        }
        *entries() {
          for (let s of this.map.values()) yield [s.uri, s.value];
        }
        *[((e = Symbol.toStringTag), Symbol.iterator)]() {
          for (let [, s] of this.map) yield [s.uri, s.value];
        }
      }
      (r.ResourceMap = _), (_.defaultToKey = (L) => L.toString());
      class u {
        constructor() {
          (this[A] = 'LinkedMap'),
            (this._map = new Map()),
        ...
        get(s, b = 0) {
          const m = this._map.get(s);
          if (!!m) return b !== 0 && this.touch(m, b), m.value;
        }
        set(s, b, m = 0) {
          let o = this._map.get(s);
          if (o) (o.value = b), m !== 0 && this.touch(o, m);
          else {
            switch (
              ((o = { key: s, value: b, next: void 0, previous: void 0 }), m)
            ) {
              case 0:
                this.addItemLast(o);
                break;
        ...
        remove(s) {
          const b = this._map.get(s);
          if (!!b)
            return (
              this._map.delete(s), this.removeItem(b), this._size--, b.value
            );
        }
        shift() {
          ...
          const s = this._head;
          return (
            this._map.delete(s.key), this.removeItem(s), this._size--, s.value
          );
        }
        forEach(s, b) {
          const m = this._state;
          ...
          for (; o; ) {
            if (
              (b ? s.bind(b)(o.value, o.key, this) : s(o.value, o.key, this),
              this._state !== m)
            )
          ...
          const o = {
            ...
            next() {
              if (s._state !== b)
                throw new Error('LinkedMap got modified during iteration.');
              if (m) {
                const i = { value: [m.key, m.value], done: !1 };
                return (m = m.next), i;
              } else return { value: void 0, done: !0 };
            },
          };
        ...
        trimOld(s) {
          ...
          let b = this._head,
            m = this.size;
          for (; b && m > s; ) this._map.delete(b.key), (b = b.next), m--;
          (this._head = b),
            (this._size = m),
            b && (b.previous = void 0),
            this._state++;
        ...
        removeItem(s) {
          if (s === this._head && s === this._tail)
            ...
            const b = s.next,
              m = s.previous;
            if (!b || !m) throw new Error('Invalid list');
            (b.previous = m), (m.next = b);
          }
          ...
          if (!(b !== 1 && b !== 2)) {
            if (b === 1) {
              ...
              const m = s.next,
                o = s.previous;
              s === this._head
                ? ((m.previous = void 0), (this._head = m))
                : ((m.previous = o), (o.next = m)),
                (s.next = void 0),
        ...
        fromJSON(s) {
          this.clear();
          for (const [b, m] of s) this.set(b, m);
        }
      }
      r.LinkedMap = u;
      class S extends u {
        constructor(s, b = 1) {
          super();
          (this._limit = s), (this._ratio = Math.min(Math.max(0, b), 1));
        }
        get limit() {
          return this._limit;
        }
        ...
        get(s, b = 2) {
          return super.get(s, b);
        }
        peek(s) {
          return super.get(s, 0);
        }
        set(s, b) {
          return super.set(s, b, 2), this.checkTrim(), this;
        }
        checkTrim() {
    ...
    Q(X[32], K([0, 1, 28, 29, 31, 8, 3, 2]), function (B, r, P, e, A, c, v, C) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.isRelativePattern =
          r.parse =
      ...
      function u(W) {
        if (!W) return '';
        let U = '';
        const T = _(W, r.GLOB_SPLIT);
        if (T.every((n) => n === r.GLOBSTAR)) U = '.*';
        else {
          let n = !1;
          T.forEach(($, j) => {
            if ($ === r.GLOBSTAR) {
            ...
            for (const ee of $) {
              ...
              if (Z && (ee !== ']' || !x)) {
                ...
                ee === '-'
                  ...
                  : ee === r.GLOB_SPLIT
                  ? (te = '')
                  : (te = (0, C.escapeRegExpCharacters)(ee)),
                  (x += te);
                continue;
              }
              switch (ee) {
                ...
                case '*':
                  ...
                  continue;
                default:
                  U += (0, C.escapeRegExpCharacters)(ee);
              }
            }
            j < T.length - 1 &&
              (T[j + 1] !== r.GLOBSTAR || j + 2 < T.length) &&
              (U += f),
              (n = !1);
          });
        }
      ...
      function g(W, U) {
        if (!W) return l;
        let T;
        typeof W != 'string' ? (T = W.pattern) : (T = W), (T = T.trim());
        const n = `${T}_${!!U.trimForExclusions}`;
        let $ = i.get(n);
        if ($) return h($, W);
        let j;
        if (S.test(T)) {
          const Y = T.substr(4);
          $ = function (z, Z) {
            return typeof z == 'string' && z.endsWith(Y) ? T : null;
          };
        } else (j = L.exec(p(T, U))) ? ($ = y(j[1], T)) : (U.trimForExclusions ? b : s).test(T) ? ($ = N(T, U)) : (j = m.exec(p(T, U))) ? ($ = E(j[1].substr(1), T, !0)) : (j = o.exec(p(T, U))) ? ($ = E(j[1], T, !1)) : ($ = M(T));
        return i.set(n, $), h($, W);
      }
      function h(W, U) {
        return typeof U == 'string'
          ? W
          : function (T, n) {
              return (0, e.isEqualOrParent)(T, U.base, !v.isLinux)
                ? W(T.substr(U.base.length + 1), n)
                : null;
            };
      }
      function p(W, U) {
        return U.trimForExclusions && W.endsWith('/**')
          ...
          $ = function (Y, z) {
            return typeof Y != 'string'
              ...
              ? z === W
                ? U
                : null
              : Y === W || Y.endsWith(T) || Y.endsWith(n)
              ? U
              : null;
          },
          j = [W];
        return ($.basenames = j), ($.patterns = [U]), ($.allBasenames = j), $;
      }
      function N(W, U) {
        const T = H(
            W.slice(1, -1)
        ...
        if (n === 1) return T[0];
        const $ = function (z, Z) {
            for (let x = 0, ee = T.length; x < ee; x++)
              if (T[x](z, Z)) return W;
            return null;
          },
          j = T.find((z) => !!z.allBasenames);
        j && ($.allBasenames = j.allBasenames);
        const Y = T.reduce(
          (z, Z) => (Z.allPaths ? z.concat(Z.allPaths) : z),
          [],
        );
        return Y.length && ($.allPaths = Y), $;
      }
      function E(W, U, T) {
        const n = c.sep === c.posix.sep,
          $ = n ? W : W.replace(w, c.sep),
          j = c.sep + $,
          Y = c.posix.sep + W,
          z = T
            ? function (Z, x) {
            ...
            : function (Z, x) {
                return typeof Z == 'string' && (Z === $ || (!n && Z === W))
                  ? U
                  : null;
              };
        return (z.allPaths = [(T ? '*/' : './') + W]), z;
      }
      function M(W) {
        try {
          const U = new RegExp(`^${u(W)}$`);
          return function (T) {
            return (
              (U.lastIndex = 0), typeof T == 'string' && U.test(T) ? W : null
            );
          };
        } catch {
          return l;
      ...
      function k(W, U, T) {
        return !W || typeof U != 'string' ? !1 : R(W)(U, void 0, T);
      }
      r.match = k;
      function R(W, U = {}) {
        if (!W) return a;
        if (typeof W == 'string' || I(W)) {
          const T = g(W, U);
          if (T === l) return a;
          const n = function ($, j) {
            return !!T($, j);
          ...
          return (
            T.allBasenames && (n.allBasenames = T.allBasenames),
            T.allPaths && (n.allPaths = T.allPaths),
            n
          );
        }
        return F(W, U);
      ...
      function I(W) {
        const U = W;
        return U
          ? typeof U.base == 'string' && typeof U.pattern == 'string'
          : !1;
      }
      r.isRelativePattern = I;
      function F(W, U) {
        const T = H(
          ...
          n = T.length;
        if (!n) return l;
        if (!T.some((z) => !!z.requiresSiblings)) {
          if (n === 1) return T[0];
          const z = function (ee, te) {
            ...
            Z = T.find((ee) => !!ee.allBasenames);
          Z && (z.allBasenames = Z.allBasenames);
          const x = T.reduce(
            (ee, te) => (te.allPaths ? ee.concat(te.allPaths) : ee),
            [],
          );
          return x.length && (z.allPaths = x), z;
        }
        const $ = function (z, Z, x) {
            let ee;
            for (let te = 0, le = T.length; te < le; te++) {
              const he = T[te];
              he.requiresSiblings &&
                x &&
                (Z || (Z = (0, c.basename)(z)),
                ee || (ee = Z.substr(0, Z.length - (0, c.extname)(z).length)));
              const me = he(z, Z, ee, x);
              if (me) return me;
            }
            return null;
          },
      ...
      function O(W, U, T) {
        ...
        const n = g(W, T);
        if (n === l) return l;
        if (typeof U == 'boolean') return n;
        if (U) {
          const $ = U.when;
          if (typeof $ == 'string') {
            const j = (Y, z, Z, x) => {
              if (!x || !n(Y, z)) return null;
              const ee = $.replace('$(basename)', Z),
                te = x(ee);
              return (0, P.isThenable)(te)
                ? te.then((le) => (le ? W : null))
                : te
                ? W
                : null;
            };
            return (j.requiresSiblings = !0), j;
          }
        }
        return n;
      }
      function H(W, U) {
        const T = W.filter((z) => !!z.basenames);
        if (T.length < 2) return W;
        const n = T.reduce((z, Z) => {
          const x = Z.basenames;
          return x ? z.concat(x) : z;
        }, []);
        let $;
        if (U) {
          $ = [];
          for (let z = 0, Z = n.length; z < Z; z++) $.push(U);
        } else
          $ = T.reduce((z, Z) => {
            const x = Z.patterns;
            return x ? z.concat(x) : z;
          }, []);
        const j = function (z, Z) {
          if (typeof z != 'string') return null;
          if (!Z) {
            let ee;
            for (ee = z.length; ee > 0; ee--) {
              const te = z.charCodeAt(ee - 1);
              if (te === 47 || te === 92) break;
            }
            Z = z.substr(ee);
          }
          const x = n.indexOf(Z);
        ...
        (j.basenames = n), (j.patterns = $), (j.allBasenames = n);
        const Y = W.filter((z) => !z.basenames);
        return Y.push(j), Y;
      }
    }),
    Q(X[9], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.assertNever =
      ...
      r.isFunction = _;
      function u(i, a) {
        const l = Math.min(i.length, a.length);
        for (let g = 0; g < l; g++) S(i[g], a[g]);
      }
      ...
      function S(i, a) {
        if (e(a)) {
          ...
          try {
            if (i instanceof a) return;
          } catch {}
          if (
            (!d(i) && i.constructor === a) ||
            (a.length === 1 && a.call(void 0, i) === !0)
          )
            return;
          throw new Error(
      ...
      r.validateConstraint = S;
      function L(i) {
        let a = [],
          l = Object.getPrototypeOf(i);
        for (; Object.prototype !== l; )
          (a = a.concat(Object.getOwnPropertyNames(l))),
            (l = Object.getPrototypeOf(l));
        return a;
      }
      r.getAllPropertyNames = L;
      function s(i) {
        const a = [];
        for (const l of L(i)) typeof i[l] == 'function' && a.push(l);
        return a;
      }
      r.getAllMethodNames = s;
      function b(i, a) {
        const l = (h) =>
          function () {
        ...
        let g = {};
        for (const h of i) g[h] = l(h);
        return g;
      }
      r.createProxyObject = b;
      function m(i) {
        return i === null ? void 0 : i;
      }
      r.withNullAsUndefined = m;
      function o(i, a = 'Unreachable') {
        throw new Error(a);
      }
      r.assertNever = o;
    }),
    Q(X[33], K([0, 1, 9]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.getOrDefault =
          r.equals =
      ...
      function e(t) {
        ...
        return (
          Object.keys(t).forEach((u) => {
            t[u] && typeof t[u] == 'object' ? (_[u] = e(t[u])) : (_[u] = t[u]);
          }),
          _
        );
      }
      ...
      function A(t) {
        ...
        for (; _.length > 0; ) {
          ...
          for (const S in u)
            if (c.call(u, S)) {
              const L = u[S];
              typeof L == 'object' && !Object.isFrozen(L) && _.push(L);
            }
        }
        return t;
      }
      ...
      function v(t, _) {
        return C(t, _, new Set());
      }
      r.cloneAndChange = v;
      function C(t, _, u) {
        if ((0, P.isUndefinedOrNull)(t)) return t;
        const S = _(t);
        if (typeof S != 'undefined') return S;
        if ((0, P.isArray)(t)) {
          const L = [];
          for (const s of t) L.push(C(s, _, u));
          return L;
        }
        if ((0, P.isObject)(t)) {
          if (u.has(t))
          ...
          u.add(t);
          const L = {};
          for (let s in t) c.call(t, s) && (L[s] = C(t[s], _, u));
          return u.delete(t), L;
        }
        return t;
      }
        ...
        return (0, P.isObject)(t)
          ? ((0, P.isObject)(_) &&
              Object.keys(_).forEach((S) => {
                S in t
                  ? u &&
                    ((0, P.isObject)(t[S]) && (0, P.isObject)(_[S])
                      ? f(t[S], _[S], u)
                      : (t[S] = _[S]))
                  : (t[S] = _[S]);
              }),
      ...
      function d(t, _) {
        ...
        if (
          ...
          typeof t != typeof _ ||
          typeof t != 'object' ||
          Array.isArray(t) !== Array.isArray(_)
        )
          return !1;
        let u, S;
        if (Array.isArray(t)) {
          if (t.length !== _.length) return !1;
          for (u = 0; u < t.length; u++) if (!d(t[u], _[u])) return !1;
        } else {
          const L = [];
          for (S in t) L.push(S);
          L.sort();
          const s = [];
          for (S in _) s.push(S);
          if ((s.sort(), !d(L, s))) return !1;
          for (u = 0; u < L.length; u++) if (!d(t[L[u]], _[L[u]])) return !1;
        }
        return !0;
      }
      r.equals = d;
      function w(t, _, u) {
        const S = _(t);
        return typeof S == 'undefined' ? u : S;
      }
      r.getOrDefault = w;
    }),
    Q(X[15], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
    ...
    Q(X[11], K([0, 1, 8, 3]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      const w = '',
        ...
        _ = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
      class u {
        constructor(p, y, N, E, M, k = !1) {
          typeof p == 'object'
            ? ((this.scheme = p.scheme || w),
              (this.authority = p.authority || w),
              (this.path = p.path || w),
              (this.query = p.query || w),
              (this.fragment = p.fragment || w))
            : ((this.scheme = f(p, k)),
              (this.authority = y || w),
              (this.path = d(this.scheme, N || w)),
              (this.query = E || w),
              (this.fragment = M || w),
              C(this, k));
        }
        ...
        with(p) {
          if (!p) return this;
          let { scheme: y, authority: N, path: E, query: M, fragment: k } = p;
          return (
            y === void 0 ? (y = this.scheme) : y === null && (y = w),
            N === void 0 ? (N = this.authority) : N === null && (N = w),
            E === void 0 ? (E = this.path) : E === null && (E = w),
            M === void 0 ? (M = this.query) : M === null && (M = w),
            k === void 0 ? (k = this.fragment) : k === null && (k = w),
            y === this.scheme &&
            N === this.authority &&
            E === this.path &&
            M === this.query &&
        ...
        static file(p) {
          let y = w;
          if (
            (e.isWindows && (p = p.replace(/\\/g, t)), p[0] === t && p[1] === t)
          ) {
            const N = p.indexOf(t, 2);
            N === -1
              ? ((y = p.substring(2)), (p = t))
              : ((y = p.substring(2, N)), (p = p.substring(N) || t));
          }
          return new L('file', y, p, w, w);
        }
        static from(p) {
          const y = new L(p.scheme, p.authority, p.path, p.query, p.fragment);
          return C(y, !0), y;
        }
        static joinPath(p, ...y) {
          if (!p.path)
          ...
          let N;
          return (
            e.isWindows && p.scheme === 'file'
              ? (N = u.file(P.win32.join(o(p, !0), ...y)).path)
              : (N = P.posix.join(p.path, ...y)),
            p.with({ path: N })
          );
        }
        toString(p = !1) {
        ...
        static revive(p) {
          if (p) {
            if (p instanceof u) return p;
            {
              const y = new L(p);
              return (
                (y._formatted = p.external),
                (y._fsPath = p._sep === S ? p.fsPath : null),
                y
              );
            }
          } else return p;
      ...
      class L extends u {
        ...
        toJSON() {
          const p = { $mid: 1 };
          return (
            this._fsPath && ((p.fsPath = this._fsPath), (p._sep = S)),
      ...
      function b(h, p) {
        ...
        for (let E = 0; E < h.length; E++) {
          ...
          if (
            ...
            N !== -1 &&
              ((y += encodeURIComponent(h.substring(N, E))), (N = -1)),
              y !== void 0 && (y += h.charAt(E));
          else {
            y === void 0 && (y = h.substr(0, E));
            const k = s[M];
            k !== void 0
              ? (N !== -1 &&
                  ((y += encodeURIComponent(h.substring(N, E))), (N = -1)),
        ...
        return (
          N !== -1 && (y += encodeURIComponent(h.substring(N))),
          y !== void 0 ? y : h
        );
      }
      function m(h) {
      ...
      function o(h, p) {
        ...
        return (
          h.authority && h.path.length > 1 && h.scheme === 'file'
            ...
            ? p
              ? (y = h.path.substr(1))
              : (y = h.path[1].toLowerCase() + h.path.substr(2))
            : (y = h.path),
          e.isWindows && (y = y.replace(/\//g, '\\')),
          y
        );
      }
      r.uriToFsPath = o;
      function i(h, p) {
        const y = p ? m : b;
        let N = '',
          { scheme: E, authority: M, path: k, query: R, fragment: I } = h;
        if (
          (E && ((N += E), (N += ':')),
          (M || E === 'file') && ((N += t), (N += t)),
          M)
          ...
          (M = M.toLowerCase()),
            ...
            F === -1
              ? (N += y(M, !1))
              : ((N += y(M.substr(0, F), !1)), (N += M.substr(F)));
        }
        if (k) {
          if (
            k.length >= 3 &&
      ...
      function a(h) {
        try {
          ...
          return h.length > 3 ? h.substr(0, 3) + a(h.substr(3)) : h;
        }
      }
      const l = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
      function g(h) {
        return h.match(l) ? h.replace(l, (p) => a(p)) : h;
      }
    }),
    Q(X[50], K([0, 1, 10, 4, 7, 3, 9, 2]), function (B, r, P, e, A, c, v, C) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.create =
      ...
      class L {
        constructor(h, p) {
          (this.vsWorker = h), (this.req = p), (this.type = 4);
        }
      }
      class s {
        constructor(h) {
        ...
        sendMessage(h, p) {
          ...
          return new Promise((N, E) => {
            (this._pendingReplies[y] = { resolve: N, reject: E }),
              this._send(new t(this._workerId, y, h, p));
          });
        }
        listen(h, p) {
          let y = null;
          const N = new e.Emitter({
            onFirstListenerAdd: () => {
              (y = String(++this._lastSentReq)),
                this._pendingEmitters.set(y, N),
                this._send(new u(this._workerId, y, h, p));
            },
            onLastListenerRemove: () => {
              this._pendingEmitters.delete(y),
                this._send(new L(this._workerId, y)),
                (y = null);
            },
          });
          return N.event;
        ...
        _handleReplyMessage(h) {
          ...
          let p = this._pendingReplies[h.seq];
          if ((delete this._pendingReplies[h.seq], h.err)) {
            let y = h.err;
            h.err.$isError &&
              ((y = new Error()),
              (y.name = h.err.name),
              (y.message = h.err.message),
              (y.stack = h.err.stack)),
              p.reject(y);
            return;
          }
        ...
        _handleRequestMessage(h) {
          ...
          this._handler.handleMessage(h.method, h.args).then(
            (N) => {
              this._send(new _(this._workerId, p, N, void 0));
            },
            (N) => {
              N.detail instanceof Error &&
                (N.detail = (0, P.transformErrorForSerialization)(N.detail)),
                this._send(
                  new _(
                    this._workerId,
                    p,
                    void 0,
                    (0, P.transformErrorForSerialization)(N),
                  ),
                );
            },
          );
        ...
        _handleSubscribeEventMessage(h) {
          const p = h.req,
            y = this._handler.handleEvent(
              h.eventName,
              h.arg,
            )((N) => {
              this._send(new S(this._workerId, p, N));
            });
          this._pendingEvents.set(p, y);
        }
        ...
        _send(h) {
          let p = [];
          if (h.type === 0)
            for (let y = 0; y < h.args.length; y++)
              h.args[y] instanceof ArrayBuffer && p.push(h.args[y]);
          else h.type === 1 && h.res instanceof ArrayBuffer && p.push(h.res);
          this._handler.sendMessage(h, p);
        }
      }
      class b extends A.Disposable {
        constructor(h, p, y) {
          super();
          let N = null;
          (this._worker = this._register(
            ...
            (this._protocol = new s({
              ...
              handleMessage: (I, F) => {
                ...
                try {
                  return Promise.resolve(y[I].apply(y, F));
                } catch (O) {
          ...
          let E = null;
          typeof c.globals.require != 'undefined' &&
          typeof c.globals.require.getConfig == 'function'
            ? (E = c.globals.require.getConfig())
            : typeof c.globals.requirejs != 'undefined' &&
              (E = c.globals.requirejs.s.contexts._.config);
          const M = v.getAllMethodNames(y);
          this._onModuleLoaded = this._protocol.sendMessage(f, [
            this._worker.getId(),
          ...
          this._lazyProxy = new Promise((I, F) => {
            (N = F),
              this._onModuleLoaded.then(
                ...
                (O) => {
                  F(O), this._onError('Worker failed to load ' + p, O);
                },
              );
          });
        }
        ...
        _request(h, p) {
          return new Promise((y, N) => {
            this._onModuleLoaded.then(() => {
              this._protocol.sendMessage(h, p).then(y, N);
            }, N);
          });
        }
        _onError(h, p) {
          console.error(h), console.info(p);
        }
      }
      r.SimpleWorkerClient = b;
      function m(g) {
        return (
          g[0] === 'o' && g[1] === 'n' && C.isUpperAsciiLetter(g.charCodeAt(2))
        );
      }
      function o(g) {
        return /^onDynamic/.test(g) && C.isUpperAsciiLetter(g.charCodeAt(9));
      }
      function i(g, h, p) {
        const y = (M) =>
            function () {
      ...
      class a {
        constructor(h, p) {
          (this._requestHandlerFactory = p),
            ...
            (this._protocol = new s({
              ...
              handleMessage: (y, N) => this._handleMessage(y, N),
              handleEvent: (y, N) => this._handleEvent(y, N),
            }));
        }
        onmessage(h) {
        ...
        _handleMessage(h, p) {
          if (h === f) return this.initialize(p[0], p[1], p[2], p[3]);
          if (
          ...
          try {
            return Promise.resolve(
              this._requestHandler[h].apply(this._requestHandler, p),
            );
          } catch (y) {
        ...
        _handleEvent(h, p) {
          ...
          if (o(h)) {
            const y = this._requestHandler[h].call(this._requestHandler, p);
            if (typeof y != 'function')
              throw new Error(`Missing dynamic event ${h} on request handler.`);
            return y;
          }
          if (m(h)) {
            const y = this._requestHandler[h];
            if (typeof y != 'function')
        ...
        initialize(h, p, y, N) {
          ...
          return this._requestHandlerFactory
            ? ((this._requestHandler = this._requestHandlerFactory(k)),
              Promise.resolve(v.getAllMethodNames(this._requestHandler)))
            : (p &&
                (typeof p.baseUrl != 'undefined' && delete p.baseUrl,
                typeof p.paths != 'undefined' &&
                  typeof p.paths.vs != 'undefined' &&
                  delete p.paths.vs,
                typeof p.trustedTypesPolicy !== void 0 &&
                  delete p.trustedTypesPolicy,
                (p.catchError = !0),
                c.globals.require.config(p)),
              new Promise((R, I) => {
                (c.globals.require || B)(
                  [y],
                  (O) => {
                    ...
                    R(v.getAllMethodNames(this._requestHandler));
                  },
                  I,
                );
              }));
    ...
    Q(X[16], K([0, 1, 15]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.CharacterSet = r.CharacterClassifier = void 0);
      class e {
        constructor(v) {
          const C = (0, P.toUint8)(v);
          (this._defaultValue = C),
            (this._asciiMap = e._createAsciiMap(C)),
            (this._map = new Map());
        }
        static _createAsciiMap(v) {
          const C = new Uint8Array(256);
          for (let f = 0; f < 256; f++) C[f] = v;
          return C;
        }
        set(v, C) {
          const f = (0, P.toUint8)(C);
          v >= 0 && v < 256 ? (this._asciiMap[v] = f) : this._map.set(v, f);
        }
        get(v) {
          return v >= 0 && v < 256
            ? this._asciiMap[v]
            : this._map.get(v) || this._defaultValue;
        }
      }
      ...
      class A {
        ...
        add(v) {
          this._actual.set(v, 1);
        }
        has(v) {
          return this._actual.get(v) === 1;
        }
      }
      r.CharacterSet = A;
    }),
    Q(X[5], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.Position = void 0);
      class P {
        constructor(A, c) {
          (this.lineNumber = A), (this.column = c);
        }
        with(A = this.lineNumber, c = this.column) {
          return A === this.lineNumber && c === this.column
            ? this
            : new P(A, c);
        }
        delta(A = 0, c = 0) {
          return this.with(this.lineNumber + A, this.column + c);
        }
        equals(A) {
        ...
        isBeforeOrEqual(A) {
          return P.isBeforeOrEqual(this, A);
        }
        static isBeforeOrEqual(A, c) {
          return A.lineNumber < c.lineNumber
            ? !0
            : c.lineNumber < A.lineNumber
            ? !1
        ...
        static lift(A) {
          return new P(A.lineNumber, A.column);
        }
    ...
    Q(X[6], K([0, 1, 5]), function (B, r, P) {
      ...
      class e {
        ...
        containsPosition(c) {
          return e.containsPosition(this, c);
        }
        static containsPosition(c, v) {
          return !(
            v.lineNumber < c.startLineNumber ||
            v.lineNumber > c.endLineNumber ||
            (v.lineNumber === c.startLineNumber && v.column < c.startColumn) ||
            (v.lineNumber === c.endLineNumber && v.column > c.endColumn)
          );
        }
        static strictContainsPosition(c, v) {
          return !(
            v.lineNumber < c.startLineNumber ||
            v.lineNumber > c.endLineNumber ||
            (v.lineNumber === c.startLineNumber && v.column <= c.startColumn) ||
        ...
        containsRange(c) {
          return e.containsRange(this, c);
        }
        static containsRange(c, v) {
          return !(
            v.startLineNumber < c.startLineNumber ||
            v.endLineNumber < c.startLineNumber ||
            v.startLineNumber > c.endLineNumber ||
            v.endLineNumber > c.endLineNumber ||
            (v.startLineNumber === c.startLineNumber &&
              v.startColumn < c.startColumn) ||
            (v.endLineNumber === c.endLineNumber && v.endColumn > c.endColumn)
          );
        }
        strictContainsRange(c) {
          return e.strictContainsRange(this, c);
        }
        static strictContainsRange(c, v) {
          return !(
            v.startLineNumber < c.startLineNumber ||
            v.endLineNumber < c.startLineNumber ||
            v.startLineNumber > c.endLineNumber ||
        ...
        plusRange(c) {
          return e.plusRange(this, c);
        }
        static plusRange(c, v) {
          let C, f, d, w;
          return (
            v.startLineNumber < c.startLineNumber
              ? ((C = v.startLineNumber), (f = v.startColumn))
              : v.startLineNumber === c.startLineNumber
              ? ((C = v.startLineNumber),
                (f = Math.min(v.startColumn, c.startColumn)))
              : ((C = c.startLineNumber), (f = c.startColumn)),
            v.endLineNumber > c.endLineNumber
              ? ((d = v.endLineNumber), (w = v.endColumn))
              : v.endLineNumber === c.endLineNumber
              ? ((d = v.endLineNumber),
                (w = Math.max(v.endColumn, c.endColumn)))
              : ((d = c.endLineNumber), (w = c.endColumn)),
            new e(C, f, d, w)
          );
        }
        intersectRanges(c) {
          return e.intersectRanges(this, c);
        }
        static intersectRanges(c, v) {
          let C = c.startLineNumber,
            f = c.startColumn,
            d = c.endLineNumber,
            w = c.endColumn,
            t = v.startLineNumber,
            ...
            S = v.endColumn;
          return (
            C < t ? ((C = t), (f = _)) : C === t && (f = Math.max(f, _)),
            d > u ? ((d = u), (w = S)) : d === u && (w = Math.min(w, S)),
            C > d || (C === d && f > w) ? null : new e(C, f, d, w)
          );
        }
        equalsRange(c) {
          return e.equalsRange(this, c);
        }
        static equalsRange(c, v) {
          return (
            !!c &&
            !!v &&
            c.startLineNumber === v.startLineNumber &&
            c.startColumn === v.startColumn &&
            c.endLineNumber === v.endLineNumber &&
            c.endColumn === v.endColumn
          );
        }
        getEndPosition() {
          return e.getEndPosition(this);
        }
        static getEndPosition(c) {
          return new P.Position(c.endLineNumber, c.endColumn);
        }
        getStartPosition() {
          return e.getStartPosition(this);
        }
        static getStartPosition(c) {
          return new P.Position(c.startLineNumber, c.startColumn);
        }
        toString() {
          return (
            '[' +
        ...
        setEndPosition(c, v) {
          return new e(this.startLineNumber, this.startColumn, c, v);
        }
        setStartPosition(c, v) {
          return new e(c, v, this.endLineNumber, this.endColumn);
        }
        collapseToStart() {
          return e.collapseToStart(this);
        }
        static collapseToStart(c) {
          return new e(
            c.startLineNumber,
            c.startColumn,
            c.startLineNumber,
        ...
        static fromPositions(c, v = c) {
          return new e(c.lineNumber, c.column, v.lineNumber, v.column);
        }
        static lift(c) {
          return c
            ? new e(
        ...
        static isIRange(c) {
          return (
            c &&
            typeof c.startLineNumber == 'number' &&
            typeof c.startColumn == 'number' &&
            typeof c.endLineNumber == 'number' &&
            typeof c.endColumn == 'number'
          );
        }
        static areIntersectingOrTouching(c, v) {
          return !(
            c.endLineNumber < v.startLineNumber ||
            (c.endLineNumber === v.startLineNumber &&
              c.endColumn < v.startColumn) ||
            v.endLineNumber < c.startLineNumber ||
            (v.endLineNumber === c.startLineNumber &&
              v.endColumn < c.startColumn)
          );
        }
        static areIntersecting(c, v) {
          return !(
            c.endLineNumber < v.startLineNumber ||
            (c.endLineNumber === v.startLineNumber &&
              c.endColumn <= v.startColumn) ||
        ...
        static compareRangesUsingStarts(c, v) {
          if (c && v) {
            const d = c.startLineNumber | 0,
              w = v.startLineNumber | 0;
            if (d === w) {
              const t = c.startColumn | 0,
                _ = v.startColumn | 0;
              if (t === _) {
                const u = c.endLineNumber | 0,
                  S = v.endLineNumber | 0;
                if (u === S) {
                  const L = c.endColumn | 0,
                    s = v.endColumn | 0;
                  return L - s;
                }
                return u - S;
        ...
        static compareRangesUsingEnds(c, v) {
          return c.endLineNumber === v.endLineNumber
            ? c.endColumn === v.endColumn
              ? c.startLineNumber === v.startLineNumber
                ? c.startColumn - v.startColumn
                : c.startLineNumber - v.startLineNumber
        ...
        static spansMultipleLines(c) {
          return c.endLineNumber > c.startLineNumber;
        }
      }
      r.Range = e;
    }),
    Q(X[34], K([0, 1, 5, 6]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.Selection = void 0);
      class A extends e.Range {
        constructor(v, C, f, d) {
          super(v, C, f, d);
          (this.selectionStartLineNumber = v),
            (this.selectionStartColumn = C),
            (this.positionLineNumber = f),
        ...
        equalsSelection(v) {
          return A.selectionsEqual(this, v);
        }
        static selectionsEqual(v, C) {
          return (
            v.selectionStartLineNumber === C.selectionStartLineNumber &&
            v.selectionStartColumn === C.selectionStartColumn &&
            v.positionLineNumber === C.positionLineNumber &&
            v.positionColumn === C.positionColumn
          );
        }
        getDirection() {
        ...
        setEndPosition(v, C) {
          return this.getDirection() === 0
            ? new A(this.startLineNumber, this.startColumn, v, C)
            : new A(v, C, this.startLineNumber, this.startColumn);
        }
        getPosition() {
          return new P.Position(this.positionLineNumber, this.positionColumn);
        }
        getSelectionStart() {
          return new P.Position(
            this.selectionStartLineNumber,
            this.selectionStartColumn,
          );
        }
        setStartPosition(v, C) {
          return this.getDirection() === 0
            ? new A(v, C, this.endLineNumber, this.endColumn)
            : new A(this.endLineNumber, this.endColumn, v, C);
        }
        static fromPositions(v, C = v) {
          return new A(v.lineNumber, v.column, C.lineNumber, C.column);
        }
        static fromRange(v, C) {
          return C === 0
            ? new A(
                v.startLineNumber,
                v.startColumn,
        ...
        static liftSelection(v) {
          return new A(
            v.selectionStartLineNumber,
            v.selectionStartColumn,
            v.positionLineNumber,
            v.positionColumn,
          );
        }
        static selectionsArrEqual(v, C) {
          if ((v && !C) || (!v && C)) return !1;
          if (!v && !C) return !0;
          if (v.length !== C.length) return !1;
          for (let f = 0, d = v.length; f < d; f++)
            if (!this.selectionsEqual(v[f], C[f])) return !1;
          return !0;
        }
        static isISelection(v) {
          return (
            v &&
            typeof v.selectionStartLineNumber == 'number' &&
            typeof v.selectionStartColumn == 'number' &&
            typeof v.positionLineNumber == 'number' &&
            typeof v.positionColumn == 'number'
          );
        }
        static createWithDirection(v, C, f, d, w) {
          return w === 0 ? new A(v, C, f, d) : new A(f, d, v, C);
        }
      }
      r.Selection = A;
    }),
    Q(X[35], K([0, 1, 16]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.getMapForWordSeparators = r.WordCharacterClassifier = void 0);
      class e extends P.CharacterClassifier {
        constructor(v) {
          super(0);
          for (let C = 0, f = v.length; C < f; C++)
            this.set(v.charCodeAt(C), 2);
      ...
      function A(c) {
        const v = {};
        return (C) => (v.hasOwnProperty(C) || (v[C] = c(C)), v[C]);
      }
      r.getMapForWordSeparators = A((c) => new e(c));
    }),
    Q(X[36], K([0, 1]), function (B, r) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.getWordAtText =
      ...
      function P(C = '') {
        let f = '(-?\\d*\\.\\d\\w*)|([^';
        for (const d of r.USUAL_WORD_SEPARATORS)
          C.indexOf(d) >= 0 || (f += '\\' + d);
        return (f += '\\s]+)'), new RegExp(f, 'g');
      }
      r.DEFAULT_WORD_REGEXP = P();
      function e(C) {
        let f = r.DEFAULT_WORD_REGEXP;
        if (C && C instanceof RegExp)
          if (C.global) f = C;
          else {
            let d = 'g';
            C.ignoreCase && (d += 'i'),
      ...
      function c(C, f, d, w, t = A) {
        ...
        let S = -1,
          L = null;
        for (let s = 1; !(Date.now() - _ >= t.timeBudget); s++) {
          const b = u - t.windowSize * s;
          f.lastIndex = Math.max(0, b);
          const m = v(f, d, u, S);
          if ((!m && L) || ((L = m), b <= 0)) break;
          S = b;
        }
        if (L) {
          const s = {
            word: L[0],
            startColumn: w + 1 + L.index,
            endColumn: w + 1 + L.index + L[0].length,
          };
          return (f.lastIndex = 0), s;
        }
        return null;
      }
      r.getWordAtText = c;
      function v(C, f, d, w) {
        ...
        for (; (t = C.exec(f)); ) {
          const _ = t.index || 0;
          if (_ <= d && C.lastIndex >= d) return t;
          if (w > 0 && _ > w) return null;
        }
        return null;
      }
    }),
    Q(X[37], K([0, 1, 14, 2]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.DiffComputer = void 0);
      const A = 3;
      function c(L, s, b, m) {
        return new P.LcsDiff(L, s, b).ComputeDiff(m);
      }
      class v {
        constructor(s) {
          const b = [],
          ...
          for (let o = 0, i = s.length; o < i; o++)
            (b[o] = _(s[o], 1)), (m[o] = u(s[o], 1));
          (this.lines = s), (this._startColumns = b), (this._endColumns = m);
        }
        getElements() {
          const s = [];
          for (let b = 0, m = this.lines.length; b < m; b++)
            s[b] = this.lines[b].substring(
              this._startColumns[b] - 1,
              this._endColumns[b] - 1,
            );
          return s;
        }
        getStrictElement(s) {
        ...
        createCharSequence(s, b, m) {
          const o = [],
            i = [],
            a = [];
          let l = 0;
          for (let g = b; g <= m; g++) {
            const h = this.lines[g],
              p = s ? this._startColumns[g] : 1,
              y = s ? this._endColumns[g] : h.length + 1;
            for (let N = p; N < y; N++)
              (o[l] = h.charCodeAt(N - 1)), (i[l] = g + 1), (a[l] = N), l++;
          }
          return new C(o, i, a);
        }
      }
      class C {
        constructor(s, b, m) {
          (this._charCodes = s), (this._lineNumbers = b), (this._columns = m);
        }
        getElements() {
      ...
      class f {
        constructor(s, b, m, o, i, a, l, g) {
          (this.originalStartLineNumber = s),
            (this.originalStartColumn = b),
            ...
            (this.modifiedEndColumn = g);
        }
        static createFromDiffChange(s, b, m) {
          let o, i, a, l, g, h, p, y;
          return (
            s.originalLength === 0
              ? ((o = 0), (i = 0), (a = 0), (l = 0))
              : ((o = b.getStartLineNumber(s.originalStart)),
                (i = b.getStartColumn(s.originalStart)),
                (a = b.getEndLineNumber(
                  s.originalStart + s.originalLength - 1,
                )),
                (l = b.getEndColumn(s.originalStart + s.originalLength - 1))),
            s.modifiedLength === 0
              ? ((g = 0), (h = 0), (p = 0), (y = 0))
              : ((g = m.getStartLineNumber(s.modifiedStart)),
                (h = m.getStartColumn(s.modifiedStart)),
                (p = m.getEndLineNumber(
                  s.modifiedStart + s.modifiedLength - 1,
                )),
                (y = m.getEndColumn(s.modifiedStart + s.modifiedLength - 1))),
            new f(o, i, a, l, g, h, p, y)
          );
        }
      }
      function d(L) {
        ...
        for (let m = 1, o = L.length; m < o; m++) {
          const i = L[m],
            a = i.originalStart - (b.originalStart + b.originalLength),
            l = i.modifiedStart - (b.modifiedStart + b.modifiedLength);
          Math.min(a, l) < A
            ? ((b.originalLength =
                i.originalStart + i.originalLength - b.originalStart),
              (b.modifiedLength =
                i.modifiedStart + i.modifiedLength - b.modifiedStart))
            : (s.push(i), (b = i));
        }
        return s;
      }
      class w {
        constructor(s, b, m, o, i) {
          (this.originalStartLineNumber = s),
            (this.originalEndLineNumber = b),
            (this.modifiedStartLineNumber = m),
            (this.modifiedEndLineNumber = o),
            (this.charChanges = i);
        }
        static createFromDiffResult(s, b, m, o, i, a, l) {
          let g, h, p, y, N;
          if (
            (b.originalLength === 0
              ? ((g = m.getStartLineNumber(b.originalStart) - 1), (h = 0))
              : ((g = m.getStartLineNumber(b.originalStart)),
                (h = m.getEndLineNumber(
                  b.originalStart + b.originalLength - 1,
                ))),
            b.modifiedLength === 0
              ? ((p = o.getStartLineNumber(b.modifiedStart) - 1), (y = 0))
              : ((p = o.getStartLineNumber(b.modifiedStart)),
                (y = o.getEndLineNumber(
                  b.modifiedStart + b.modifiedLength - 1,
                ))),
            a &&
              b.originalLength > 0 &&
              b.originalLength < 20 &&
            ...
            const E = m.createCharSequence(
                s,
                b.originalStart,
                b.originalStart + b.originalLength - 1,
              ),
              M = o.createCharSequence(
                s,
                b.modifiedStart,
                b.modifiedStart + b.modifiedLength - 1,
              );
            let k = c(E, M, i, !0).changes;
            l && (k = d(k)), (N = []);
            for (let R = 0, I = k.length; R < I; R++)
              N.push(f.createFromDiffChange(k[R], E, M));
          }
          return new w(g, h, p, y, N);
        }
      }
      class t {
        constructor(s, b, m) {
          (this.shouldComputeCharChanges = m.shouldComputeCharChanges),
            (this.shouldPostProcessCharChanges =
              m.shouldPostProcessCharChanges),
            (this.shouldIgnoreTrimWhitespace = m.shouldIgnoreTrimWhitespace),
            (this.shouldMakePrettyDiff = m.shouldMakePrettyDiff),
            (this.originalLines = s),
            (this.modifiedLines = b),
            (this.original = new v(s)),
            (this.modified = new v(b)),
            (this.continueLineDiff = S(m.maxComputationTime)),
            (this.continueCharDiff = S(
              m.maxComputationTime === 0
                ? 0
                : Math.min(m.maxComputationTime, 5e3),
            ));
        }
        computeDiff() {
          if (
          ...
          if (this.shouldIgnoreTrimWhitespace) {
            ...
            return { quitEarly: m, changes: l };
          }
          const o = [];
          let i = 0,
            a = 0;
          for (let l = -1, g = b.length; l < g; l++) {
            const h = l + 1 < g ? b[l + 1] : null,
              p = h ? h.originalStart : this.originalLines.length,
              y = h ? h.modifiedStart : this.modifiedLines.length;
            for (; i < p && a < y; ) {
              const N = this.originalLines[i],
                E = this.modifiedLines[a];
              if (N !== E) {
                {
                  let M = _(N, 1),
                    k = _(E, 1);
                  for (; M > 1 && k > 1; ) {
                    const R = N.charCodeAt(M - 2),
                      I = E.charCodeAt(k - 2);
                    if (R !== I) break;
                    M--, k--;
                  }
          ...
          return { quitEarly: m, changes: o };
        }
        _pushTrimWhitespaceCharChange(s, b, m, o, i, a, l) {
          if (this._mergeTrimWhitespaceCharChange(s, b, m, o, i, a, l)) return;
          let g;
          this.shouldComputeCharChanges &&
            (g = [new f(b, m, b, o, i, a, i, l)]),
            s.push(new w(b, b, i, i, g));
        }
        _mergeTrimWhitespaceCharChange(s, b, m, o, i, a, l) {
          const g = s.length;
          if (g === 0) return !1;
          const h = s[g - 1];
          return h.originalEndLineNumber === 0 || h.modifiedEndLineNumber === 0
            ? !1
            : h.originalEndLineNumber + 1 === b &&
              h.modifiedEndLineNumber + 1 === i
            ? ((h.originalEndLineNumber = b),
              (h.modifiedEndLineNumber = i),
              this.shouldComputeCharChanges &&
                h.charChanges &&
                h.charChanges.push(new f(b, m, b, o, i, a, i, l)),
              !0)
            : !1;
        }
      }
      r.DiffComputer = t;
      function _(L, s) {
        const b = e.firstNonWhitespaceIndex(L);
        return b === -1 ? s : b + 1;
      }
      function u(L, s) {
        const b = e.lastNonWhitespaceIndex(L);
        return b === -1 ? s : b + 2;
      }
      function S(L) {
        if (L === 0) return () => !0;
    ...
    Q(X[38], K([0, 1, 32, 8]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }), (r.score = void 0);
      function A(c, v, C, f) {
        if (Array.isArray(c)) {
          let d = 0;
          for (const w of c) {
          ...
          if (typeof c == 'string')
            return f ? (c === '*' ? 5 : c === C ? 10 : 0) : 0;
          if (c) {
            const {
              language: d,
              pattern: w,
              scheme: t,
              hasAccessToAllModels: _,
            } = c;
            if (!f && !_) return 0;
            let u = 0;
            if (t)
            ...
            if (w) {
              ...
              if (
                (typeof w == 'string'
                  ? (S = w)
                  : (S = Object.assign(Object.assign({}, w), {
                      base: (0, e.normalize)(w.base),
                    })),
                S === v.fsPath || (0, P.match)(S, v.fsPath))
              )
                u = 10;
              else return 0;
            }
    ...
    Q(X[39], K([0, 1, 16]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.computeLinks =
          r.LinkComputer =
      ...
      class e {
        constructor(_, u, S) {
          const L = new Uint8Array(_ * u);
          for (let s = 0, b = _ * u; s < b; s++) L[s] = S;
          (this._data = L), (this.rows = _), (this.cols = u);
        }
        get(_, u) {
          return this._data[_ * this.cols + u];
        }
        set(_, u, S) {
          this._data[_ * this.cols + u] = S;
        }
      }
      r.Uint8Matrix = e;
      class A {
        constructor(_) {
          ...
          (this._states = L), (this._maxCharCode = u);
        }
        nextState(_, u) {
          return u < 0 || u >= this._maxCharCode ? 0 : this._states.get(_, u);
        }
      }
      r.StateMachine = A;
      let c = null;
      ...
      function f() {
        if (C === null) {
          C = new P.CharacterClassifier(0);
          const t = ` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;
          for (let u = 0; u < t.length; u++) C.set(t.charCodeAt(u), 1);
          const _ = '.,;';
          for (let u = 0; u < _.length; u++) C.set(_.charCodeAt(u), 2);
        }
        return C;
      }
      class d {
        static _createLink(_, u, S, L, s) {
          let b = s - 1;
          do {
            const m = u.charCodeAt(b);
            if (_.get(m) !== 2) break;
            b--;
          } while (b > L);
          if (L > 0) {
            const m = u.charCodeAt(L - 1),
              o = u.charCodeAt(b);
            ((m === 40 && o === 41) ||
              (m === 91 && o === 93) ||
              (m === 123 && o === 125)) &&
          ...
          return {
            ...
            url: u.substring(L, b + 1),
          };
        }
        static computeLinks(_, u = v()) {
          const S = f(),
            L = [];
          for (let s = 1, b = _.getLineCount(); s <= b; s++) {
            const m = _.getLineContent(s),
              o = m.length;
            let i = 0,
              a = 0,
              l = 0,
            ...
            for (; i < o; ) {
              ...
              if (g === 13) {
                ...
                k === 1 && (L.push(d._createLink(S, m, s, a, i)), (E = !0));
              } else if (g === 12) {
                let k;
                M === 91 ? ((p = !0), (k = 0)) : (k = S.get(M)),
                  k === 1 ? (E = !0) : (g = 13);
              } else (g = u.nextState(g, M)), g === 0 && (E = !0);
              E &&
                ((g = 1), (h = !1), (p = !1), (N = !1), (a = i + 1), (l = M)),
                i++;
            }
            g === 13 && L.push(d._createLink(S, m, s, a, o));
          }
          return L;
        }
      }
    ...
    Q(X[40], K([0, 1]), function (B, r) {
      ...
      class P {
        ...
        navigateValueSet(A, c, v, C, f) {
          if (A && c) {
            const d = this.doNavigateValueSet(c, f);
            if (d) return { range: A, value: d };
          }
          if (v && C) {
            const d = this.doNavigateValueSet(C, f);
            if (d) return { range: v, value: d };
          }
          return null;
        }
        doNavigateValueSet(A, c) {
          const v = this.numberReplace(A, c);
          return v !== null ? v : this.textReplace(A, c);
        }
        numberReplace(A, c) {
          const v = Math.pow(10, A.length - (A.lastIndexOf('.') + 1));
          let C = Number(A),
            f = parseFloat(A);
          return !isNaN(C) && !isNaN(f) && C === f
            ? C === 0 && !c
              ? null
              : ((C = Math.floor(C * v)), (C += c ? v : -v), String(C / v))
            : null;
        }
        textReplace(A, c) {
          return this.valueSetsReplace(this._defaultValueSet, A, c);
        }
        valueSetsReplace(A, c, v) {
          let C = null;
          for (let f = 0, d = A.length; C === null && f < d; f++)
            C = this.valueSetReplace(A[f], c, v);
          return C;
        }
        valueSetReplace(A, c, v) {
          let C = A.indexOf(c);
          return C >= 0
            ? ((C += v ? 1 : -1),
      ...
      (r.BasicInplaceReplace = P), (P.INSTANCE = new P());
    }),
    Q(X[17], K([0, 1, 33]), function (B, r, P) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      var A;
      (function (_) {
        (_[(_.Inline = 1)] = 'Inline'), (_[(_.Gutter = 2)] = 'Gutter');
      ...
      class v {
        constructor(u) {
          (this._textModelResolvedOptionsBrand = void 0),
            ...
            (this.indentSize = u.tabSize | 0),
            (this.insertSpaces = Boolean(u.insertSpaces)),
            (this.defaultEOL = u.defaultEOL | 0),
            (this.trimAutoWhitespace = Boolean(u.trimAutoWhitespace)),
            (this.bracketPairColorizationOptions =
              u.bracketPairColorizationOptions);
        }
        equals(u) {
          return (
      ...
      r.TextModelResolvedOptions = v;
      class C {
        constructor(u, S) {
          (this._findMatchBrand = void 0), (this.range = u), (this.matches = S);
        }
      }
      r.FindMatch = C;
      class f {
        constructor(u, S, L, s, b, m) {
          (this.identifier = u),
            (this.range = S),
            (this.text = L),
      ...
      r.ValidAnnotatedEditOperation = f;
      class d {
        constructor(u, S, L) {
          (this.regex = u), (this.wordSeparators = S), (this.simpleSearch = L);
        }
      }
      r.SearchData = d;
      class w {
      ...
      r.ApplyEditsResult = w;
      function t(_) {
        return !_.isTooLargeForSyncing() && !_.isForSimpleWidget;
      }
      r.shouldSynchronizeModel = t;
    }),
    Q(X[41], K([0, 1, 4, 7, 17, 38]), function (B, r, P, e, A, c) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.LanguageFeatureRegistry = void 0);
      function v(f) {
      ...
      class C {
        constructor() {
          (this._clock = 0),
            (this._entries = []),
            (this._onDidChange = new P.Emitter());
        }
        get onDidChange() {
        ...
        register(d, w) {
          ...
          return (
            ...
            (0, e.toDisposable)(() => {
              if (t) {
                const _ = this._entries.indexOf(t);
                _ >= 0 &&
                  (this._entries.splice(_, 1),
                  (this._lastCandidate = void 0),
                  this._onDidChange.fire(this._entries.length),
                  (t = void 0));
              }
        ...
        has(d) {
          return this.all(d).length > 0;
        }
        all(d) {
          if (!d) return [];
          this._updateScores(d);
          const w = [];
          for (let t of this._entries) t._score > 0 && w.push(t.provider);
          return w;
        }
        ordered(d) {
          const w = [];
          return this._orderedForEach(d, (t) => w.push(t.provider)), w;
        }
        orderedGroups(d) {
          const w = [];
          let t, _;
          return (
            this._orderedForEach(d, (u) => {
              t && _ === u._score
                ? t.push(u.provider)
                : ((_ = u._score), (t = [u.provider]), w.push(t));
            }),
            w
          );
        }
        _orderedForEach(d, w) {
          if (!!d) {
            this._updateScores(d);
            for (const t of this._entries) t._score > 0 && w(t);
          }
        }
        _updateScores(d) {
          const w = { uri: d.uri.toString(), language: d.getLanguageId() };
          if (
            !(
              this._lastCandidate &&
              this._lastCandidate.language === w.language &&
              this._lastCandidate.uri === w.uri
            )
          ) {
            this._lastCandidate = w;
            for (let t of this._entries)
              if (
                ((t._score = (0, c.score)(
                  ...
                  d.uri,
                  d.getLanguageId(),
                  (0, A.shouldSynchronizeModel)(d),
                )),
                v(t.selector) && t._score > 0)
              ) {
                for (let _ of this._entries) _._score = 0;
                t._score = 1e3;
                break;
              }
            this._entries.sort(C._compareByScoreAndTime);
          }
        }
        static _compareByScoreAndTime(d, w) {
          return d._score < w._score
            ? 1
            : d._score > w._score
            ? -1
            : d._time < w._time
      ...
      r.LanguageFeatureRegistry = C;
    }),
    Q(X[42], K([0, 1, 18, 15]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      class A {
        constructor(f) {
          (this.values = f),
            (this.prefixSum = new Uint32Array(f.length)),
        ...
        insertValues(f, d) {
          ...
          return _ === 0
            ? !1
            : ((this.values = new Uint32Array(w.length + _)),
              this.values.set(w.subarray(0, f), 0),
              this.values.set(w.subarray(f), f + _),
              this.values.set(d, f),
              f - 1 < this.prefixSumValidIndex[0] &&
                (this.prefixSumValidIndex[0] = f - 1),
        ...
        removeValues(f, d) {
          (f = (0, e.toUint32)(f)), (d = (0, e.toUint32)(d));
          const w = this.values,
            t = this.prefixSum;
          if (f >= w.length) return !1;
          const _ = w.length - f;
          return (
            d >= _ && (d = _),
            d === 0
              ? !1
              : ((this.values = new Uint32Array(w.length - d)),
                this.values.set(w.subarray(0, f), 0),
                this.values.set(w.subarray(f + d), f),
                (this.prefixSum = new Uint32Array(this.values.length)),
                f - 1 < this.prefixSumValidIndex[0] &&
                  (this.prefixSumValidIndex[0] = f - 1),
                this.prefixSumValidIndex[0] >= 0 &&
        ...
        getPrefixSum(f) {
          return f < 0 ? 0 : ((f = (0, e.toUint32)(f)), this._getPrefixSum(f));
        }
        _getPrefixSum(f) {
          if (f <= this.prefixSumValidIndex[0]) return this.prefixSum[f];
          let d = this.prefixSumValidIndex[0] + 1;
          d === 0 && ((this.prefixSum[0] = this.values[0]), d++),
            f >= this.values.length && (f = this.values.length - 1);
          for (let w = d; w <= f; w++)
        ...
        getIndexOf(f) {
          (f = Math.floor(f)), this.getTotalSum();
          let d = 0,
      ...
      class c {
        ...
        getPrefixSum(f) {
          return this._ensureValid(), f === 0 ? 0 : this._prefixSum[f - 1];
        }
        getIndexOf(f) {
          this._ensureValid();
          const d = this._indexBySum[f],
            w = d > 0 ? this._prefixSum[d - 1] : 0;
          return new v(d, f - w);
        }
        removeValues(f, d) {
          this._values.splice(f, d), this._invalidate(f);
        }
        insertValues(f, d) {
          (this._values = (0, P.arrayInsert)(this._values, f, d)),
            this._invalidate(f);
        }
        _invalidate(f) {
          (this._isValid = !1),
            (this._validEndIndex = Math.min(this._validEndIndex, f - 1));
        }
        _ensureValid() {
          if (!this._isValid) {
            for (
              let f = this._validEndIndex + 1, d = this._values.length;
              f < d;
              f++
            ) {
              const w = this._values[f],
                t = f > 0 ? this._prefixSum[f - 1] : 0;
              this._prefixSum[f] = t + w;
              for (let _ = 0; _ < w; _++) this._indexBySum[t + _] = f;
            }
        ...
        setValue(f, d) {
          this._values[f] !== d && ((this._values[f] = d), this._invalidate(f));
        }
      }
      r.ConstantTimePrefixSumComputer = c;
      class v {
        constructor(f, d) {
          (this.index = f),
            (this.remainder = d),
      ...
      r.PrefixSumIndexOfResult = v;
    }),
    Q(X[43], K([0, 1, 2, 5, 42]), function (B, r, P, e, A) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      class c {
          ...
          for (const d of f)
            this._acceptDeleteRange(d.range),
              this._acceptInsertText(
                new e.Position(d.range.startLineNumber, d.range.startColumn),
                d.text,
              );
        ...
        _ensureLineStarts() {
          if (!this._lineStarts) {
            const C = this._eol.length,
              ...
              d = new Uint32Array(f);
            for (let w = 0; w < f; w++) d[w] = this._lines[w].length + C;
            this._lineStarts = new A.PrefixSumComputer(d);
          }
        }
        _setLineText(C, f) {
          (this._lines[C] = f),
        ...
        _acceptInsertText(C, f) {
          if (f.length === 0) return;
          const d = (0, P.splitLines)(f);
          if (d.length === 1) {
            this._setLineText(
              C.lineNumber - 1,
          ...
          (d[d.length - 1] += this._lines[C.lineNumber - 1].substring(
            C.column - 1,
          )),
            this._setLineText(
              C.lineNumber - 1,
              this._lines[C.lineNumber - 1].substring(0, C.column - 1) + d[0],
            );
          const w = new Uint32Array(d.length - 1);
          for (let t = 1; t < d.length; t++)
            this._lines.splice(C.lineNumber + t - 1, 0, d[t]),
              (w[t - 1] = d[t].length + this._eol.length);
          this._lineStarts && this._lineStarts.insertValues(C.lineNumber, w);
        }
      }
      r.MirrorTextModel = c;
    }),
    Q(X[44], K([0, 1, 2, 35, 5, 6, 17]), function (B, r, P, e, A, c, v) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.Searcher =
          r.isValidMatch =
      ...
      class f {
        ...
        parseSearchRequest() {
          ...
          let m;
          this.isRegex
            ? (m = d(this.searchString))
            : (m =
                this.searchString.indexOf(`
`) >= 0);
          let o = null;
          try {
            o = P.createRegExp(this.searchString, this.isRegex, {
      ...
      function d(b) {
        ...
        for (let m = 0, o = b.length; m < o; m++)
          if (b.charCodeAt(m) === 92) {
            if ((m++, m >= o)) break;
            const a = b.charCodeAt(m);
            if (a === 110 || a === 114 || a === 87) return !0;
          }
        return !1;
      }
      r.isMultilineRegexSource = d;
      function w(b, m, o) {
        if (!o) return new v.FindMatch(b, null);
        const i = [];
        for (let a = 0, l = m.length; a < l; a++) i[a] = m[a];
        return new v.FindMatch(b, i);
      }
      r.createFindMatch = w;
      class t {
        constructor(m) {
          ...
          for (let a = 0, l = m.length; a < l; a++)
            m.charCodeAt(a) === 10 && (o[i++] = a);
          this._lineFeedsOffsets = o;
        }
        findLineFeedCountBeforeOffset(m) {
          const o = this._lineFeedsOffsets;
          let i = 0,
            a = o.length - 1;
          if (a === -1 || m <= o[0]) return 0;
          for (; i < a; ) {
            const l = i + (((a - i) / 2) >> 0);
            o[l] >= m
              ? (a = l - 1)
      ...
      class _ {
        static findMatches(m, o, i, a, l) {
          const g = o.parseSearchRequest();
          return g
            ? g.regex.multiline
              ? this._doFindMatchesMultiline(
                  m,
                  i,
                  new s(g.wordSeparators, g.regex),
                  a,
                  l,
                )
              : this._doFindMatchesLineByLine(m, i, g, a, l)
            : [];
        }
        static _getMultilineMatchRange(m, o, i, a, l, g) {
          let h,
            p = 0;
          a
            ? ((p = a.findLineFeedCountBeforeOffset(l)), (h = o + l + p))
            : (h = o + l);
          let y;
          if (a) {
            const k = a.findLineFeedCountBeforeOffset(l + g.length) - p;
            y = h + g.length + k;
          } else y = h + g.length;
          const N = m.getPositionAt(h),
            E = m.getPositionAt(y);
          return new c.Range(N.lineNumber, N.column, E.lineNumber, E.column);
        }
        static _doFindMatchesMultiline(m, o, i, a, l) {
          const g = m.getOffsetAt(o.getStartPosition()),
            h = m.getValueInRange(o, 1),
            p =
              m.getEOL() ===
              `\r
`
          ...
          let N = 0,
            E;
          for (i.reset(0); (E = i.next(h)); )
            if (
              ((y[N++] = w(
                this._getMultilineMatchRange(m, g, h, p, E.index, E[0]),
                E,
                a,
              )),
              N >= l)
        ...
        static _doFindMatchesLineByLine(m, o, i, a, l) {
          const g = [];
          let h = 0;
          if (o.startLineNumber === o.endLineNumber) {
            const y = m
              .getLineContent(o.startLineNumber)
              .substring(o.startColumn - 1, o.endColumn - 1);
            return (
          ...
          for (let y = o.startLineNumber + 1; y < o.endLineNumber && h < l; y++)
            h = this._findMatchesInLine(
              i,
              m.getLineContent(y),
              y,
          ...
          if (h < l) {
            const y = m
              .getLineContent(o.endLineNumber)
              .substring(0, o.endColumn - 1);
            h = this._findMatchesInLine(i, y, o.endLineNumber, 0, h, g, a, l);
          }
          return g;
        }
        static _findMatchesInLine(m, o, i, a, l, g, h, p) {
          const y = m.wordSeparators;
          if (!h && m.simpleSearch) {
            const M = m.simpleSearch,
              k = M.length,
              R = o.length;
            let I = -k;
            for (; (I = o.indexOf(M, I + k)) !== -1; )
              if (
                (!y || L(y, o, R, I, k)) &&
                ((g[l++] = new v.FindMatch(
                  new c.Range(i, I + 1 + a, i, I + 1 + k + a),
                  null,
                )),
                l >= p)
              )
          ...
          const N = new s(m.wordSeparators, m.regex);
          let E;
          N.reset(0);
          do
            if (
        ...
        static findNextMatch(m, o, i, a) {
          const l = o.parseSearchRequest();
          if (!l) return null;
          const g = new s(l.wordSeparators, l.regex);
          return l.regex.multiline
            ? this._doFindNextMatchMultiline(m, i, g, a)
            : this._doFindNextMatchLineByLine(m, i, g, a);
        }
        static _doFindNextMatchMultiline(m, o, i, a) {
          const l = new A.Position(o.lineNumber, 1),
            g = m.getOffsetAt(l),
            h = m.getLineCount(),
            p = m.getValueInRange(
              new c.Range(l.lineNumber, l.column, h, m.getLineMaxColumn(h)),
              1,
            ),
            y =
              m.getEOL() ===
...
`
          ...
          let N = i.next(p);
          return N
            ? w(this._getMultilineMatchRange(m, g, p, y, N.index, N[0]), N, a)
            : o.lineNumber !== 1 || o.column !== 1
            ? this._doFindNextMatchMultiline(m, new A.Position(1, 1), i, a)
            : null;
        }
        static _doFindNextMatchLineByLine(m, o, i, a) {
          const l = m.getLineCount(),
            g = o.lineNumber,
            h = m.getLineContent(g),
            p = this._findFirstMatchInLine(i, h, g, o.column, a);
          if (p) return p;
          for (let y = 1; y <= l; y++) {
            const N = (g + y - 1) % l,
              E = m.getLineContent(N + 1),
              M = this._findFirstMatchInLine(i, E, N + 1, 1, a);
            if (M) return M;
          }
          return null;
        }
        static _findFirstMatchInLine(m, o, i, a, l) {
          m.reset(a - 1);
          const g = m.next(o);
          return g
            ? w(new c.Range(i, g.index + 1, i, g.index + 1 + g[0].length), g, l)
            : null;
        }
        static findPreviousMatch(m, o, i, a) {
          const l = o.parseSearchRequest();
          if (!l) return null;
          const g = new s(l.wordSeparators, l.regex);
          return l.regex.multiline
            ? this._doFindPreviousMatchMultiline(m, i, g, a)
            : this._doFindPreviousMatchLineByLine(m, i, g, a);
        }
        static _doFindPreviousMatchMultiline(m, o, i, a) {
          const l = this._doFindMatchesMultiline(
            m,
            new c.Range(1, 1, o.lineNumber, o.column),
            i,
            a,
            10 * C,
          );
          if (l.length > 0) return l[l.length - 1];
          const g = m.getLineCount();
          return o.lineNumber !== g || o.column !== m.getLineMaxColumn(g)
            ? this._doFindPreviousMatchMultiline(
                m,
                new A.Position(g, m.getLineMaxColumn(g)),
                i,
                a,
              )
            : null;
        }
        static _doFindPreviousMatchLineByLine(m, o, i, a) {
          const l = m.getLineCount(),
            g = o.lineNumber,
            h = m.getLineContent(g).substring(0, o.column - 1),
            p = this._findLastMatchInLine(i, h, g, a);
          if (p) return p;
          for (let y = 1; y <= l; y++) {
            const N = (l + g - y - 1) % l,
              E = m.getLineContent(N + 1),
              M = this._findLastMatchInLine(i, E, N + 1, a);
            if (M) return M;
          }
          return null;
        }
        static _findLastMatchInLine(m, o, i, a) {
          let l = null,
            g;
          for (m.reset(0); (g = m.next(o)); )
            l = w(
              new c.Range(i, g.index + 1, i, g.index + 1 + g[0].length),
              g,
              a,
            );
          return l;
      ...
      r.TextModelSearch = _;
      function u(b, m, o, i, a) {
        if (i === 0) return !0;
        const l = m.charCodeAt(i - 1);
        if (b.get(l) !== 0 || l === 13 || l === 10) return !0;
        if (a > 0) {
          const g = m.charCodeAt(i);
          if (b.get(g) !== 0) return !0;
        }
        return !1;
      }
      function S(b, m, o, i, a) {
        if (i + a === o) return !0;
        const l = m.charCodeAt(i + a);
        if (b.get(l) !== 0 || l === 13 || l === 10) return !0;
        if (a > 0) {
          const g = m.charCodeAt(i + a - 1);
          if (b.get(g) !== 0) return !0;
        }
        return !1;
      }
      function L(b, m, o, i, a) {
        return u(b, m, o, i, a) && S(b, m, o, i, a);
      }
      r.isValidMatch = L;
      class s {
        constructor(m, o) {
        ...
        next(m) {
          ...
          do {
            if (
              this._prevMatchStartIndex + this._prevMatchLength === o ||
              ((i = this._searchRegex.exec(m)), !i)
            )
              return null;
            const a = i.index,
              l = i[0].length;
            if (
              ...
              if (l === 0) {
                P.getNextCodePoint(m, o, this._searchRegex.lastIndex) > 65535
            ...
            if (
              ...
              !this._wordSeparators || L(this._wordSeparators, m, o, a, l))
            )
              return i;
          } while (i);
          return null;
    ...
    Q(X[45], K([0, 1, 6, 44, 2, 9]), function (B, r, P, e, A, c) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.UnicodeTextModelHighlighter = void 0);
      class v {
        static computeUnicodeHighlights(w, t, _) {
          const u = _ ? _.startLineNumber : 1,
            S = _ ? _.endLineNumber : w.getLineCount(),
            L = new f(t),
            s = L.getCandidateCodePoints();
          let b;
          s === 'allNonBasicAscii'
            ? (b = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
            : (b = new RegExp(`${C(Array.from(s))}`, 'g'));
          const m = new e.Searcher(null, b),
            o = [];
          let i = !1,
            a,
            l = 0,
            g = 0,
            h = 0;
          e: for (let p = u, y = S; p <= y; p++) {
            const N = w.getLineContent(p),
              E = N.length;
            m.reset(0);
            do
              if (((a = m.next(N)), a)) {
                ...
                if (M > 0) {
                  const F = N.charCodeAt(M - 1);
                  A.isHighSurrogate(F) && M--;
                }
                if (k + 1 < E) {
                  const F = N.charCodeAt(k - 1);
                  A.isHighSurrogate(F) && k++;
                }
                const R = N.substring(M, k),
                  I = L.shouldHighlightNonBasicASCII(R);
                if (I !== 0) {
                  I === 3
                    ? l++
                    : I === 2
                  ...
                  o.push(new P.Range(p, M + 1, p, k + 1));
                }
              }
            while (a);
          }
        ...
        static computeUnicodeHighlightReason(w, t) {
          const _ = new f(t);
          switch (_.shouldHighlightNonBasicASCII(w)) {
            case 0:
              return null;
            case 2:
              return { kind: 1 };
            case 3: {
              const S = w.codePointAt(0),
                L = _.ambiguousCharacters.getPrimaryConfusable(S),
                s = A.AmbiguousCharacters.getLocales().filter(
                  (b) =>
                    !A.AmbiguousCharacters.getInstance(
                      new Set([...t.allowedLocales, b]),
                    ).isAmbiguous(S),
                );
              return {
                kind: 0,
      ...
      r.UnicodeTextModelHighlighter = v;
      function C(d, w) {
        return `[${A.escapeRegExpCharacters(
          d.map((_) => String.fromCodePoint(_)).join(''),
        )}]`;
      }
      class f {
        constructor(w) {
          (this.options = w),
            (this.allowedCodePoints = new Set(w.allowedCodePoints)),
            (this.ambiguousCharacters = A.AmbiguousCharacters.getInstance(
              new Set(w.allowedLocales),
            ));
        }
        getCandidateCodePoints() {
          ...
          if (this.options.invisibleCharacters)
            for (const t of A.InvisibleCharacters.codePoints) w.add(t);
          if (this.options.ambiguousCharacters)
            for (const t of this.ambiguousCharacters.getConfusableCodePoints())
              w.add(t);
          for (const t of this.allowedCodePoints) w.delete(t);
          return w;
        }
        shouldHighlightNonBasicASCII(w) {
          const t = w.codePointAt(0);
...
` ||
              ...
              A.InvisibleCharacters.isInvisibleCharacter(t)
            ? 2
    ...
    Q(X[46], K([0, 1]), function (B, r) {
      ...
      })((P = r.AccessibilitySupport || (r.AccessibilitySupport = {})));
      var e;
      (function (n) {
      ...
      })((A = r.CompletionItemKind || (r.CompletionItemKind = {})));
      var c;
      (function (n) {
        n[(n.Deprecated = 1)] = 'Deprecated';
      })((c = r.CompletionItemTag || (r.CompletionItemTag = {})));
      var v;
      (function (n) {
        (n[(n.Invoke = 0)] = 'Invoke'),
      ...
      })((v = r.CompletionTriggerKind || (r.CompletionTriggerKind = {})));
      var C;
      (function (n) {
        (n[(n.EXACT = 0)] = 'EXACT'),
          (n[(n.ABOVE = 1)] = 'ABOVE'),
      ...
      (function (n) {
        (n[(n.NotSet = 0)] = 'NotSet'),
          ...
          (n[(n.Undo = 5)] = 'Undo'),
          (n[(n.Redo = 6)] = 'Redo');
      })((f = r.CursorChangeReason || (r.CursorChangeReason = {})));
      var d;
      (function (n) {
        (n[(n.LF = 1)] = 'LF'), (n[(n.CRLF = 2)] = 'CRLF');
      })((d = r.DefaultEndOfLine || (r.DefaultEndOfLine = {})));
      var w;
      (function (n) {
        (n[(n.Text = 0)] = 'Text'),
          (n[(n.Read = 1)] = 'Read'),
          (n[(n.Write = 2)] = 'Write');
      })((w = r.DocumentHighlightKind || (r.DocumentHighlightKind = {})));
      var t;
      (function (n) {
        (n[(n.None = 0)] = 'None'),
          (n[(n.Keep = 1)] = 'Keep'),
      ...
      })((_ = r.EditorOption || (r.EditorOption = {})));
      var u;
      (function (n) {
        (n[(n.TextDefined = 0)] = 'TextDefined'),
          (n[(n.LF = 1)] = 'LF'),
          (n[(n.CRLF = 2)] = 'CRLF');
      })((u = r.EndOfLinePreference || (r.EndOfLinePreference = {})));
      var S;
      (function (n) {
        (n[(n.LF = 0)] = 'LF'), (n[(n.CRLF = 1)] = 'CRLF');
      })((S = r.EndOfLineSequence || (r.EndOfLineSequence = {})));
      var L;
      (function (n) {
        (n[(n.None = 0)] = 'None'),
          (n[(n.Indent = 1)] = 'Indent'),
      ...
      })((g = r.MouseTargetType || (r.MouseTargetType = {})));
      var h;
      (function (n) {
      ...
      (function (n) {
        (n[(n.Left = 1)] = 'Left'),
          ...
          (n[(n.Right = 4)] = 'Right'),
          (n[(n.Full = 7)] = 'Full');
      })((p = r.OverviewRulerLane || (r.OverviewRulerLane = {})));
      var y;
      (function (n) {
        (n[(n.Left = 0)] = 'Left'),
          (n[(n.Right = 1)] = 'Right'),
          (n[(n.None = 2)] = 'None');
      })((y = r.PositionAffinity || (r.PositionAffinity = {})));
      var N;
      (function (n) {
        (n[(n.Off = 0)] = 'Off'),
          (n[(n.On = 1)] = 'On'),
          ...
          (n[(n.Custom = 4)] = 'Custom');
      })((N = r.RenderLineNumbersType || (r.RenderLineNumbersType = {})));
      var E;
      (function (n) {
        (n[(n.None = 0)] = 'None'),
          (n[(n.Text = 1)] = 'Text'),
          (n[(n.Blocks = 2)] = 'Blocks');
      })((E = r.RenderMinimap || (r.RenderMinimap = {})));
      var M;
      (function (n) {
        (n[(n.Smooth = 0)] = 'Smooth'), (n[(n.Immediate = 1)] = 'Immediate');
      })((M = r.ScrollType || (r.ScrollType = {})));
      var k;
      (function (n) {
        (n[(n.Auto = 1)] = 'Auto'),
          (n[(n.Hidden = 2)] = 'Hidden'),
      ...
      })((U = r.TrackedRangeStickiness || (r.TrackedRangeStickiness = {})));
      var T;
      (function (n) {
        (n[(n.None = 0)] = 'None'),
          (n[(n.Same = 1)] = 'Same'),
      ...
      })((T = r.WrappingIndent || (r.WrappingIndent = {})));
    }),
    Q(X[47], K([0, 1, 4, 7]), function (B, r, P, e) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      class A {
        ...
        register(C, f) {
          return (
            ...
            this.fire([C]),
            (0, e.toDisposable)(() => {
              this._map.get(C) === f && (this._map.delete(C), this.fire([C]));
            })
          );
        }
        registerFactory(C, f) {
          var d;
          (d = this._factories.get(C)) === null || d === void 0 || d.dispose();
          const w = new c(this, C, f);
          return (
            this._factories.set(C, w),
            (0, e.toDisposable)(() => {
              const t = this._factories.get(C);
              !t || t !== w || (this._factories.delete(C), t.dispose());
            })
          );
        }
        getOrCreate(C) {
          return ne(this, void 0, void 0, function* () {
            const f = this.get(C);
            if (f) return f;
            const d = this._factories.get(C);
            return !d || d.isResolved ? null : (yield d.resolve(), this.get(C));
          });
        }
        get(C) {
    ...
    Q(X[48], K([0, 1, 11, 6, 41, 47, 20]), function (B, r, P, e, A, c, v) {
      'use strict';
      Object.defineProperty(r, '__esModule', { value: !0 }),
        (r.TokenizationRegistry =
          r.DocumentRangeSemanticTokensProviderRegistry =
          r.DocumentSemanticTokensProviderRegistry =
          r.FoldingRangeProviderRegistry =
          r.SelectionRangeRegistry =
          r.ColorProviderRegistry =
          r.LinkProviderRegistry =
          r.OnTypeFormattingEditProviderRegistry =
          r.DocumentRangeFormattingEditProviderRegistry =
          r.DocumentFormattingEditProviderRegistry =
          r.CodeActionProviderRegistry =
          r.InlayHintsProviderRegistry =
          r.CodeLensProviderRegistry =
          r.TypeDefinitionProviderRegistry =
          r.ImplementationProviderRegistry =
          r.DeclarationProviderRegistry =
          r.DefinitionProviderRegistry =
          r.LinkedEditingRangeProviderRegistry =
          r.DocumentHighlightProviderRegistry =
          r.DocumentSymbolProviderRegistry =
          r.InlineValuesProviderRegistry =
          r.EvaluatableExpressionProviderRegistry =
          r.HoverProviderRegistry =
          r.SignatureHelpProviderRegistry =
          r.InlineCompletionsProviderRegistry =
          r.CompletionProviderRegistry =
          r.RenameProviderRegistry =
          r.ReferenceProviderRegistry =
          r.InlayHintKind =
          r.Command =
          r.FoldingRangeKind =
          r.SymbolKinds =
      ...
      class C {
        ...
        static getBackground(a) {
          return (a & 4286578688) >>> 23;
        }
        static getClassNameFromMetadata(a) {
          const l = this.getForeground(a);
          let g = 'mtk' + l;
          const h = this.getFontStyle(a);
          return (
            h & 1 && (g += ' mtki'),
            h & 2 && (g += ' mtkb'),
            h & 4 && (g += ' mtku'),
        ...
        static getInlineStyleFromMetadata(a, l) {
          const g = this.getForeground(a),
            h = this.getFontStyle(a);
          let p = `color: ${l[g]};`;
          h & 1 && (p += 'font-style: italic;'),
            h & 2 && (p += 'font-weight: bold;');
          let y = '';
          return (
            h & 4 && (y += ' underline'),
            h & 8 && (y += ' line-through'),
            y && (p += `text-decoration:${y};`),
            p
          );
        }
        static getPresentationFromMetadata(a) {
          const l = this.getForeground(a),
            g = this.getFontStyle(a);
          return {
            foreground: l,
            italic: Boolean(g & 1),
            bold: Boolean(g & 2),
            underline: Boolean(g & 4),
            strikethrough: Boolean(g & 8),
          };
        }
      }
      r.TokenMetadata = C;
      ...
      r.EncodedTokenizationResult = w;
      var t;
      (function (i) {
        const a = new Map();
        a.set(0, v.Codicon.symbolMethod),
          a.set(1, v.Codicon.symbolFunction),
          a.set(2, v.Codicon.symbolConstructor),
          a.set(3, v.Codicon.symbolField),
          a.set(4, v.Codicon.symbolVariable),
          a.set(5, v.Codicon.symbolClass),
          a.set(6, v.Codicon.symbolStruct),
          a.set(7, v.Codicon.symbolInterface),
          a.set(8, v.Codicon.symbolModule),
          a.set(9, v.Codicon.symbolProperty),
          a.set(10, v.Codicon.symbolEvent),
          a.set(11, v.Codicon.symbolOperator),
          a.set(12, v.Codicon.symbolUnit),
          a.set(13, v.Codicon.symbolValue),
          a.set(15, v.Codicon.symbolEnum),
          a.set(14, v.Codicon.symbolConstant),
          a.set(15, v.Codicon.symbolEnum),
          a.set(16, v.Codicon.symbolEnumMember),
          a.set(17, v.Codicon.symbolKeyword),
          a.set(27, v.Codicon.symbolSnippet),
          a.set(18, v.Codicon.symbolText),
          a.set(19, v.Codicon.symbolColor),
          a.set(20, v.Codicon.symbolFile),
          a.set(21, v.Codicon.symbolReference),
          a.set(22, v.Codicon.symbolCustomColor),
          a.set(23, v.Codicon.symbolFolder),
          a.set(24, v.Codicon.symbolTypeParameter),
          a.set(25, v.Codicon.account),
          a.set(26, v.Codicon.issues);
        function l(p) {
          let y = a.get(p);
          return (
            y ||
              (console.info('No codicon found for CompletionItemKind ' + p),
              (y = v.Codicon.symbolProperty)),
            y
          );
        }
        i.toIcon = l;
        ...
        function h(p, y) {
          let N = g.get(p);
          return typeof N == 'undefined' && !y && (N = 9), N;
        }
        i.fromString = h;
      })((t = r.CompletionItemKinds || (r.CompletionItemKinds = {})));
      var _;
      (function (i) {
        (i[(i.Automatic = 0)] = 'Automatic'),
      ...
      })((u = r.SignatureHelpTriggerKind || (r.SignatureHelpTriggerKind = {})));
      var S;
      (function (i) {
        (i[(i.Text = 0)] = 'Text'),
          (i[(i.Read = 1)] = 'Read'),
      ...
      function L(i) {
        return (
          i &&
          P.URI.isUri(i.uri) &&
          e.Range.isIRange(i.range) &&
          (e.Range.isIRange(i.originSelectionRange) ||
            e.Range.isIRange(i.targetSelectionRange))
        );
      }
      r.isLocationLink = L;
      var s;
      (function (i) {
        const a = new Map();
        a.set(0, v.Codicon.symbolFile),
          a.set(1, v.Codicon.symbolModule),
          a.set(2, v.Codicon.symbolNamespace),
          a.set(3, v.Codicon.symbolPackage),
          a.set(4, v.Codicon.symbolClass),
          a.set(5, v.Codicon.symbolMethod),
          a.set(6, v.Codicon.symbolProperty),
          a.set(7, v.Codicon.symbolField),
          a.set(8, v.Codicon.symbolConstructor),
          a.set(9, v.Codicon.symbolEnum),
          a.set(10, v.Codicon.symbolInterface),
          a.set(11, v.Codicon.symbolFunction),
          a.set(12, v.Codicon.symbolVariable),
          a.set(13, v.Codicon.symbolConstant),
          a.set(14, v.Codicon.symbolString),
          a.set(15, v.Codicon.symbolNumber),
          a.set(16, v.Codicon.symbolBoolean),
          a.set(17, v.Codicon.symbolArray),
          a.set(18, v.Codicon.symbolObject),
          a.set(19, v.Codicon.symbolKey),
          a.set(20, v.Codicon.symbolNull),
          a.set(21, v.Codicon.symbolEnumMember),
          a.set(22, v.Codicon.symbolStruct),
          a.set(23, v.Codicon.symbolEvent),
          a.set(24, v.Codicon.symbolOperator),
          a.set(25, v.Codicon.symbolTypeParameter);
        function l(g) {
          let h = a.get(g);
          return (
            h ||
              (console.info('No codicon found for SymbolKind ' + g),
              (h = v.Codicon.symbolProperty)),
            h
          );
        }
        i.toIcon = l;
      })((s = r.SymbolKinds || (r.SymbolKinds = {})));
      class b {
        constructor(a) {
          this.value = a;
        }
      }
      (r.FoldingRangeKind = b),
        (b.Comment = new b('comment')),
        (b.Imports = new b('imports')),
        (b.Region = new b('region'));
      var m;
      (function (i) {
        function a(l) {
        ...
        i.is = a;
      })((m = r.Command || (r.Command = {})));
      var o;
      (function (i) {
        (i[(i.Other = 0)] = 'Other'),
          (i[(i.Type = 1)] = 'Type'),
          (i[(i.Parameter = 2)] = 'Parameter');
      })((o = r.InlayHintKind || (r.InlayHintKind = {}))),
        (r.ReferenceProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.RenameProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.CompletionProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.InlineCompletionsProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.SignatureHelpProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.HoverProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.EvaluatableExpressionProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.InlineValuesProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.DocumentSymbolProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.DocumentHighlightProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.LinkedEditingRangeProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.DefinitionProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.DeclarationProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.ImplementationProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.TypeDefinitionProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.CodeLensProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.InlayHintsProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.CodeActionProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.DocumentFormattingEditProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.DocumentRangeFormattingEditProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.OnTypeFormattingEditProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.LinkProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.ColorProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.SelectionRangeRegistry = new A.LanguageFeatureRegistry()),
        (r.FoldingRangeProviderRegistry = new A.LanguageFeatureRegistry()),
        (r.DocumentSemanticTokensProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.DocumentRangeSemanticTokensProviderRegistry =
          new A.LanguageFeatureRegistry()),
        (r.TokenizationRegistry = new c.TokenizationRegistry());
    }),
    Q(
      X[49],
      K([0, 1, 13, 4, 24, 11, 5, 6, 34, 48, 46]),
      function (B, r, P, e, A, c, v, C, f, d, w) {
        'use strict';
        Object.defineProperty(r, '__esModule', { value: !0 }),
          (r.createMonacoBaseAPI = r.KeyMod = void 0);
        class t {
          static chord(S, L) {
            return (0, A.KeyChord)(S, L);
          }
        }
        (r.KeyMod = t),
          (t.CtrlCmd = 2048),
        ...
        r.createMonacoBaseAPI = _;
      },
    ),
    Q(
      X[51],
      K([0, 1, 14, 3, 11, 5, 6, 37, 43, 36, 39, 40, 49, 9, 12, 45]),
      function (B, r, P, e, A, c, v, C, f, d, w, t, _, u, S, L) {
        'use strict';
        Object.defineProperty(r, '__esModule', { value: !0 }),
          (r.create = r.EditorSimpleWorker = r.MirrorModel = void 0);
        class s extends f.MirrorTextModel {
          get uri() {
            return this._uri;
          }
          get eol() {
          ...
          getWordAtPosition(i, a) {
            const l = (0, d.getWordAtText)(
              i.column,
              (0, d.ensureValidWordDefinition)(a),
          ...
          words(i) {
            ...
            return {
              *[Symbol.iterator]() {
                for (;;)
                  if (p < y.length) {
                    const N = h.substring(y[p].start, y[p].end);
                    (p += 1), yield N;
                  } else if (g < a.length)
                    (h = a[g]), (y = l(h, i)), (p = 0), (g += 1);
                  else break;
              },
            };
          }
          getLineWords(i, a) {
            const l = this._lines[i - 1],
              g = this._wordenize(l, a),
              h = [];
            for (const p of g)
              h.push({
                word: l.substring(p.start, p.end),
          ...
          _wordenize(i, a) {
            const l = [];
            let g;
            for (a.lastIndex = 0; (g = a.exec(i)) && g[0].length !== 0; )
          ...
          getValueInRange(i) {
            ...
            const a = this._eol,
              ...
              g = i.endLineNumber - 1,
              h = [];
            h.push(this._lines[l].substring(i.startColumn - 1));
            for (let p = l + 1; p < g; p++) h.push(this._lines[p]);
            return (
              h.push(this._lines[g].substring(0, i.endColumn - 1)), h.join(a)
            );
          }
          offsetAt(i) {
            return (
          ...
          _validatePosition(i) {
            if (!c.Position.isIPosition(i)) throw new Error('bad position');
            ...
            if (a < 1) (a = 1), (l = 1), (g = !0);
              ...
              const h = this._lines[a - 1].length + 1;
              l < 1 ? ((l = 1), (g = !0)) : l > h && ((l = h), (g = !0));
            }
            return g ? { lineNumber: a, column: l } : i;
          }
        }
        r.MirrorModel = s;
        class b {
          ...
          computeDiff(i, a, l, g) {
            return ne(this, void 0, void 0, function* () {
              const h = this._getModel(i),
                p = this._getModel(a);
              if (!h || !p) return null;
              const y = h.getLinesContent(),
                N = p.getLinesContent(),
                M = new C.DiffComputer(y, N, {
                ...
                k = M.changes.length > 0 ? !1 : this._modelsAreIdentical(h, p);
              return {
                quitEarly: M.quitEarly,
                identical: k,
                changes: M.changes,
              };
            });
          ...
          computeMoreMinimalEdits(i, a) {
            return ne(this, void 0, void 0, function* () {
              ...
              const g = [];
              let h;
              a = a.slice(0).sort((p, y) => {
                if (p.range && y.range)
                  return v.Range.compareRangesUsingStarts(p.range, y.range);
                const N = p.range ? 0 : 1,
                  E = y.range ? 0 : 1;
                return N - E;
              });
              for (let { range: p, text: y, eol: N } of a) {
                if ((typeof N == 'number' && (h = N), v.Range.isEmpty(p) && !y))
                  continue;
                const E = l.getValueInRange(p);
                if (((y = y.replace(/\r\n|\n|\r/g, l.eol)), E === y)) continue;
                if (Math.max(y.length, E.length) > b._diffLimit) {
                  g.push({ range: p, text: y });
                  continue;
                }
                const M = (0, P.stringDiff)(E, y, !1),
                  k = l.offsetAt(v.Range.lift(p).getStartPosition());
                for (const R of M) {
                  const I = l.positionAt(k + R.originalStart),
                    F = l.positionAt(k + R.originalStart + R.originalLength),
                    O = {
                      text: y.substr(R.modifiedStart, R.modifiedLength),
                      range: {
                  ...
                  l.getValueInRange(O.range) !== O.text && g.push(O);
                }
              }
              return (
                typeof h == 'number' &&
          ...
          computeLinks(i) {
            return ne(this, void 0, void 0, function* () {
              ...
              return a ? (0, w.computeLinks)(a) : null;
            });
          }
          textualSuggest(i, a, l, g) {
            return ne(this, void 0, void 0, function* () {
              const h = new S.StopWatch(!0),
                p = new RegExp(l, g),
                y = new Set();
              e: for (let N of i) {
                const E = this._getModel(N);
                if (!!E) {
                  for (let M of E.words(p))
                    if (
                      !(M === a || !isNaN(Number(M))) &&
                      (y.add(M), y.size > b._suggestionsLimit)
                    )
                      break e;
                }
              }
              return { words: Array.from(y), duration: h.elapsed() };
            });
          }
          computeWordRanges(i, a, l, g) {
            return ne(this, void 0, void 0, function* () {
              const h = this._getModel(i);
          ...
          navigateValueSet(i, a, l, g, h) {
            return ne(this, void 0, void 0, function* () {
              const p = this._getModel(i);
              if (!p) return null;
              const y = new RegExp(g, h);
              ...
              const N = p.getValueInRange(a),
                E = p.getWordAtPosition(
                  { lineNumber: a.startLineNumber, column: a.startColumn },
                  y,
                );
              if (!E) return null;
              const M = p.getValueInRange(E);
          ...
          loadForeignModule(i, a, l) {
            const g = (y, N) => this._host.fhr(y, N),
              p = {
                host: u.createProxyObject(l, g),
                getMirrorModels: () => this._getModels(),
              };
            return this._foreignModuleFactory
              ? ((this._foreignModule = this._foreignModuleFactory(p, a)),
                Promise.resolve(u.getAllMethodNames(this._foreignModule)))
              : new Promise((y, N) => {
                  B(
                    [i],
                    (E) => {
                      (this._foreignModule = E.create(p, a)),
                        y(u.getAllMethodNames(this._foreignModule));
                    },
                    N,
                  );
                });
        ...
        (r.create = m),
          typeof importScripts == 'function' &&
            (e.globals.monaco = (0, _.createMonacoBaseAPI)());
      },
    ),
    (function () {
      var B, r;
      const P = self.MonacoEnvironment,
        e = P && P.baseUrl ? P.baseUrl : '../../../',
        A =
          typeof ((B = self.trustedTypes) === null || B === void 0
            ? void 0
            : B.createPolicy) == 'function'
            ? (r = self.trustedTypes) === null || r === void 0
              ? void 0
              : r.createPolicy('amdLoader', {
                  createScriptURL: (w) => w,
                  createScript: (w, ...t) => {
                    const _ = t.slice(0, -1).join(','),
                      u = t.pop().toString();
...
${u}
      ...
      function v() {
        return new Promise((w, t) => {
          if (typeof self.define == 'function' && self.define.amd) return w();
          const _ = e + 'vs/loader.js';
          if (
            !(
              /^((http:)|(https:)|(file:))/.test(_) &&
              _.substring(0, self.origin.length) !== self.origin
            ) &&
            c()
          ) {
            fetch(_)
              ...
              .then((S) => {
                (S = `${S}
//# sourceURL=${_}`),
                  (A ? self.eval(A.createScript('', S)) : new Function(S)).call(
                    self,
                  ),
                  w();
              })
          ...
          A ? importScripts(A.createScriptURL(_)) : importScripts(_), w();
        });
      }
      const C = function (w) {
        v().then(() => {
          require.config({
            ...
            require([w], function (t) {
              setTimeout(function () {
                let _ = t.create((u, S) => {
                  self.postMessage(u, S);
                }, null);
                for (
                  self.onmessage = (u) => _.onmessage(u.data, u.ports);
                  d.length > 0;

                )
                  self.onmessage(d.shift());
              }, 0);
            });
        });
      };
